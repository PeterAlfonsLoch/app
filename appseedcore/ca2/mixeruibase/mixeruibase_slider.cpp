...
namespace mixeruserbase
{
   ...
   void slider::_001InstallMessageHandling(::user::win::message::dispatch * pinterface)
   {
...
//      int iMax = GetRangeMax();
   ...
   /*VMSRESULT slider::TwiRender(LPRECT lprect, ::ca::graphics * pdcBuffer)
   {
       return CTransparentWndInterface::TwiRender(lprect, pdcBuffer);
       ::ca::graphics * pdc = ::ca::graphics_sp::from_handle(pdcBuffer->get_os_data());
       ...
       if(rectClip.intersect(rectClip, rectClient))
       {

           ::ca::rgn rgnClipOld;
           rgnClipOld.CreateRectRgn(0, 0, 0, 0);
           GetClipRgn((HDC)pdc->get_os_data(), rgnClipOld);

           ::ca::rgn rgnClip;
           point ptClip = pdc->GetViewportOrg();
           rectClip.offset(ptClip);
