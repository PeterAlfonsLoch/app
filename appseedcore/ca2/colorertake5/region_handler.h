...
/** Handles parse information, passed from text_parser.
    ...
    @ingroup colorer
*/
   class CLASS_DECL_ca RegionHandler
{
protected:
...
public:
  ...
  */
  virtual void clearLine(int lno, const char *line);
  ...
  */
  virtual void addRegion(int lno, const char *line, int sx, int ex, class region *region) = 0;
  ...
  */
  virtual void enterScheme(int lno, const char *line, int sx, int ex, class region *region, class scheme *scheme) = 0;
  ...
  /** Informs handler about leaveing specified scheme.
      ...
      @param scheme Additional scheme information
  */
  virtual void leaveScheme(int lno, const char  *line, int sx, int ex, class region *region, class scheme *scheme) = 0;
