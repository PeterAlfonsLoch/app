...
public:
  ...
  static SharedInputSource *getInputSource(string path, ex1::input_stream & base);
  ...
  int get_length() const{ return is->get_length(); }

private:

  SharedInputSource(ex1::input_stream & source);
  ~SharedInputSource();
