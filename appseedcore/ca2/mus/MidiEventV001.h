...
class CLASS_DECL_ca MidiEventV001 : 
...
public:
   ...
   virtual MidiEventV001 & operator = (const MidiEventV001 & eventSrc);
   ...
   inline static index CompareTkPosition(MidiEventV001 * pa1, MidiEventV001 * pa2);
   inline static void swap(MidiEventV001 * p1, MidiEventV001 * p2);
