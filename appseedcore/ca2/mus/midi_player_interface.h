...
class CLASS_DECL_ca midi_player_interface :
   virtual public midi_player_callback
{
public:
   
   
   midi_central *       m_pcentral;
   midi_player   *         m_pmidiplayer;


   midi_player_interface(::ca::application * papp);
   virtual ~midi_player_interface();
