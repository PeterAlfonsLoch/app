...
void CMapStringToPtr::remove_all()
{
   ASSERT_VALID(this);
...
CMapStringToPtr::NewAssoc()
{
   if (m_pFreeList == NULL)
   {
      ...
      plex* newBlock = plex::create(m_pBlocks, m_nBlockSize,
                     sizeof(CMapStringToPtr::assoc));
      // chain them into free list
      CMapStringToPtr::assoc* pAssoc =
            (CMapStringToPtr::assoc*) newBlock->data();
   ...
   CMapStringToPtr::assoc* pAssoc = m_pFreeList;
...
void CMapStringToPtr::FreeAssoc(CMapStringToPtr::assoc* pAssoc)
{
   DestructElement(&pAssoc->key);  // free up string data
...
CMapStringToPtr::assoc*
CMapStringToPtr::GetAssocAt(const char * key, UINT& nHashBucket, UINT& nHashValue) const
...
BOOL CMapStringToPtr::LookupKey(const char * key, const char *& rKey) const
{
   ASSERT_VALID(this);
...
void CMapStringToPtr::get_next_assoc(POSITION& rNextPosition,
   string & rKey, void *& rValue) const
{
   ASSERT_VALID(this);
...
#ifdef _DEBUG
void CMapStringToPtr::dump(dump_context & dumpcontext) const
{
...
void CMapStringToPtr::assert_valid() const
{
...
// IMPLEMENT_DYNAMIC(CMapStringToPtr, ::radix::object)
