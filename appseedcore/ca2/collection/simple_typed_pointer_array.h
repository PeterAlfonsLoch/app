...
public:
	...
	void set_at_grow(int nIndex, TYPE newElement)
	...
	void insert_at(int nIndex, TYPE newElement, int nCount = 1)
		{ BASE_CLASS::InsertAt(nIndex, newElement, nCount); }
	void insert_at(int nStartIndex, simple_typed_pointer_array<BASE_CLASS, TYPE>* pNewArray)
