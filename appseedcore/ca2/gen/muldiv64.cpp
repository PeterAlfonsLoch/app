...
void mul64(unsigned __int64 v1, unsigned __int64 v2, unsigned __int64 & hi, unsigned __int64 & lo)
{
  register unsigned __int64 a, c;
  register unsigned __int64 b, d;
  register unsigned __int64 x, y;
...
void mul64(__int64 v1, __int64 v2, __int64 & hi, unsigned __int64 & lo)
{
   if(v1 > 0)
   {
      if(v2 > 0)
      {
         mul64((unsigned __int64) v1, (unsigned __int64) v2, (unsigned __int64 &) hi, lo);
      }
      else
      {
         mul64((unsigned __int64) v1, (unsigned __int64) -(__int64)v2, (unsigned __int64 &) hi, lo);
         hi = -hi;
         lo = (unsigned __int64)-(__int64)lo;
      }
   }
   else
   {
      ...
      {
         mul64((unsigned __int64) -(__int64)v1, (unsigned __int64) -(__int64)v2, (unsigned __int64 &) hi, lo);
      }
   }
}
...
unsigned __int64 div128_64(unsigned __int64 hi, unsigned __int64 lo, unsigned __int64 div, unsigned __int64 & remainder)
{
   for(size_t i = 1; i <= 64; ++i)
   {
      unsigned __int64 t = __int64(hi) >> 63;
...
__int64 div128_64(__int64 hi, unsigned __int64 lo, __int64 div, unsigned __int64 & remainder)
{
   if(hi > 0)
   {
      if(div > 0)
      {
         return div128_64((unsigned __int64) hi, lo, (unsigned __int64) div, remainder);
      }
      else
      {
         return -(__int64)div128_64((unsigned __int64) hi, lo, (unsigned __int64) -(__int64)div, remainder);
      }
   }
   else
   {
      if(div > 0)
      {
         return -(__int64)div128_64((unsigned __int64) -(__int64)hi, (unsigned __int64)-(__int64)lo, (unsigned __int64) div, remainder);
      }
      else
      {
         return div128_64((unsigned __int64) -(__int64)hi, (unsigned __int64)-(__int64)lo, (unsigned __int64) -(__int64)div, remainder);
      }
   }
}
