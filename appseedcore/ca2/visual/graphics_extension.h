...
namespace visual
{
   ...
   public:
      ...
      void GetTextExtent(::ca::graphics * pdc, const char * lpcwsz, base_array < size, size & > & sizea);
      ...
      int _DrawText(::ca::graphics * pdc, const char * lpcsz, LPCRECT lpcrect, UINT uiFormat);
