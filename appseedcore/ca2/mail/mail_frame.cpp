...
/* // BEGIN_MESSAGE_MAP(mail_frame, simple_frame_window)
   //{{AFX_MSG_MAP(mail_frame)
   ON_WM_CREATE()
   ON_WM_GETMINMAXINFO()
   ON_WM_MOVE()
   ON_WM_CLOSE()
...
/////////////////////////////////////////////////////////////////////////////
// mail_frame construction/destruction

mail_frame::mail_frame(::ca::application * papp) :
   ca(papp),
...
mail_frame::~mail_frame()
{
}

int mail_frame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
BOOL mail_frame::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// mail_frame diagnostics

#ifdef _DEBUG
void mail_frame::assert_valid() const
{
   simple_frame_window::assert_valid();
}

void mail_frame::dump(dump_context & dumpcontext) const
{
...
void mail_frame::OnTimer(UINT nIDEvent) 
{
   static float theta;
   if(nIDEvent == 3)
   {
...
void mail_frame::SetAnimatedStatusBarText(const char * lpcsz)
{
...
void mail_frame::AnimateStatusBar()
{
   if(m_strAnimatedStatusBarText.is_empty())
      return;
...
void mail_frame::ShowControlBars(bool bShow)
{
   UINT nShow;
   if(bShow)
   {
