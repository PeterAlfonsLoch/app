...
/** \class ID3_Frame frame.h frame.h
 ...
 ** 
 ** Given an ID3_FrameID (a list of which is found in &lt;field.h&gt;),
...
ID3_Fields &    ID3_Frame::fields()
{
   return _impl->fields();
}

const ID3_Fields &    ID3_Frame::fields() const
{
   return _impl->fields();
}
...
void ID3_Frame::to(ID3_Writer& writer) const
{
  _impl->to(writer);
}
