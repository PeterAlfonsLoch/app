...
#define ID3_CATCH(code) try { code; } catch (...) { }
  ...
  ID3Tag_FindFrameWithUNICODE(const ID3Tag *tag, ID3_FrameID id,
                              ID3_FieldID fld, const wchar_t *data)
  {
    ID3_Frame *frame = NULL;

    if (tag)
    {
       ID3_CATCH(frame = reinterpret_cast<const ID3_Tag *>(tag)->Find(id, fld, gen::international::unicode_to_utf8(data)));
    }
...
/*  ID3_C_EXPORT void CCONV
  ID3Field_SetUNICODE(ID3Field *field, const wchar_t *string)
  {
    if (field)
    {
  ...
  ID3_C_EXPORT size_t CCONV
  ID3Field_GetUNICODE(const ID3Field *field, wchar_t *buffer, size_t maxChars)
  {
    size_t numChars = 0;
  ...
  ID3_C_EXPORT size_t CCONV
  ID3Field_GetUNICODEItem(const ID3Field *field, wchar_t *buffer,
  ...
  ID3_C_EXPORT void CCONV
  ID3Field_AddUNICODE(ID3Field *field, const wchar_t *string)
  {
    if (field)
    {
