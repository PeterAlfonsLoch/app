...
bool id3::v1::parse(ID3_TagImpl& tag, ID3_Reader& reader)
{
  ...
  if (title.get_length() > 0 && (field.get_length() == 0 || field == ""))
  {
  ...
  if (artist.get_length() > 0 && (field.get_length() == 0 || field == ""))
  {
  ...
  if (album.get_length() > 0 && (field.get_length() == 0 || field == ""))
  {
  ...
  if (year.get_length() > 0 && (field.get_length() == 0 || field == ""))
  {
  ...
  uchar genre;
  reader.read((char *) &genre);
  field = id3::v2::getGenre(tag);
  if (genre != 0xFF && (field.get_length() == 0 || field == ""))
  {
