...
{
  ID3TT_NONE       =      0,   /**< Represents an is_empty or non-existant tag */
...
ID3_ENUM(ID3_Err)
{
  ...
  ID3E_NoMemory,                /**< No available primitive::memory */
...
#define ID3LIB_MASK(bits) ((1 << (bits)) - 1)
#define ID3LIB_MASK1 ID3LIB_MASK(1)
#define ID3LIB_MASK2 ID3LIB_MASK(2)
#define ID3LIB_MASK3 ID3LIB_MASK(3)
#define ID3LIB_MASK4 ID3LIB_MASK(4)
#define ID3LIB_MASK5 ID3LIB_MASK(5)
#define ID3LIB_MASK6 ID3LIB_MASK(6)
#define ID3LIB_MASK7 ID3LIB_MASK(7)
#define ID3LIB_MASK8 ID3LIB_MASK(8)
