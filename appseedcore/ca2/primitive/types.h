...
#include "gen/MulDiv64.h"

#define MAKELONG64(a, b)      (((unsigned __int64)(((unsigned int)(((unsigned __int64)(a)) & 0xffffffff)) | ((unsigned __int64)((unsigned int)(((unsigned __int64)(b)) & 0xffffffff))) << 32)))
#define LODWORD(l)           ((unsigned int)(((unsigned __int64)(l)) & 0xffffffff))
#define HIDWORD(l)           ((unsigned int)((((unsigned __int64)(l)) >> 32) & 0xffffffff))
