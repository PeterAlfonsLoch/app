...
/////////////////////////////////////////////////////////////////////////////
// frame_window support for modality
...
void frame_window::InitialUpdateFrame(document * pDoc, BOOL bMakeVisible)
{
   ...
   {
      ::user::interaction * pWnd = GetDescendantWindow(AFX_IDW_PANE_FIRST);
...
//   DWORD dwOldStates = 0;
   ...
   else
   {
      ...
      if (hWnd != NULL)
      {
         ::user::interaction * hWndTemp = GetDlgItem(AFX_IDW_PANE_FIRST);
         if (hWndTemp != NULL)
            _AfxSetDlgCtrlID_(hWndTemp, AFX_IDW_PANE_SAVE);
         _AfxSetDlgCtrlID_(hWnd, AFX_IDW_PANE_FIRST);
      }
