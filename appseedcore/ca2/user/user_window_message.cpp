...
/*         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(base);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(create);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(timer);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(activate);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(move);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(size);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(scroll);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(mouse_wheel);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(mouse);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(mouse_activate);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(context_menu);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(set_cursor);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(show_window);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(on_draw);
         ...
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(ctl_color);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(set_focus);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(window_pos);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(measure_item);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(nc_calc_size);
         IMPLEMENT_SIGNAL_OBJECT_FIXED_ALLOC(enable);*/
