...
namespace mediaplay
{
   ...
   class CLASS_DECL_ca view_interface :
      ...
      virtual public midi_player_interface,
      ...
      virtual public mediaplaylist::callback_container_interface,
   ...
   //   virtual void data_on_after_change(int iConfigurationId, int iLine, int iColumn, CVmsDataUpdateHint * puh);
      ...
      virtual mediaplaylist::callback_interface * GetPlaylistCallback();
