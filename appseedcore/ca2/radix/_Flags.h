...
#include "_DispatchPtrArray.h"
#include "collection/_sort_array.h"

class CLASS_DECL_ca base_sort_serializable_int_ptr_array :
   virtual public ex1::serializable_array < BaseSortArray < INT_PTR, INT_PTR > >
{
...
{
   BaseSortArray < INT_PTR, INT_PTR >::copy(f);
	return *this;
}
...
{
   return BaseSortArray < INT_PTR, INT_PTR >::operator == (f);
}
