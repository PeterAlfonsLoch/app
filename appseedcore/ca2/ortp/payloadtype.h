...
extern CLASS_DECL_ca RtpProfile av_profile;
...
/* some payload types */
/* audio */
extern CLASS_DECL_ca PayloadType payload_type_pcmu8000;
extern CLASS_DECL_ca PayloadType payload_type_pcma8000;
extern CLASS_DECL_ca PayloadType payload_type_pcm8000;
extern CLASS_DECL_ca PayloadType payload_type_l16_mono;
extern CLASS_DECL_ca PayloadType payload_type_l16_stereo;
extern CLASS_DECL_ca PayloadType payload_type_lpc1016;
extern CLASS_DECL_ca PayloadType payload_type_g729;
extern CLASS_DECL_ca PayloadType payload_type_g7231;
extern CLASS_DECL_ca PayloadType payload_type_g7221;
extern CLASS_DECL_ca PayloadType payload_type_g726_40;
extern CLASS_DECL_ca PayloadType payload_type_g726_32;
extern CLASS_DECL_ca PayloadType payload_type_g726_24;
extern CLASS_DECL_ca PayloadType payload_type_g726_16;
extern CLASS_DECL_ca PayloadType payload_type_gsm;
extern CLASS_DECL_ca PayloadType payload_type_lpc;
extern CLASS_DECL_ca PayloadType payload_type_lpc1015;
extern CLASS_DECL_ca PayloadType payload_type_speex_nb;
extern CLASS_DECL_ca PayloadType payload_type_speex_wb;
extern CLASS_DECL_ca PayloadType payload_type_speex_uwb;
extern CLASS_DECL_ca PayloadType payload_type_ilbc;
extern CLASS_DECL_ca PayloadType payload_type_amr;
extern CLASS_DECL_ca PayloadType payload_type_amrwb;
extern CLASS_DECL_ca PayloadType payload_type_truespeech;
extern CLASS_DECL_ca PayloadType payload_type_evrc0;
extern CLASS_DECL_ca PayloadType payload_type_evrcb0;

extern CLASS_DECL_ca PayloadType payload_type_mp3_128;

/* video */
extern CLASS_DECL_ca PayloadType payload_type_mpv;
extern CLASS_DECL_ca PayloadType payload_type_h261;
extern CLASS_DECL_ca PayloadType payload_type_h263;
extern CLASS_DECL_ca PayloadType payload_type_h263_1998;
extern CLASS_DECL_ca PayloadType payload_type_h263_2000;
extern CLASS_DECL_ca PayloadType payload_type_mp4v;
extern CLASS_DECL_ca PayloadType payload_type_theora;
extern CLASS_DECL_ca PayloadType payload_type_h264;
extern CLASS_DECL_ca PayloadType payload_type_x_snow;
extern CLASS_DECL_ca PayloadType payload_type_t140;

/* non standard file transfer over UDP */
extern CLASS_DECL_ca PayloadType payload_type_x_udpftp;

/* telephone-event */
extern CLASS_DECL_ca PayloadType payload_type_telephone_event;
...
namespace rtp
{
   ...
   public:
      ...
      void set_payload(int idx, PayloadType *pt);
