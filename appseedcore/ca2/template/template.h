...
// Construction
   ...
   POSITION add_head(base_object_list* newElement)
      { return _typed_pointer_list<base_object_list, base_object_list*>::add_head((::radix::object*)newElement); }
   POSITION add_tail(base_object_list* newElement)
      { return _typed_pointer_list<base_object_list, base_object_list*>::add_tail((::radix::object*)newElement); }
...
public:
   ...
   void get_next_assoc(POSITION& rPosition, KEY& rKey, VALUE& rValue) const
      { BASE_CLASS::get_next_assoc(rPosition, (BASE_CLASS::BASE_KEY&)rKey,
