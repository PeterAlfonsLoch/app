...
namespace ca
{
   ...
   CLASS_DECL__ int SimpleDebugReport(int,const char *,int,const char *,const char * pszFormat, va_list list);

/*   CLASS_DECL__ int __cdecl ca2_votagus_logging_Report(
                                             int iReportType,
   ...
   extern CLASS_DECL__ int  ( __cdecl *  ________ca2_votagus_logging_Report)(
                                             int iReportType,
                                             const char * pszFileName,
                                             int iLineNumber,
                                             const char * pszModuleName,
