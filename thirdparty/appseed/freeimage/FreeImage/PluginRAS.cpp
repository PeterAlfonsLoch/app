...
static void
ReadData(FreeImageIO *io, fi_handle handle, BYTE *buf, DWORD length, int_bool rle) {
...
Load(FreeImageIO *io, fi_handle handle, int page, int flags, void *data) {
	...
	int_bool rle;			// TRUE if RLE file
	int_bool isRGB;			// TRUE if file type is RT_FORMAT_RGB
	BYTE fillchar;
