...
*/
static int_bool GaussianPyramid(FIBITMAP *H, FIBITMAP **pyramid, int nlevels) {
	try {
...
@return Returns TRUE if successful, returns FALSE otherwise
*/
static int_bool GradientPyramid(FIBITMAP **pyramid, int nlevels, FIBITMAP **gradients, float *avgGrad) {
	try {
		for(int k = 0; k < nlevels; k++) {
