 ...
 */
int DLL_CALLCONV
FreeImage_GetAdjustColorsLookupTable(BYTE *LUT, double brightness, double contrast, double gamma, int_bool invert) {
	double dblLUT[256];
	double value;
	int result = 0;
 ...
 */
int_bool DLL_CALLCONV
FreeImage_AdjustColors(FIBITMAP *dib, double brightness, double contrast, double gamma, int_bool invert) {
	BYTE LUT[256];
...
FreeImage_ApplyColorMapping(FIBITMAP *dib, RGBQUAD *srccolors, RGBQUAD *dstcolors, unsigned count, int_bool ignore_alpha, int_bool swap) {
	unsigned result = 0;
 ...
 */
unsigned DLL_CALLCONV
FreeImage_SwapColors(FIBITMAP *dib, RGBQUAD *color_a, RGBQUAD *color_b, int_bool ignore_alpha) {
 ...
 */
unsigned DLL_CALLCONV
FreeImage_ApplyPaletteIndexMapping(FIBITMAP *dib, BYTE *srcindices,	BYTE *dstindices, unsigned count, int_bool swap) {
	unsigned result = 0;
