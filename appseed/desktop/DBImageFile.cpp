...
bool DBImageFileSet::GetNextFile(LPCTSTR lpcszCurrentFilePath, String & wstrNextFilePath)
{
...
HRESULT DBImageFileSet::Add(const String &str)
{
	ASSERT(FALSE);
	return S_OK;
}
