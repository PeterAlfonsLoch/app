...
/*BOOL OptionsAudioDevicesView::Create(base_wnd* pParentWnd) 
{
...
void OptionsAudioDevicesView::_001InitializeFormPreData()
{
   ...
   control.m_bTransparent = true;
	...
	control.m_datakey = VMSDATAKEY(WaveInDevice);
   control.GetComboBox()->m_datakeyFill = VMSDATAKEY(WaveInDevices);
	_001AddControl(control);
