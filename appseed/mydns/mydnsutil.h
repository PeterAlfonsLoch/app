/**************************************************************************************************
	$Id: StdAfx.h,v 1.68 2005/04/28 18:43:46 bboy Exp $

	StdAfx.h: Support library for the MyDNS package.
...
#if USE_PGSQL
extern int	WarnSQL(PGconn *, const char *, ...);
extern void ErrSQL(PGconn *, const char *, ...);
extern char *sql_errmsg(PGconn *);
#else
extern int	WarnSQL(MYSQL *, const char *, ...);
extern void ErrSQL(MYSQL *, const char *, ...);
...
/* ip.c */
extern void		_sockclose(SOCKET);
#define			sockclose(fd)	_sockclose((fd)), (fd) = (SOCKET)-1
...
extern int		sdprintf(char **, const char *, ...);
