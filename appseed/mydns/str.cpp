...
/**************************************************************************************************
	MYDNS_CLASS_STR
	Returns a pointer to a static string describing the specified query/response protocol dnsclass.
**************************************************************************************************/
char *
mydns_class_str(dns_class_t c)
{
	...
	_snprintf(buf, sizeof(buf), "%03d", c);
	return (buf);
}
/*--- mydns_class_str() -------------------------------------------------------------------------*/
...
mydns_qtype_str(dns_qtype_t qtype)
{
	...
	_snprintf(buf, sizeof(buf), "%03d", qtype);
	return (buf);
}
/*--- mydns_qtype_str() -------------------------------------------------------------------------*/
...
mydns_opcode_str(dns_opcode_t opcode)
{
	...
	_snprintf(buf, sizeof(buf), "%03d", opcode);
	return (buf);
}
/*--- mydns_opcode_str() ------------------------------------------------------------------------*/
...
mydns_rcode_str(dns_rcode_t rcode)
{
	...
	_snprintf(buf, sizeof(buf), "%03d", rcode);
	return (buf);
}
/*--- mydns_rcode_str() -------------------------------------------------------------------------*/
