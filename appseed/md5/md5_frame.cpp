...
namespace md5
{
   ...
   void frame::_001InstallMessageHandling(::user::win::message::dispatch * pinterface)
   {
      ...
      IGUI_WIN_MSG_LINK(WM_CREATE, pinterface, this, &::md5::frame::_001OnCreate);
      IGUI_WIN_MSG_LINK(WM_TIMER, pinterface, this, &::md5::frame::_001OnTimer);
   }
   ...
   void frame::md5_fullscreen(bool bAlatel)
   {
      if(bAlatel)
      {
