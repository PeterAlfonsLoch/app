...
namespace iexca2
{
   ...
   class VLCEnumFORMATETC : public enum_iterator<IID_IEnumFORMATETC,
       IEnumFORMATETC,
       FORMATETC,
       std::vector<FORMATETC>::iterator>
   {
   public:
       VLCEnumFORMATETC(std::vector<FORMATETC> v) :
           enum_iterator<IID_IEnumFORMATETC,
           IEnumFORMATETC,
           FORMATETC,
           std::vector<FORMATETC>::iterator>(v.begin(), v.end())
       {};
   };

   ////////////////////////////////////////////////////////////////////////////////////////////////

   data_object::data_object(plugin *p_instance) : _p_instance(p_instance)
   {
