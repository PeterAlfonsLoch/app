...
namespace iexca2
{
   ...
   typedef std::pair < class AxVLCWSTR, class variant> AxVLCPropertyPair;
   typedef std::map < class AxVLCWSTR, class variant> AxVLCPropertyMap;
   ...
   public:
       ...
       STDMETHODIMP Write(LPCOLESTR pszPropName, VARIANT *pVar)
       {
           ...
           std::pair<AxVLCPropertyMap::iterator, bool> p = _pm.insert(val);
           if( false == p.second )
   ...
   persist_stream_init::persist_stream_init(plugin *p_instance) : _p_instance(p_instance)
   {
