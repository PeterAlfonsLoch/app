...
namespace iexca2
{
   ...
   STDMETHODIMP ole_control::GetControlInfo(CONTROLINFO *pCI)
   {
       if( NULL == pCI )
           return E_POINTER;
   ...
   STDMETHODIMP ole_control::OnMnemonic(LPMSG pMsg)
   {
       return S_OK;
   };

   STDMETHODIMP ole_control::OnAmbientPropertyChange(DISPID dispID)
   {
       HRESULT hr;
       LPOLEOBJECT oleObj;
   ...
   STDMETHODIMP ole_control::FreezeEvents(BOOL bFreeze)
   {
