...
//      SCAST_PTR(::user::win::message::create, pcreate, pobj)
      ...
      papp->::veiev::application::m_prightpaneview = this;
   ...
   void right_pane_view::on_update(::view * pSender, LPARAM lHint, ::radix::object* pHint) 
   {
      ...
      if(lHint == document::hint_veiev_profile_changed)
      {
   ...
   void right_pane_view::on_show_view() 
   {
      ...
      case pane_configuration:
         {
            m_cfg.on_show(get_document()->m_pprofile->m_strLogin);
         }
         break;
      case pane_text:
         {
            m_pveievview->open_elemental();
         }
         break;
      }
   }
