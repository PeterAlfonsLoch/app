   ...
   ex1::tree(papp)
{
   ...
   connect_update_cmd_ui("edit_copy", &primary_command_view::_001OnUpdateEditCopy);
   connect_command("edit_copy", &primary_command_view::_001OnEditCopy);
   connect_update_cmd_ui("edit_paste", &primary_command_view::_001OnUpdateEditPaste);
   connect_command("edit_paste", &primary_command_view::_001OnEditPaste);
}

void primary_command_view::on_update(::view* pSender, LPARAM lHint, ::radix::object* phint) 
{
...
void primary_command_view::_001OnUpdateEditCopy(gen::signal_object * pobj)
{
...
void primary_command_view::_001OnUpdateEditPaste(gen::signal_object * pobj)
{
   SCAST_PTR(base_cmd_ui, pcmdui, pobj)
   pcmdui->m_pcmdui->Enable(TRUE);
}
...
void primary_command_view::_001OnContextMenu(gen::signal_object * pobj) 
{
   SCAST_PTR(::user::win::message::context_menu, pcontextmenu, pobj)
   point point = pcontextmenu->GetPoint();

   ::userbase::menu menu(get_app());
   menu.LoadXmlMenu("veiev\\popup_primary_verbing.xml");
