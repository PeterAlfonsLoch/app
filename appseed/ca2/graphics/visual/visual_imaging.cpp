...
bool imaging::LoadImageFile(::draw2d::dib * pdib, var varFile, sp(::ca2::application) papp)
{
   ...
   COLORREF crAlpha)
{
   ...
   {
   ::draw2d::bitmap * pbitmapOriginal = pdc->SelectObject(bitmapLocal);
   ...
   ::draw2d::bitmap * bitmapOld = spgraphics->SelectObject(bitmapLocal);
...
::draw2d::bitmap_sp imaging::LoadImageSync(const char * lpcszImageFilePath, sp(::ca2::application) papp)
{
...
bool imaging::LoadImageSync(::draw2d::dib * pdib, const char * lpcszImageFilePath, sp(::ca2::application) papp)
{
...
/*
HBITMAP
imaging::LoadSysColorBitmap(::draw2d::graphics * pdcCompatible, HINSTANCE hInst, HRSRC hRsrc, bool bMono)
{
HGLOBAL hglb;
