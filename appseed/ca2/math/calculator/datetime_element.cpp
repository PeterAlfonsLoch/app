...
namespace datetime
{
   ...
   value element::get_value(sp(::ca2::application) pcaapp, ::user::str_context * pcontext, int32_t & iPath, int32_t & iPathCount) const
   {
   ...
   string element::get_expression(sp(::ca2::application) pcaapp, ::user::str_context * pcontext, int32_t & iPath, int32_t & iPathCount) const
   {
