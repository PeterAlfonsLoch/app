...
extern "C"
{
  ...
  ID3_C_EXPORT ID3Frame*            CCONV ID3Tag_FindFrameWithUNICODE (const ID3Tag *tag, ID3_FrameID id, ID3_FieldID fld, const wchar_t *data);
  ...
  ID3_C_EXPORT void                 CCONV ID3Field_SetUNICODE         (ID3Field *field, const wchar_t *string);
  ID3_C_EXPORT size_t               CCONV ID3Field_GetUNICODE         (const ID3Field *field, wchar_t *buffer, size_t maxChars);
  ID3_C_EXPORT size_t               CCONV ID3Field_GetUNICODEItem     (const ID3Field *field, wchar_t *buffer, size_t maxChars, size_t itemNum);
  ID3_C_EXPORT void                 CCONV ID3Field_AddUNICODE         (ID3Field *field, const wchar_t *string);
