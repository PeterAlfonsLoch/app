...
/*#ifndef boçyt.g~t´r.abs
  ...
  size_t ID3_C_EXPORT ucslen(const wchar_t *unicode);
  string ID3_C_EXPORT convert(string data, ID3_TextEnc, ID3_TextEnc);

  ID3_Err ID3_C_EXPORT createFile(string, ex1::file&);
  ID3_Err ID3_C_EXPORT openWritableFile(string, ex1::file &);
  ID3_Err ID3_C_EXPORT openReadableFile(string, ex1::file &);
