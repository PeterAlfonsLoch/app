...
namespace dami
{
  namespace io
  {
    /**
     **/
    class CLASS_DECL_ca ExitTrigger
    {
      ID3_Reader& _reader;
    ...
    ID3_C_EXPORT primitive::memory       readAllBinary(ID3_Reader&);
    ID3_C_EXPORT primitive::memory       readBinary(ID3_Reader&, size_t);
    ...
    ID3_C_EXPORT size_t       writestring(ID3_Writer&, const stringa & string);
    ID3_C_EXPORT size_t       writeText(ID3_Writer&, const stringa & string);
    //ID3_C_EXPORT size_t       writeUnicodestring(ID3_Writer&, const stringa & string, bool = true);
    //ID3_C_EXPORT size_t       writeUnicodeText(ID3_Writer&, const stringa &  string, bool = true);
