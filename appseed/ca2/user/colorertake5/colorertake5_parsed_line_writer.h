...
namespace colorertake5
{
   ...
   */
   ...
   public:
      ...
      */
      static void tokenWrite(::file::output_stream & markupWriter, ::file::output_stream & textWriter, string_to_string_map * docLinkHash, const char  *line, LineRegion *lineRegions);
      ...
      @param lineRegions Linked list of LineRegion structures
      */
      static void markupWrite(::file::output_stream & markupWriter, ::file::output_stream & textWriter, string_to_string_map *docLinkHash, const char *line, LineRegion *lineRegions);
      ...
      @param lineRegions Linked list of LineRegion structures
      */
      static void htmlRGBWrite(::file::output_stream & markupWriter, ::file::output_stream & textWriter, string_to_string_map *docLinkHash, const char *line, LineRegion *lineRegions);
      ...
      */
      ...
      static void writeHref(::file::output_stream & writer, string_to_string_map *docLinkHash, const class scheme *scheme, const string &token, bool start);
