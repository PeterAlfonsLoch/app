...
namespace colorertake5
{
   ...
   */
   ...
   public:
      ...
      */
      static void tokenWrite(::file::byte_output_stream & markupWriter, ::file::byte_output_stream & textWriter, string_to_string_map * docLinkHash, const char  *line, LineRegion *lineRegions);
      ...
      @param lineRegions Linked list of LineRegion structures
      */
      static void markupWrite(::file::byte_output_stream & markupWriter, ::file::byte_output_stream & textWriter, string_to_string_map *docLinkHash, const char *line, LineRegion *lineRegions);
      ...
      @param lineRegions Linked list of LineRegion structures
      */
      static void htmlRGBWrite(::file::byte_output_stream & markupWriter, ::file::byte_output_stream & textWriter, string_to_string_map *docLinkHash, const char *line, LineRegion *lineRegions);

      static void writeStyle(::file::byte_output_stream & writer, const StyledRegion *lr);

      /** Puts into stream starting HTML \<span> tag with requested style specification
      */
      static void writeStart(::file::byte_output_stream & writer, const StyledRegion *lr);

      /** Puts into stream ending HTML \</span> tag
      */
      static void writeEnd(::file::byte_output_stream & writer, const StyledRegion *lr);

      static void writeHref(::file::byte_output_stream & writer, string_to_string_map *docLinkHash, const class scheme *scheme, const string &token, bool start);
