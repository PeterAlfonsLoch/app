...
namespace colorertake5
{
   ...
   */
      ...
      */
      void ParsedLineWriter::tokenWrite(::ca2::byte_output_stream & markupWriter, ::ca2::byte_output_stream & textWriter, string_to_string_map * docLinkHash, const char  *line, LineRegion *lineRegions)
      {
         ...
         for(LineRegion *l1 = lineRegions; l1; l1 = l1->next){
            ...
            while(region != NULL){
               string token0 = ::ca2::str::replace(":", "-", region->getName());
               string token = ::ca2::str::replace(".", "-", token0);
               markupWriter << token;
      ...
      @param lineRegions Linked list of LineRegion structures
      */
      void ParsedLineWriter::markupWrite(::ca2::byte_output_stream & markupWriter, ::ca2::byte_output_stream & textWriter, string_to_string_map *docLinkHash, const char *line, LineRegion *lineRegions)
      {
         UNREFERENCED_PARAMETER(docLinkHash);
      ...
      @param lineRegions Linked list of LineRegion structures
      */
      void ParsedLineWriter::htmlRGBWrite(::ca2::byte_output_stream & markupWriter, ::ca2::byte_output_stream & textWriter, string_to_string_map *docLinkHash, const char *line, LineRegion *lineRegions)
      {
      ...
      */
      void ParsedLineWriter::writeStyle(::ca2::byte_output_stream & writer, const StyledRegion *lr){
      ...
      */
      void ParsedLineWriter::writeStart(::ca2::byte_output_stream & writer, const StyledRegion *lr){
      ...
      */
      void ParsedLineWriter::writeEnd(::ca2::byte_output_stream & writer, const StyledRegion *lr){
         if (!lr->bfore && !lr->bback) return;
         writer << "</span>";
      }

      void ParsedLineWriter::writeHref(::ca2::byte_output_stream & writer, string_to_string_map *docLinkHash, const class scheme *scheme, const string &token, bool start){
         string url;
         if (scheme != NULL){
