...
namespace colorertake5
{
   ...
   */
      ...
      */
      void ParsedLineWriter::tokenWrite(::file::byte_output_stream & markupWriter, ::file::byte_output_stream & textWriter, string_to_string_map * docLinkHash, const char  *line, LineRegion *lineRegions)
      {
      ...
      @param lineRegions Linked list of LineRegion structures
      */
      void ParsedLineWriter::markupWrite(::file::byte_output_stream & markupWriter, ::file::byte_output_stream & textWriter, string_to_string_map *docLinkHash, const char *line, LineRegion *lineRegions)
      {
         UNREFERENCED_PARAMETER(docLinkHash);
      ...
      @param lineRegions Linked list of LineRegion structures
      */
      void ParsedLineWriter::htmlRGBWrite(::file::byte_output_stream & markupWriter, ::file::byte_output_stream & textWriter, string_to_string_map *docLinkHash, const char *line, LineRegion *lineRegions)
      {
      ...
      */
      void ParsedLineWriter::writeStyle(::file::byte_output_stream & writer, const StyledRegion *lr){
      ...
      */
      void ParsedLineWriter::writeStart(::file::byte_output_stream & writer, const StyledRegion *lr){
      ...
      */
      void ParsedLineWriter::writeEnd(::file::byte_output_stream & writer, const StyledRegion *lr){
         if (!lr->bfore && !lr->bback) return;
         writer << "</span>";
      }

      void ParsedLineWriter::writeHref(::file::byte_output_stream & writer, string_to_string_map *docLinkHash, const class scheme *scheme, const string &token, bool start){
         string url;
         if (scheme != NULL){
