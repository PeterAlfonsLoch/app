...
{
public:
  RegionMapperImpl(sp(::application) papp) : element(papp){};
  ~RegionMapperImpl(){};

  /** Loads region defines from @ca is input_source
  */
  virtual void  loadRegionMappings(::file::byte_input_stream & reader) = 0;
  /** Saves all loaded region defines into @ca writer.
      ...
      documents.
  */
  virtual void  saveRegionMappings(::file::byte_output_stream & writer) const = 0;
