...
namespace colorertake5
{
   ...
   TextHRDMapper::TextHRDMapper(sp(base_application) papp) :
      element(papp),
   ...
   */
   void TextHRDMapper::loadRegionMappings(::file::byte_input_stream & is)
   {
...
//               delete rd->sback; delete rd->eback;
   ...
   */
   void TextHRDMapper::saveRegionMappings(::file::byte_output_stream & writer) const
   {
