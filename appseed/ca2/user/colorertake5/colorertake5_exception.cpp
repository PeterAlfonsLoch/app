...
namespace colorertake5
{
   ...
   exception::exception(sp(::application) papp) :
      element(papp),
      ::call_stack(papp),
      ::exception::base(papp)
   {
   ...
   exception::exception(sp(::application) papp, const string &msg) :
      element(papp),
      ::call_stack(papp),
      ::exception::base(papp)
   {
...
/*   InputSourceException::InputSourceException(sp(::application) papp)
         element(papp),
      ::call_stack(papp),
      ::exception::base(papp)
