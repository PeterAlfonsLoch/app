...
StyledHRDMapper::StyledHRDMapper(sp(base_application) papp) :
   element(papp),
...
void StyledHRDMapper::loadRegionMappings(::file::byte_input_stream & istream)
{
...
*/
void StyledHRDMapper::saveRegionMappings(::file::byte_output_stream & writer) const
{
