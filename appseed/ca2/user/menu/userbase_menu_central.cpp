...
BaseMenuCentral::BaseMenuCentral(sp(::application) papp) :
   element(papp),
   m_fontMenu(allocer())
{
...
BaseMenuCentral * BaseMenuCentral::GetMenuCentral(sp(::application) papp)
{
...
bool BaseMenuCentralContainer::initialize_central_container(sp(::application) papp)
{
