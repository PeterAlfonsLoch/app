...
{
public:
   static BaseMenuCentral * GetMenuCentral(sp(::application) papp);
   BaseMenuCentral(sp(::application) papp);
...
public:
   ...
   virtual bool initialize_central_container(sp(::application) papp);
