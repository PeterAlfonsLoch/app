...
namespace frame
{
   ...
   void WorkSet::message_handler(::ca2::signal_object * pobj)
   {
      relay_event(pobj);
   }

   void WorkSet::relay_event(::ca2::signal_object * pobj)
   {
      ...
      sp(::user::interaction)pwndCommand)
   {
      ...
      _001InstallEventHandling(dynamic_cast < ::ca2::message::dispatch * >(pwndEvent->m_pimpl.m_p));
   ...
   void WorkSet::_001OnCommand(::ca2::signal_object * pobj)
   {
   ...
   void WorkSet::hover_relay_event(::ca2::signal_object * pobj)
   {
      SCAST_PTR(::ca2::message::base, pbase, pobj);
      if(m_bHoverModeOn)
      {
   ...
   void WorkSet::WindowProcHover(sp(::user::interaction) pwnd, ::ca2::signal_object * pobj)
   {
      UNREFERENCED_PARAMETER(pwnd);
      SCAST_PTR(::ca2::message::base, pbase, pobj);
      if(m_bHoverModeOn)
   ...
   void WorkSet::WindowProcBefore(sp(::user::interaction) pwnd, ::ca2::signal_object * pobj)
   {
   ...
   void WorkSet::_001OnActivate(::ca2::signal_object * pobj)
   {
   ...
   void WorkSet::_001OnNcActivate(::ca2::signal_object * pobj)
   {
   ...
   void WorkSet::_001InstallEventHandling(::ca2::message::dispatch * pdispatch)
   {
   ...
   void WorkSet::_001OnLButtonDown(::ca2::signal_object * pobj)
   {
   ...
   void WorkSet::_001OnMouseMove(::ca2::signal_object * pobj)
   {
      SCAST_PTR(::ca2::message::mouse, pmouse, pobj)
      if(!m_bEnable)
      {
...
//      point ptCursor = pmouse->m_pt;
   ...
   void WorkSet::_001OnLButtonUp(::ca2::signal_object * pobj)
   {
      SCAST_PTR(::ca2::message::mouse, pmouse, pobj)
      if(!m_bEnable)
      {
   ...
   void WorkSet::_001OnNcLButtonDown(::ca2::signal_object * pobj)
   {
      SCAST_PTR(::ca2::message::mouse, pmouse, pobj)
      if(!m_bEnable)
      {
   ...
   void WorkSet::_001OnNcMouseMove(::ca2::signal_object * pobj)
   {
      SCAST_PTR(::ca2::message::mouse, pmouse, pobj)
      if(!m_bEnable)
      {
...
//      point pt(pmouse->m_pt);
   ...
   void WorkSet::_001OnNcLButtonUp(::ca2::signal_object * pobj)
   {
      SCAST_PTR(::ca2::message::mouse, pmouse, pobj)
      if(!m_bEnable)
      {
   ...
   void WorkSet::_001OnNcHitTest(::ca2::signal_object * pobj)
   {
   ...
   void WorkSet::_001OnTimer(::ca2::signal_object * pobj)
   {
      //return; //xxxtimer
   ...
   void WorkSet::_001OnSize(::ca2::signal_object * pobj)
   {
   ...
   void WorkSet::_001OnMove(::ca2::signal_object * pobj)
   {
