...
namespace user
{
   ...
   CLASS_DECL_ca2 sp(::user::interaction) create_virtual_window(sp(::application) papp, uint32_t dwExStyle, const char * lpClassName, const char * lpWindowName, uint32_t dwStyle,
