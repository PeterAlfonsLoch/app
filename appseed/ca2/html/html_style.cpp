...
#define n_to_b(nible) ((nible << 4) | (nible))
   ...
   bool style::get_border_color(const char * pszName, const char * pszSubClass, data * pdata, elemental * pelemental, border & box)
   {
      ...
      iCur              = i1;
      varCur            = var1;
      pdata->m_stylesheeta.greater(pstyleCur, iCur, varCur, pstyleCur, iCur, varCur, pstyleLeft, iLeft, crLeft);
      pdata->m_stylesheeta.greater(pstyleCur, iCur, varCur, pstyleCur, iCur, varCur, pstyleLeftW, iLeftW, crLeftW);
      box.crLeft        = varCur;

      pstyleCur         = pstyle1;
      iCur              = i1;
      varCur            = var1;
      pdata->m_stylesheeta.greater(pstyleCur, iCur, varCur, pstyleCur, iCur, varCur, pstyleTop, iTop, crTop);
      pdata->m_stylesheeta.greater(pstyleCur, iCur, varCur, pstyleCur, iCur, varCur, pstyleTopW, iTopW, crTopW);
      box.crTop         = varCur;
   ...
   float style::parse_dimension(const char * psz)
   {
      ...
      str.trim();
      if(gen::str::ends_eat_ci(str, "px"))
      {
         str.trim();
         return (float) strtod(str, NULL);
      }
      else if(gen::str::ends_eat_ci(str, "pt"))
      {
         str.trim();
      ...
      if(iFindDigit >= 0 && iFindColor >= 0 && iFindDigit > iFindColor)
      {
         ...
         if(iFindRgb >= 0)
         {
            try
            {
               ...
               gen::str::consume(psz, "(");
               gen::str::consume_spaces(psz, 0);
               gen::str::consume_natural(psz, 255);
               gen::str::consume_spaces(psz, 0);
               gen::str::consume(psz, ",");
               gen::str::consume_spaces(psz, 0);
               gen::str::consume_natural(psz, 255);
