 ...
 namespace oAuthLibDefaults
   ...
   *--*/
      ...
      string & oAuthSignature )
   {
      ...
      objHMACSHA1.HMAC_SHA1( (unsigned char*)(const char*)sigBase,
         sigBase.get_length(),
         (unsigned char*)(const char*)secretSigningKey,
         secretSigningKey.get_length(),
         memHmac.get_data() );
      //System.crypt().hmac(memKey, sigBase, memHmac);
