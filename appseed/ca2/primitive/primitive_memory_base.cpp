...
namespace primitive
{
   ...
   void memory_base::FullLoad(::ca2::file & file)
   {
   ...
   void memory_base::read(::ca2::byte_input_stream & istream)
   {
   ...
   void memory_base::write(::ca2::byte_output_stream & ostream)
   {
   ...
   ::primitive::memory_size memory_base::read(::ca2::file & file)
   {
