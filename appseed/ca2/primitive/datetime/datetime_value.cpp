...
namespace datetime
{
   ...
   value span_strtotime(sp(::application) pcaapp, ::user::str_context * pcontext, const char * pszSpanExpression)
   {
   ...
   value strtotime(sp(::application) pcaapp, ::user::str_context * pcontext, const char * psz, int32_t & iPath, int32_t & iPathCount)
   {
      ::datetime::time time;
      string str(psz);
      str.trim();
   ...
   string value::to_string(sp(::application) pcaapp, ::user::str_context * pcontext)
   {
      string str;
      if(m_bSpan)
      {
