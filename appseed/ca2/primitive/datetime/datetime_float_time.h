...
CLASS_DECL_ca2 int_bool   FileTimeToLocalFileTime(const FILETIME *utcft, LPFILETIME localft );
CLASS_DECL_ca2 int_bool   FileTimeToSystemTime(const FILETIME * ft, LPSYSTEMTIME syst);
