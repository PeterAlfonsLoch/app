 ...
 */
CLASS_DECL_ca2 INT SystemTimeToFloatTime(LPSYSTEMTIME lpSt, double *pDateOut)
{
  UDATE ud;
 ...
 */
CLASS_DECL_ca2 HRESULT FloatTimeFromUdate(UDATE *pUdateIn, ULONG dwFlags, DATE *pDateOut)
{
 ...
 *  Failure: E_INVALIDARG, if pUdateIn cannot be represented in VT_DATE format.
 */
CLASS_DECL_ca2 HRESULT FloatTimeFromUdateEx(UDATE *pUdateIn, LCID lcid, ULONG dwFlags, DATE *pDateOut)
{
  UDATE ud;
 ...
 */
CLASS_DECL_ca2 HRESULT FloatTimeFromStr(const char * strIn, LCID lcid, ULONG dwFlags, DATE* pdateOut)
{
