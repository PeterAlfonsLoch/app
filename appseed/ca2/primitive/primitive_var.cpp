...
bool var::has_property(const char * pszName) const
{
   ...
   {
      if(ca2 < property_set >() != NULL)
      {
         return ca2 < property_set >()->has_property(pszName);
      }
      else if(ca2 < property >() != NULL)
      {
         return ca2 < property >()->name().CompareNoCase(pszName) == 0;
      }
      else
      {
         return false;
