...
namespace collection
{
   ...
   public:
      ...
      list(const class list < TYPE, ARG_TYPE > & l);
   ...
   // Operations
      ...
      list < TYPE, ARG_TYPE > & operator = (const class list < TYPE, ARG_TYPE > & l);
   ...
   template<class TYPE, class ARG_TYPE>
   list<TYPE, ARG_TYPE>::list(const class list < TYPE, ARG_TYPE > & l)
   {
	   m_nCount = 0;
	   m_pnodeHead = m_pnodeTail = m_pnodeFree = NULL;
	   m_pBlocks = NULL;
