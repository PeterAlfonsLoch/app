...
namespace ca
{
   ...
   byte_stream_memory_file::byte_stream_memory_file(sp(::ca::application) papp, ::primitive::memory_size iSize) :
      ca(papp),
   ...
   byte_stream_memory_file::byte_stream_memory_file(sp(::ca::application) papp, void * pMemory, primitive::memory_size dwSize) :
      ca(papp),
   ...
   byte_stream_memory_file::byte_stream_memory_file(sp(::ca::application) papp, const memory_file & memoryfile) :
      ca(papp),
      memory_container(papp),
   ...
   byte_stream_memory_file::byte_stream_memory_file(sp(::ca::application) papp, ::primitive::memory_base * pmemory) :
      ca(papp),
