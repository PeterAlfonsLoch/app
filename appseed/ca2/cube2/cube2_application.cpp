...
namespace cube2
{
   ...
   bool application::update_appmatter(const char * pszRoot, const char * pszRelative, const char * pszLocale, const char * pszStyle)
   {
      ...
      if(_ca_is_basis())
      {
         strUrl = "http://basis.spaignition.api.veriverdi.net/download?authnone&version=basis&stage=";
      }
      else
      {
         strUrl = "http://stage.spaignition.api.veriverdi.net/download?authnone&version=stage&stage=";
      }
