...
namespace zip
{
   ...
   void Util::ls(sp(::application) papp, const char * lpszFileName, bool bRecursive, stringa * pstraPath, stringa * pstraTitle, stringa * pstraRelative, array < bool, bool > * pbaIsDir, array < int64_t, int64_t > * piaSize, e_extract eextract)
   {
      string strZip;
      string strRemain;
      string strLastZip;
   ...
   void Util::ls_dir(sp(::application) papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle)
   {
      stringa straPath;
      stringa straTitle;
   ...
   bool Util::HasSubFolder(sp(::application) papp, const char * lpszFileName)
   {
      string strZip;
      if(::str::ends_ci(lpszFileName, ".zip"))
      {
...
//      smart_pointer_array < File, File & > filea;
  ...
  /*    stringa wstraPath;
   ...
   bool Util::exists(sp(::application) papp, const char * pszPath)
   {
      return extract(papp, pszPath, NULL);
   }

   bool Util::extract(sp(::application) papp, const char * lpszFileName, const char * lpszExtractFileName)
   {
   ...
   bool Util::extract_all(const char * pszDir, sp(::file::file) pfile)
   {
   ...
   bool Util::IsUnzipable(sp(::application) papp, const char * lpszFileName)
   {
