...
extern zipFile CLASS_DECL_ca2 zipOpen2 OF((const char *pathname,
                                   int32_t append,
                                   zipcharpc* globalcomment,
                                   zlib_filefunc_def* pzlib_filefunc_def));

extern int32_t CLASS_DECL_ca2 zipOpenNewFileInZip OF((zipFile file,
                       const char* filename,
...
extern int32_t CLASS_DECL_ca2 zipOpenNewFileInZip2 OF((zipFile file,
                                            const char* filename,
                                            const zip_fileinfo* zipfi,
                                            const void * extrafield_local,
                                            uint32_t size_extrafield_local,
...
extern int32_t CLASS_DECL_ca2 zipOpenNewFileInZip3 OF((zipFile file,
                                            const char* filename,
                                            const zip_fileinfo* zipfi,
                                            const void * extrafield_local,
                                            uint32_t size_extrafield_local,
...
extern int32_t CLASS_DECL_ca2 zipWriteInFileInZip OF((zipFile file,
                       const void * buf,
                       uint32_t len));
/*
...
extern int32_t CLASS_DECL_ca2 zipCloseFileInZip OF((zipFile file));
/*
  close the current file in the zipfile
*/


extern int32_t CLASS_DECL_ca2 zipCloseFileInZipRaw OF((zipFile file,
...
extern int32_t CLASS_DECL_ca2 zipClose OF((zipFile file,
