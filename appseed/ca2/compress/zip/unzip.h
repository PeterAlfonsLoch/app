...
extern int32_t CLASS_DECL_ca2 unzStringFileNameCompare OF ((const char* fileName1,
...
extern unzFile CLASS_DECL_ca2 unzOpen2 OF((const char *path,
...
extern int32_t CLASS_DECL_ca2 unzClose OF((unzFile file));
/*
...
extern int32_t CLASS_DECL_ca2 unzGetGlobalInfo OF((unzFile file,
...
extern int32_t CLASS_DECL_ca2 unzGetGlobalComment OF((unzFile file,
                                           char *szComment,
                                           uint_ptr uSizeBuf));
/*
...
extern int32_t CLASS_DECL_ca2 unzGoToFirstFile OF((unzFile file));
/*
  set the current file of the zipfile to the first spfile->
  return UNZ_OK if there is no problem
*/

extern int32_t CLASS_DECL_ca2 unzGoToNextFile OF((unzFile file));
/*
...
extern int32_t CLASS_DECL_ca2 unzLocateFile OF((unzFile file,
...
extern int32_t CLASS_DECL_ca2 unzGetFilePos(
    unzFile file,
    unz_file_pos* file_pos);

extern int32_t CLASS_DECL_ca2 unzGoToFilePos(
    unzFile file,
    unz_file_pos* file_pos);

/* ****************************************** */

extern int32_t CLASS_DECL_ca2 unzGetCurrentFileInfo OF((unzFile file,
...
extern int32_t CLASS_DECL_ca2 unzOpenCurrentFile OF((unzFile file));
/*
  open for reading data the current file in the zipfile.
  If there is no error, the return value is UNZ_OK.
*/

extern int32_t CLASS_DECL_ca2 unzOpenCurrentFilePassword OF((unzFile file,
                                                  const char* password));
/*
  open for reading data the current file in the zipfile.
...
extern int32_t CLASS_DECL_ca2 unzOpenCurrentFile2 OF((unzFile file,
                                           int32_t* method,
                                           int32_t* level,
                                           int32_t raw));
/*
...
extern int32_t CLASS_DECL_ca2 unzCloseCurrentFile OF((unzFile file));
/*
  close the file in zip opened with unzOpenCurrentFile
  Return UNZ_CRCERROR if all the file was read but the CRC is not good
*/

extern int32_t CLASS_DECL_ca2 unzReadCurrentFile OF((unzFile file,
                      voidp buf,
                      uint32_t len));
/*
...
extern int_ptr CLASS_DECL_ca2 unztell OF((unzFile file));
/*
  Give the current position in uncompressed data
*/

extern int32_t CLASS_DECL_ca2 unzeof OF((unzFile file));
/*
  return 1 if the end of file was reached, 0 elsewhere
*/

extern int32_t CLASS_DECL_ca2 unzGetLocalExtrafield OF((unzFile file,
                                             voidp buf,
                                             uint32_t len));
/*
