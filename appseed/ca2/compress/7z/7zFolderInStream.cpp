...
namespace n7z
{
   ...
   HRESULT CFolderInStream::OpenStream()
   {
      ...
      {
         ::ca::smart_pointer < ::ca2::byte_input_stream > stream;
         ...
         {
            _fileIsOpen = true;
            ::ca::smart_pointer < ::ca2::stream_get_size > streamGetSize;
            streamGetSize = dynamic_cast < ::ca2::stream_get_size * > (stream.m_p);
            if (streamGetSize)
            {
