...
namespace libcompress
{
   ...
   namespace coder_mixer
   {
      ...
      struct CCoder2: public CCoderInfo2, public ::ca2::thread
      {
         ...
         CCoder2(sp(base_application) papp, uint32_t numInStreams, uint32_t numOutStreams);
      ...
      */
      ...
      public:
         ...
         CCoderMixer2MT(sp(base_application) papp);

         ::ca2::HRes Code(spa(::file::reader) & inStreams,
