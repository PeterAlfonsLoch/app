...
namespace rar
{
   ...
   public:
      ...
      input_file_exception(sp(::ca2::application) papp, CCauseType cause) :
         ca2(papp),
         ::call_stack(papp),
         ::base_exception(papp),
   ...
   public:
      ...
      sp(::ca2::byte_input_stream)                      m_Stream;
      ...
      HRESULT Open2(::ca2::byte_input_stream *stream, const file_position *searchHeaderSizeLimit);
      ...
      HRESULT Open(::ca2::byte_input_stream *inStream, const file_position *searchHeaderSizeLimit);
      void Close();
      ...
      ::ca2::reader * CreateLimitedStream(file_position position, file_size size);
   };
