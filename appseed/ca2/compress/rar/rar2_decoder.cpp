...
#define RIF(x) { if (!(x)) return false; }
      ...
      HRESULT decoder::CodeReal(::ca2::reader *inStream, ::ca2::writer *outStream,
      ...
      ::ca2::HRes decoder::Code(::ca2::reader *inStream, ::ca2::writer *outStream, const file_size * inSize, const file_size * outSize, ::libcompress::progress_info_interface *progress)
      {
