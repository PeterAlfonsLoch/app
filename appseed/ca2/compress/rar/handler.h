...
namespace rar
{
   ...
   public:
      ...
      //HRESULT Open2(::ca2::byte_input_stream *stream, // seekable input stream
      HRESULT Open2(::ca2::byte_input_stream * stream, const file_position * maxCheckStartPosition,  ::libcompress::archive_open_callback_interface *openCallback);
