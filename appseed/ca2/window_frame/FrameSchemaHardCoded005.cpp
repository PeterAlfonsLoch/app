...
//      SetStyle(StyleLightBlue);
   ...
   bool FrameSchemaHardCoded005::_000OnNcHitTest(point pt, LRESULT & nHitTest)
   {
   ...
   bool FrameSchemaHardCoded005::_000OnMove(int x, int y)
   {
   ...
   bool FrameSchemaHardCoded005::_000OnSize( UINT nType, int cx, int cy )
   {
...
//         int cx2 = rectClient.width();
  //       int cy2 = rectClient.height();
   ...
   void FrameSchemaHardCoded005::SetStyle(EStyle estyle)
   {
       m_estyle = estyle;
   ...
   int FrameSchemaHardCoded005::UpdateControlBox()
   {
      ::user::interaction * pwndDraw = GetDrawWindow();
...
//      int iWidth = cx - m_iMargin * 2;
  //    int iHeight = cy - m_iMargin * 2 - iCaptionHeight;
   ...
   void FrameSchemaHardCoded005::OnAppearanceModeChange()
   {
   ...
   int FrameSchemaHardCoded005::GetMargin()
   {
...
//      int iMargin = GetMargin();
   ...
   void FrameSchemaHardCoded005::OnNcCalcSize(LPRECT lprect)
   {
   ...
   void FrameSchemaHardCoded005::UpdateWndClientRect()
   {
      ::user::interaction * pwnd = m_pworkset->GetDrawWindow();
   ...
   void FrameSchemaHardCoded005::CalcWndClient(LPRECT lprect, LPCRECT lprectWindow)
   {
   ...
   void FrameSchemaHardCoded005::UpdateWndRegion(LPCRECT lpcrectWindow)
   {
      ::user::interaction * pwnd = GetWnd();
...
//      ::user::interaction * pwnd = GetWnd();
   ...
   void FrameSchemaHardCoded005::UpdateWnd()
   {
      UpdateWndStyle();
      //UpdateWndRegion();
   }

   ::user::interaction * FrameSchemaHardCoded005::GetWnd()
   {
      try
      {
   ...
   ::user::interaction * FrameSchemaHardCoded005::GetDrawWindow()
   {
      return GetWnd();
   }
   ...
   void FrameSchemaHardCoded005::UpdateDrawingObjects()
   {
//      gen::savings & savings = System.savings();
      ::user::interaction * pwndDraw = GetDrawWindow();
...
//      int cy = rectClient.height();
   ...
   bool FrameSchemaHardCoded005::_000OnDisplayChange(int iBitsPerPixel, size sizeScreen)
   {
   ...
   void FrameSchemaHardCoded005::GetWndClientRect(LPRECT lprect)
   {
      *lprect = m_rectClient;
   }

   void FrameSchemaHardCoded005::GetDrawClientRect(LPRECT lprect)
   {
       rect rect;
   ...
   bool FrameSchemaHardCoded005::GetElementRect(LPRECT lprect, EElement eelement)
   {
      switch(eelement)
      {
   ...
   bool FrameSchemaHardCoded005::hit_test(const POINT &point, EElement &eelementParam)
   {
      rect rect;
   ...
   FrameSchemaHardCoded005::EElement operator++(FrameSchemaHardCoded005::EElement & eelement, int i)
   {
      UNREFERENCED_PARAMETER(i);
      return (FrameSchemaHardCoded005::EElement) (*((int*)&eelement))++;
   }

   void FrameSchemaHardCoded005::OnActivate()
   {
      UpdateControlBox();
   }

   void FrameSchemaHardCoded005::_000OnBeforeMove(LPCRECT lpcrect)
   {
      UpdateWndRegion(lpcrect);
   }

   void FrameSchemaHardCoded005::_000OnBeforeSize(LPCRECT lpcrect)
   {
