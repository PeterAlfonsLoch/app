   ...
   void pane_tab_view::on_create_view(::user::view_creator_data * pcreatordata)
   {
      ...
      if(pcreatordata->m_id.is_text())
      {
              ...
              || pcreatordata->m_id == "right_file")
         {
            ...
            ::filemanager::document * pdoc = Application.GetStdFileManagerTemplate()->OpenChild(&Application.filemanager(), true, true, pcreatordata->m_pholder, pfilemanagerdata);
            if(pdoc != NULL)
            {
         ...
         else if(pcreatordata->m_id == "tabbed_file_manager")
         {
            ...
            ::filemanager::document * pdoc = Application.GetStdFileManagerTemplate()->open(&Application.filemanager(), cc);
