...
namespace userbase
{
   ...
   single_document_template::single_document_template(::ax::application * papp, const char * pszMatter, ::ax::type_info & pDocClass, ::ax::type_info & pFrameClass, ::ax::type_info & pViewClass) :
      ax(papp),
