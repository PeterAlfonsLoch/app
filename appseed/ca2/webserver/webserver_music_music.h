...
namespace webserver
{
   ...
   namespace music
   {
      ...
      public:
         ...
         var file_get_file(var filename, ::webserver::music::song ** ppsong);
         var file_get_file_by_kar_file_id(var karfileid, ::webserver::music::song ** ppsong);
         var file_test_file(var filename, ::webserver::music::song ** ppsong);
