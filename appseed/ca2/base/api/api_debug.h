...
#ifndef CLASS_DECL__
#ifdef  _DLL
#define CLASS_DECL__ __declspec(dllimport)
#else   /* ndef _DLL */
#define CLASS_DECL__
#endif  /* _DLL */
#endif  /* CLASS_DECL__ */
...
#if !defined(_M_CEE_PURE)
CLASS_DECL__ _CRT_REPORT_HOOK DECL_C _CrtGetReportHook(
    void
    );
#endif
...
#if !defined(_M_CEE_PURE)
CLASS_DECL__ extern long _crtBreakAlloc;      /* Break on this allocation */
#endif /* !defined(_M_CEE_PURE) */
...
_Check_return_ _Ret_opt_bytecap_(_Size) CLASS_DECL__ void * DECL_C _aligned_malloc_dbg(
        _In_ size_t _Size,
        _In_ size_t _Alignment,
        _In_opt_z_ const char * _Filename,
        _In_ int32_t _LineNumber
...
_Success_(return!=0)
_Check_return_ _Ret_opt_bytecap_(_NewSize) CLASS_DECL__ void * DECL_C _aligned_realloc_dbg(
        _Post_ptr_invalid_ void * _Memory,
        _In_ size_t _NewSize,
        _In_ size_t _Alignment,
        _In_opt_z_ const char * _Filename,
...
_Success_(return!=0)
_Check_return_ _Ret_opt_bytecap_x_(_NumOfElements*_SizeOfElements) CLASS_DECL__ void * DECL_C _aligned_recalloc_dbg
(
        _Post_ptr_invalid_ void * _Memory,
        _In_ size_t _NumOfElements,
        _In_ size_t _SizeOfElements,
...
_Success_(return!=0)
_Check_return_ _Ret_opt_bytecap_(_NewSize) CLASS_DECL__ void * DECL_C _aligned_offset_realloc_dbg(
        _Post_ptr_invalid_ void * _Memory,
        _In_ size_t _NewSize,
        _In_ size_t _Alignment,
        _In_ size_t _Offset,
...
_Success_(return!=0)
_Check_return_ _Ret_opt_bytecap_x_(_NumOfElements*_SizeOfElements) CLASS_DECL__ void * DECL_C _aligned_offset_recalloc_dbg
(
        _Post_ptr_invalid_ void * _Memory,
        _In_ size_t _NumOfElements,
        _In_ size_t _SizeOfElements,
 ...
 ***************************************************************************/
#if !defined(_M_CEE_PURE)
CLASS_DECL__ _CRT_ALLOC_HOOK DECL_C _CrtGetAllocHook
(
    void
);
#endif
 ...
 */
#if !defined(_M_CEE_PURE)
CLASS_DECL__ _CRT_ALLOC_HOOK DECL_C _CrtSetAllocHook
(
...
#if !defined(_M_CEE_PURE)
CLASS_DECL__ _CRT_DUMP_CLIENT DECL_C _CrtGetDumpClient
(
    void
);
#endif
 ...
 */
#if !defined(_M_CEE_PURE)
CLASS_DECL__ _CRT_DUMP_CLIENT DECL_C _CrtSetDumpClient
(
