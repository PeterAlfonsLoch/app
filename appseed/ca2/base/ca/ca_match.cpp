...
namespace ca2
{
   ...
   namespace match
   {
      ...
      {
         return ::ca2::str::begins(var.get_string(), m_str);
      }
      ...
      {
         return ::ca2::str::begins_ci(var.get_string(), m_str);
      }
      ...
      {
         return ::ca2::str::ends(var.get_string(), m_str);
      }
      ...
      {
         return ::ca2::str::ends_ci(var.get_string(), m_str);
      }
