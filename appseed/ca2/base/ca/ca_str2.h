...
namespace ca2
{
   ...
   namespace str
   {
      ...
      inline CLASS_DECL_ca2  string  from(uchar uch)
      {
         string str;
         from(str, uch);
         return str;
      ...
      inline CLASS_DECL_ca2  string  from(int16_t i)
      {
         string str;
         from(str, i);
         return str;
      ...
      inline CLASS_DECL_ca2  string  from(uint16_t ui)
      {
         string str;
         from(str, ui);
         return str;
      ...
      inline CLASS_DECL_ca2 bool     trimmed_is_empty(const char * psz)
      {
