...
POSITION object_list::add_head(::ca2::object* newElement)
{
...
POSITION object_list::add_tail(::ca2::object* newElement)
{
...
::ca2::object* object_list::remove_head()
{
   ENSURE_VALID(this);
   ...
   ::ca2::object* returnValue = pOldNode->m_pdata;
...
::ca2::object* object_list::remove_tail()
{
   ASSERT_VALID(this);
...
POSITION object_list::insert_before(POSITION position, ::ca2::object* newElement)
{
...
POSITION object_list::insert_after(POSITION position, ::ca2::object* newElement)
{
...
POSITION object_list::find(::ca2::object* searchValue, POSITION startAfter) const
{
   ASSERT_VALID(this);
