...
//         dispatch_event_ok()->wait();
   ...
   //xxx      UnhookMessageHandler(this);
      ...
      base::base(sp(::application) papp, ::ca2::signal * psignal) :
         element(papp),
      ...
      base::base(sp(::application) papp, sp(::user::interaction) pwnd, UINT uiMessage, WPARAM wparam, LPARAM lparam, LRESULT & lresult) :
         element(papp),
         signal_details(papp)
      {
         m_lresult = 0;
      ...
      activate::activate(sp(::application) papp) :
         element(papp),
      ...
      erase_bkgnd::erase_bkgnd(sp(::application) papp) :
         element(papp),
         ::ca2::message::base(papp)
      {
      }
      ...
      nc_activate::nc_activate(sp(::application) papp) :
         element(papp),
         ::ca2::message::base(papp)
      {
      }
      ...
      mouse::mouse(sp(::application) papp) :
         element(papp),
         base(papp),
