...
_AFX_INLINE CArchiveException::~CArchiveException()
   { }*/
/*_AFX_INLINE ::ca2::file_exception_sp::ca2::file_exception_sp(int32_t cause, LONG lOsError,
...
// ::ca2::filesp
_AFX_INLINE ::ca2::filesp::operator HANDLE() const
   { return m_hFile; }
_AFX_INLINE ULONGLONG ::ca2::filesp::SeekToEnd()
   { return seek(0, ::ca2::filesp::end); }
_AFX_INLINE void ::ca2::filesp::seek_to_begin()
   { seek(0, ::ca2::filesp::begin); }
_AFX_INLINE void ::ca2::filesp::SetFilePath(LPCTSTR lpszNewName)
{
   ASSERT_VALID(this);
...
_AFX_INLINE sp(::ca2::file) CArchive::GetFile() const
   { return m_pFile; }
...
/*   { }
CLASS_DECL_ca2api00000001 CArchive& operator<<(CArchive& ar, const ::ca2::object* pOb);
_AFX_INLINE CArchive& operator>>(CArchive& ar, ::ca2::object*& pOb)
   { pOb = ar.ReadObject(NULL); return ar; }
_AFX_INLINE CArchive& operator>>(CArchive& ar, const ::ca2::object*& pOb)
   { pOb = ar.ReadObject(NULL); return ar; }
