...
#include "../../Common/StreamUtils.h"*/
   ...
   byte_input_stream & byte_input_stream::operator >> (sp(type) info)
   {
      {
         int32_t iLen;
   ...
   byte_output_stream & byte_output_stream::operator << (sp(type) info)
   {
   ...
   HRESULT ReadStream(::file::reader * stream, void * data, ::primitive::memory_size * processedSize)
   {
