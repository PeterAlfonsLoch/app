...
namespace ca2
{
   ...
   plain_text_input_stream & plain_text_input_stream::operator >> (sp(type) info)
   {
      {
         int32_t iLen;
   ...
   plain_text_output_stream & plain_text_output_stream::operator << (sp(type) info)
   {
