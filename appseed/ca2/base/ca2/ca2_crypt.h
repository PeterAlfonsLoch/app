...
namespace ca2
{
   ...
   public:
      ...
      bool file_set(var varFile, const char * pszData, const char * pszSalt, sp(::application) papp);
      bool file_get(var varFile, string & str, const char * pszSalt, sp(::application) papp);
   ...
   typedef smart_pointer < crypt > crypt_sp;
