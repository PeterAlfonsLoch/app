...
namespace ca2
{
   ...
   string prepare_basic_authentication(sp(::ca2::application) papp, const char * inParam1, const char * inParam2 );
   ...
   *
   *--*/
   twit::twit(sp(::ca2::application) papp) :
      ca2(papp),
      m_oauth(papp)
   {
   ...
   *
   *--*/
   bool twit::performGet( const string & getUrl, ::ca2::property_set & headers)
   {
      string dataStrDummy( "" );
      ::ca2::property_set post;
   ...
   bool twit::performPost( const string & getUrl, ::ca2::property_set & headers, ::ca2::property_set & post)
   {
   ...
   *
   *--*/
   bool twit::performPost( const string & postUrl, ::ca2::property_set & post )
   {
