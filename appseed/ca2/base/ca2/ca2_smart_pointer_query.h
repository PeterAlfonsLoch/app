...
template < class T >
inline ::ca2::smart_pointer_query < T > ca_smart_pointer_query(smart_pointer < T > & sp)
{
...
template < class T >
inline ::ca2::smart_pointer_query < T > ca_smart_pointer_query(const smart_pointer < T > & sp)
{
   return sp;
}
