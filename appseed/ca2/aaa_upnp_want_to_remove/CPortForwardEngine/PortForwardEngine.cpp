...
#include "stdafx.h"  // NOTE: Delete this line if you are not using pre-compiled headers
...
BOOL CPortForwardEngine::GetMappingsUsingThread( oswindow hWnd )
{
...
BOOL CPortForwardEngine::EditMappingUsingThread( CPortForwardEngine::PortMappingContainer& oldMapping,
					CPortForwardEngine::PortMappingContainer& newMapping, oswindow hWnd )
{
	// returns TRUE if thread was started successfully
...
BOOL CPortForwardEngine::AddMappingUsingThread( CPortForwardEngine::PortMappingContainer& newMapping, oswindow hWnd )
{
	// returns TRUE if thread was started successfully
...
BOOL CPortForwardEngine::DeleteMappingUsingThread( CPortForwardEngine::PortMappingContainer& oldMapping, oswindow hWnd )
{
	// returns TRUE if thread was started successfully
...
BOOL CPortForwardEngine::GetDeviceInformationUsingThread( oswindow hWnd )
{
	// returns TRUE if thread was started successfully
...
HRESULT CPortForwardEngine::PopulateDeviceInfoContainer( IUPnPDevice* piDevice,
				CPortForwardEngine::DeviceInformationContainer& deviceInfo, oswindow hWnd /* =NULL */ )
{
	USES_CONVERSION;  // for conversion to CString's
