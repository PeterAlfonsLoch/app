...
//      cc->m_usercreatecontext.m_pCurrentDoc = get_document();
  //    cc->m_usercreatecontext.m_typeinfoNewView = System.template type_info < tree > ();
      ::user::interaction* pwnd = create_view(System.template type_info < tree > (), get_document(), this, 100);
      SetPane(0, pwnd, false);
//      tree * ptree = dynamic_cast < tree * > (pwnd);


//      cc->m_usercreatecontext.m_pCurrentDoc = get_document();
  //    cc->m_usercreatecontext.m_typeinfoNewView = System.template type_info < list > ();
      pwnd = create_view(System.template type_info < list > (), get_document(), this, 101);
