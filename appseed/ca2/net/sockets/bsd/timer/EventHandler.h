...
namespace sockets
{
   ...
   private:
      ...
      EventHandler(sp(::application) papp, const EventHandler& ) : element(papp), socket_handler(papp) {} // copy constructor
   ...
   public:
      ...
      EventHandler(sp(::application) papp, StdLog * = NULL);
      EventHandler(sp(::application) papp, mutex &,StdLog * = NULL);
      ~EventHandler();
