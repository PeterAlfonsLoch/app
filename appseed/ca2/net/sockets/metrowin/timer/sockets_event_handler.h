...
namespace sockets
{
   ...
   private:
      ...
      EventHandler(::ca2::application * papp, const EventHandler& ) : ca2(papp), socket_handler(papp) {} // copy constructor
   ...
   public:
      ...
      EventHandler(::ca2::application * papp, StdLog * = NULL);
      EventHandler(::ca2::application * papp, mutex &,StdLog * = NULL);
      ~EventHandler();
