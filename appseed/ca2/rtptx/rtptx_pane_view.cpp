      ...
      case PaneViewVideo:
         {
            ...
            rtptx::document * pdoc = dynamic_cast < rtptx::document * > (papp->m_ptemplateVideo->open_document_file(createcontext));
            if(pdoc != NULL)
            {
            ...
            /*         create_context cc;
            cc.m_pCurrentDoc = get_document();
            cc.m_typeinfoNewView =  ::ca::get_type_info < rtptx::view > ();
