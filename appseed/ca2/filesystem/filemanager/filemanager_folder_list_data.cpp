...
namespace filemanager
{
   ...
   folder_list_data::folder_list_data(sp(::ca2::application) papp) :
      ca2(papp),
      ::user::list_data(papp)
   {
   }
   ...
   void folder_list_data::_001GetItemText(::user::list_item * pitem)
   {
      ...
      {
         bool_array ba;
         if(!data_get("recursive", ::ca2::system::idEmpty, ba))
         {
            pitem->m_bOk = false;
            return;
         }
   ...
   bool folder_list_data::add_unique(const stringa & stra, bool_array & baRecursive)
   {
      ...
      bool_array baData;
      data_get("recursive", ::ca2::system::idEmpty, baData);
      ...
      if(!data_set(::ca2::system::idEmpty, ::ca2::system::idEmpty, straData))
         return false;
      if(!data_set("recursive", ::ca2::system::idEmpty, baData))
         return false;
      return true;
   }
