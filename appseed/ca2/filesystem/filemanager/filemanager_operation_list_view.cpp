...
file_manager_operation_list_view::file_manager_operation_list_view(sp(::application) papp) :
   element(papp),
   m_headerctrl(papp),
...
void file_manager_operation_list_view::_001OnInitialUpdate(signal_details * pobj)
{
...
void file_manager_operation_list_view::_001OnCreate(signal_details * pobj)
{
   pobj->previous();
