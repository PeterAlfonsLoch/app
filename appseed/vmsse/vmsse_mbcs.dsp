...
!MESSAGE 
!MESSAGE NMAKE /f "vmsse_mbcs.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "vmsse_mbcs.mak" CFG="vmsse - Win32 Debug"
!MESSAGE 
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "..\vmsdb" /I "..\vmsmus" /I "..\vmsgen" /I "..\vmsgui" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /D "_USRDLL" /D "_ATL_DLL" /FR /Yu"stdafx.h" /FD /GZ /c
...
# ADD LINK32 rpcrt4.lib vmsdb.lib vmsmus.lib vmsgen.lib vmsgui.lib /nologo /subsystem:windows /dll /debug /machine:I386 /nodefaultlib:"libc.lib" /nodefaultlib:"libcmt.lib" /nodefaultlib:"libcd.lib" /nodefaultlib:"libcmtd.lib" /nodefaultlib:"msvcrt.lib" /out:"..\_DebugMbcs/vmsse.dll" /pdbtype:sept /libpath:"..\_DebugMbcs"
# SUBTRACT LINK32 /nodefaultlib
# Begin Custom Build - Performing registration
OutDir=.\..\_DebugMbcs
TargetPath=\vms\current\_DebugMbcs\vmsse.dll
InputPath=\vms\current\_DebugMbcs\vmsse.dll
SOURCE="$(InputPath)"
...
# Begin Custom Build - Performing registration
OutDir=.\DebugU
TargetPath=.\DebugU\vmsse_mbcs.dll
InputPath=.\DebugU\vmsse_mbcs.dll
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseMinSize\vmsse_mbcs.dll
InputPath=.\ReleaseMinSize\vmsse_mbcs.dll
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseMinDependency\vmsse_mbcs.dll
InputPath=.\ReleaseMinDependency\vmsse_mbcs.dll
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseUMinSize\vmsse_mbcs.dll
InputPath=.\ReleaseUMinSize\vmsse_mbcs.dll
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseUMinDependency\vmsse_mbcs.dll
InputPath=.\ReleaseUMinDependency\vmsse_mbcs.dll
SOURCE="$(InputPath)"
...
# ADD CPP /nologo /MD /W3 /GR /GX /O1 /I "..\vmsgui" /I "..\vmsdb" /I "..\vmsgen" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_WINDLL" /D "_AFXDLL" /D "_MBCS" /D "_USRDLL" /D "_ATL_DLL" /Yu"stdafx.h" /FD /c
# SUBTRACT CPP /Fr
# ADD BASE RSC /l 0x416 /d "NDEBUG" /d "_AFXDLL"
# ADD RSC /l 0x416 /d "NDEBUG" /d "_AFXDLL"
BSC32=bscmake.exe
...
# ADD LINK32 rpcrt4.lib vmsgui.lib vmsdb.lib vmsgen.lib /nologo /subsystem:windows /dll /pdb:none /machine:I386 /nodefaultlib:"libc.lib" /nodefaultlib:"libcmt.lib" /nodefaultlib:"libcd.lib" /nodefaultlib:"libcmtd.lib" /nodefaultlib:"msvcrtd.lib" /out:"..\_ReleaseMbcs/vmsse.dll" /libpath:"..\_Release"
# SUBTRACT LINK32 /debug
# Begin Custom Build - Performing registration
OutDir=.\..\_ReleaseMbcs
TargetPath=\vms\current\_ReleaseMbcs\vmsse.dll
InputPath=\vms\current\_ReleaseMbcs\vmsse.dll
SOURCE="$(InputPath)"
...
TargetPath=\vms\current\_ReleaseDebug\vmsse_mbcs.dll
InputPath=\vms\current\_ReleaseDebug\vmsse_mbcs.dll
SOURCE="$(InputPath)"
