...
CLASS_DECL_c void strncpy_dup(char * dest, const char * cat, int iLen);
CLASS_DECL_c int  strlen_dup(const char * cat);
CLASS_DECL_c char * strdup_dup(const char * src);
CLASS_DECL_c char * strndup_dup(const char * src, int iLen);
...
CLASS_DECL_c int strnicmp_dup(const char * sz1, const char * sz2, int iLen);
CLASS_DECL_c int strncmp_dup(const char * sz1, const char * sz2, int iLen);
...
CLASS_DECL_c void zero_pad(char * sz, int iPad);
