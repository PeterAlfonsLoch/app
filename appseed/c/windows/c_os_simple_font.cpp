...
bool simple_font::create_point(int nPointSize, const char * lpszFaceName, simple_graphics & g, bool bBold)
{
   ...
   m_pfont = new Gdiplus::Font(lpszFaceName, nPointSize / 10.0, bBold ? Gdiplus::FontStyleBold : Gdiplus::FontStyleRegular, Gdiplus::UnitPoint);
...
bool simple_font::create_pixel(int nPointSize, const char * lpszFaceName, simple_graphics & g, bool bBold)
{
   ...
   m_pfont = new Gdiplus::Font(lpszFaceName, nPointSize * 0.7 / 10.0, bBold ? Gdiplus::FontStyleBold : Gdiplus::FontStyleRegular, Gdiplus::UnitPixel);
