...
namespace hex
{
   ...
   inline CLASS_DECL_c int32_t to(char ch)
   {
      if(ch >= '0' && ch <= '9')
         return ch - '0';
      else
   ...
   inline CLASS_DECL_c char lower_from(byte b)
   {
   ...
   inline CLASS_DECL_c char upper_from(byte b)
   {
   ...
   inline CLASS_DECL_c void lower_from(char * sz, byte b)
   {
   ...
   inline CLASS_DECL_c void upper_from(char * sz, byte b)
   {
