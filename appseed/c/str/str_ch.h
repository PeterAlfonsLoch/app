...
#include "c/x/x_defines.h"
#include "c/x/x_tables.h"
...
namespace str
{
   ...
   namespace ch
   {
      ...
      CLASS_DECL_c  int64_t uni_index(const char * pszUtf8);
      CLASS_DECL_c  int64_t uni_index_len(const char * pszUtf8, strsize & len);
      CLASS_DECL_c  int64_t uni_index(const char * pszUtf8, const char * pszEnd);
      ...
      CLASS_DECL_c string to_lower_case(const char * pszUtf8Char);
      CLASS_DECL_c string to_upper_case(const char * pszUtf8Char);
      CLASS_DECL_c string to_title_case(const char * pszUtf8Char);

      CLASS_DECL_c bool is_lower_case(const char * pszUtf8Char);
      CLASS_DECL_c bool is_upper_case(const char * pszUtf8Char);
      CLASS_DECL_c bool is_title_case(const char * pszUtf8Char);
      CLASS_DECL_c bool is_letter(const char * pszUtf8Char);
      CLASS_DECL_c bool is_letter_or_digit(const char * pszUtf8Char);
      CLASS_DECL_c bool is_digit(const char * pszUtf8Char);
      CLASS_DECL_c bool is_assigned(const char * pszUtf8Char);
      CLASS_DECL_c bool is_space_char(const char * pszUtf8Char);
      CLASS_DECL_c bool is_whitespace(const char * pszUtf8Char);
      CLASS_DECL_c bool is_whitespace(const char * pszUtf8Char, const char * pszEnd);

      CLASS_DECL_c bool is_number(const char * pszUtf8Char);
//      CLASS_DECL_c bool to_numeric_value(const char * pszUtf8Char, float *f);

      CLASS_DECL_c string get_category_name(const char * pszUtf8Char);
      ECharCategory get_category(const char * pszUtf8Char);

      CLASS_DECL_c int32_t get_combining_class(const char * pszUtf8Char);
      CLASS_DECL_c bool is_mirrored(const char * pszUtf8Char);

      /** @deprecated For debug purposes only. */
      CLASS_DECL_c int32_t size_of_tables();
