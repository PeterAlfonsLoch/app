...
CLASS_DECL_c bool ms_download_dup(const char * pszUrl, const char * pszFile, bool bProgress, bool bUrlEncode = false, int32_t * piStatus = NULL, void (*callback)(void *, int32_t, dword_ptr) = NULL, void * callback_param = NULL);
