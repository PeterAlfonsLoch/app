...
CLASS_DECL_c int32_t strnicmp_dup(const char * sz1, const char * sz2, count iLen);
CLASS_DECL_c int32_t strncmp_dup(const char * sz1, const char * sz2, count iLen);
...
CLASS_DECL_c char to_lower(int32_t ch);
