...
//#ifdef WINDOWS
DEFINE_C_NUMBER(CLASS_DECL_c, os_lock_duration, uint32_t)
//#endif

//DEFINE_C_NUMBER(CLASS_DECL_c, file_size        , uint64_t)
//DEFINE_C_NUMBER(CLASS_DECL_c, file_position    , uint64_t)
//DEFINE_C_NUMBER(CLASS_DECL_c, file_offset      ,  int64_t)
...
namespace numeric_info
{
   ...
   template < typename T > class CLASS_DECL_c offset < ::c_number < T > > { public: typedef typename ::numeric_info::offset < T >::TYPE TYPE; };
   template < typename T > class CLASS_DECL_c type   < ::c_number < T > > { public: typedef typename ::numeric_info::type   < T >::TYPE TYPE; };
