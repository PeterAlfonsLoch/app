...
CLASS_DECL_c bool is_debugger_attached();


CLASS_DECL_c bool EnforceFilter( bool bEnforce );
   ...
   // 
CLASS_DECL_c bool WriteMemory( BYTE* pTarget, const BYTE* pSource, uint32_t size );
