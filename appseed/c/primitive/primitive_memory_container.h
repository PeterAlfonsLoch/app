...
namespace primitive
{
   ...
   class CLASS_DECL_c memory_container :
   ...
   public:
      ...
      memory_container(sp(::application) papp);
      memory_container(sp(::application) papp, void * pMemory, memory_size dwSize);
      memory_container(sp(::application) papp, memory_base * pmemory);
