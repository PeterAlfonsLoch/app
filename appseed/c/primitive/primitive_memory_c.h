...
//DEFINE_C_NUMBER(CLASS_DECL_c, memory_size         , uint64_t)
//DEFINE_C_NUMBER(CLASS_DECL_c, memory_position     , uint64_t)
//DEFINE_C_NUMBER(CLASS_DECL_c, memory_offset       ,  int64_t)
...
//DEFINE_C_NUMBER(CLASS_DECL_c,   memory_size         , uint32_t)
//DEFINE_C_NUMBER(CLASS_DECL_c,   memory_position     , uint32_t)
//DEFINE_C_NUMBER(CLASS_DECL_c,   memory_offset       ,  int32_t)
