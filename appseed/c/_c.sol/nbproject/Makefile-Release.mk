...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/OracleSolarisStudio-Solaris-x86/lib_c.sol.so

dist/Release/OracleSolarisStudio-Solaris-x86/lib_c.sol.so: ${OBJECTFILES}
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/OracleSolarisStudio-Solaris-x86/lib_c.sol.so
