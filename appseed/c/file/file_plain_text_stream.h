...
namespace file
{
   ...
   class CLASS_DECL_c plain_text_input_stream :
   ...
   public:
      ...
      plain_text_input_stream & operator >> (sp(type) info);
   ...
   class CLASS_DECL_c plain_text_output_stream :
   ...
   public:
      ...
      plain_text_output_stream & operator << (sp(type) info);
...
/*
   CLASS_DECL_c HRESULT ReadStream(reader * stream, void *data, uint64_t *size);
   CLASS_DECL_c HRESULT ReadStream_FALSE(reader * stream, void *data, uint64_t size);
   CLASS_DECL_c HRESULT ReadStream_FAIL(reader * stream, void *data, uint64_t size);
   CLASS_DECL_c HRESULT WriteStream(writer * stream, const void *data, uint64_t size);
   */
