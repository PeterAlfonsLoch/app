...
namespace file
{
   ...
   class CLASS_DECL_c byte_input_stream  :
   ...
   public:
      ...
      byte_input_stream & operator >> (sp(type) info);
      ...
      byte_input_stream & operator >> (string & str);
   ...
   class CLASS_DECL_c byte_output_stream :
   ...
   public:
      ...
      byte_output_stream & operator << (sp(type) info);
      ...
      byte_output_stream & operator << (const string & str);
   ...
   CLASS_DECL_c HRESULT ReadStream(reader * stream, void * data, ::primitive::memory_size * size);
   CLASS_DECL_c HRESULT ReadStream_FALSE(reader * stream, void * data, ::primitive::memory_size size);
   CLASS_DECL_c HRESULT ReadStream_FAIL(reader * stream, void * data, ::primitive::memory_size size);
   CLASS_DECL_c HRESULT WriteStream(writer * stream, const void * data, ::primitive::memory_size size);
