...
typedef CLASS_DECL_c sort_attrib_map < sort_map < int32_t, int32_t, int32_t, int32_t > > sort_int_to_int;
typedef CLASS_DECL_c sort_attrib_map < sort_map < int32_t, int32_t, string, const string & > > sort_int_to_string;
typedef CLASS_DECL_c sort_string_map < void *, void * > sort_string_to_ptr;

template < class T >
class CLASS_DECL_c sort_string_to_pointer :
...
typedef CLASS_DECL_c sort_string_map < int_ptr, int_ptr > sort_string_to_intptr;

typedef CLASS_DECL_c sort_string_map < string, const string & > sort_string_to_string_map;
