...
namespace cube
{
   ...
   int application::exit_instance()
   {
      ...
      {
         return mplite::application::exit_instance();
      }
      else if(m_strId == "status")
      {
      ...
      else if(chFirst == 'v')
      {
         ...
         {
            return vmsp::application::exit_instance();
         }
      }
      else if(chFirst == 'w')
      {
   ...
   void application::on_request(::ca::create_context * pcreatecontext)
   {
      ...
      else if(chFirst == 'v')
      {
         ...
         {
            return vmsp::application::on_request(pcreatecontext);
         }
         else if(strId == "veriview")
         {
      ...
      {
         return mplite::application::on_request(pcreatecontext);
      }
