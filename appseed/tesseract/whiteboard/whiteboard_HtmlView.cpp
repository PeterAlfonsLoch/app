...
/*      if (::html_view::OnCreate(lpCreateStruct) == -1)
   ...
   void html_view::OnBeforeNavigate2(var & varFile, DWORD nFlags, const char * lpszTargetFrameName, byte_array& baPostedData, const char * lpszHeaders, BOOL* pbCancel)
   {
...
//      whiteboard::application * papp = dynamic_cast < whiteboard::application * > (&Application);
      ...
      if(gen::str::begins_eat(str, "WhiteboardSpecialFrameFor:MRTS"))
      {
         html_view::OnBeforeNavigate2(varFile, nFlags, lpszTargetFrameName, baPostedData, lpszHeaders, pbCancel);
         return;
      }
      */
   ...
   //   whiteboard::application * papp = (whiteboard::application *) &Application;
   ...
   //      *ppDisp = pview->GetApplication();
      ...
      else*/
      {
         ...
         papp->m_ptemplate->CreateHtmlWnd(true);
   //      *ppDisp = pview->GetApplication();
      }
   }
