...
namespace whiteboard
{
   ...
   void document::OnBeforeNavigate2(html::data * pdata, var & varFile, DWORD nFlags, const char * lpszTargetFrameName, byte_array& baPostedData, const char * lpszHeaders, BOOL* pbCancel)
   {
      ...
      {
         string strPath;
         userhour_create_file(varFile, strCmd);
         //Navigate(strPath);
      }
      else if(strCmd.Left(8) == "userhour")
      {
         varFile = System.dir().path(strUserHourUrl, strCmd);
         userhour_create_file(varFile, strCmd);
      }
   ...
   {
      strDir = Application.dir().userappdata("whiteboard/userhour");
   }
   ...
   void document::WriteUserHourFile(string & strPath, const char * lpcszQuery)
   {
      ...
      spfile->open(strPath, ::ex1::file::type_text | ::ex1::file::mode_create
         | ::ex1::file::mode_write | ::ex1::file::defer_create_directory);
