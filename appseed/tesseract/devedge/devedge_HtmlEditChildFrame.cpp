#include "StdAfx.h"
#include "HtmlEditChildFrame.h"

devedgeHtmlEditChildFrame::devedgeHtmlEditChildFrame(::ca::application * papp) :
   ca(papp),
   ...
   m_toolbar(papp)
{
   IGUI_WIN_MSG_LINK(gen::application::APPM_LANGUAGE, this, this, &devedgeHtmlEditChildFrame::_001OnAppLanguage);
}

devedgeHtmlEditChildFrame::~devedgeHtmlEditChildFrame()
{
}



bool devedgeHtmlEditChildFrame::CreateBars()
{
...
BOOL devedgeHtmlEditChildFrame::PreCreateWindow(CREATESTRUCT& cs)
{
...
bool devedgeHtmlEditChildFrame::DestroyBars()
{
...
bool devedgeHtmlEditChildFrame::_001OnCmdMsg(BaseCmdMsg * pcmdmsg)  
{
...
void devedgeHtmlEditChildFrame::OnChangeEditSearch()
{
...
int devedgeHtmlEditChildFrame::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void devedgeHtmlEditChildFrame::_001OnAppLanguage(gen::signal_object * pobj)
{
   CreateBars();
   pobj->m_bRet = false;
}
...
FileManagerInterface * devedgeHtmlEditChildFrame::GetFileManager()
{
   return dynamic_cast <FileManagerInterface *>(GetActiveDocument());
}

/*void devedgeHtmlEditChildFrame::GetSelected(::fs::item_array &itema)
{
