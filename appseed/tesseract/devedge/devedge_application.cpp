...
namespace devedge 
{
   ...
   bool application::initialize_instance()
   {
      ...
      devedge::application_interface::m_ptemplateEdge = new ::userbase::single_document_template(
         this, 
         "devedge/frame", 
         ::ca::get_type_info < MainDoc > (), 
         ::ca::get_type_info < main_frame > (), 
         ::ca::get_type_info < devedge::pane_view > ());
      ...
      m_ptemplate_solution = new ::userbase::single_document_template(
         this, 
         "devedge/frame", 
         ::ca::get_type_info < devedge::solution_document > (), 
         ::ca::get_type_info < devedge_child_frame > (), 
         ::ca::get_type_info < devedge::solution_view > ());

      add_document_template(devedge::application_interface::m_ptemplate_solution);

      m_ptemplateHtmlEdit = new ::userbase::single_document_template(
         this, 
         "devedge/frame", 
         ::ca::get_type_info < devedgeHtmlEditDoc > (), 
         ::ca::get_type_info < devedgeHtmlEditChildFrame > (), 
         ::ca::get_type_info < devedgeHtmlEditView > ());

      add_document_template(devedge::application_interface::m_ptemplateHtmlEdit);

      devedge::application_interface::m_ptemplateHtml = new ::userbase::single_document_template(
         this, 
         "devedge/frame", 
         ::ca::get_type_info < devedgeHtmlDoc > (),
         ::ca::get_type_info < devedgeHtmlChildFrame > (), 
         ::ca::get_type_info < devedgeHtmlView > ());

      add_document_template(devedge::application_interface::m_ptemplateHtml);

      devedge::application_interface::m_ptemplateFront = new ::userbase::single_document_template(
         this,
         "devedge/frame", 
         ::ca::get_type_info < devedgeFrontDoc > (),
         ::ca::get_type_info < devedgeFrontChildFrame > (), 
         ::ca::get_type_info < devedgeFrontView > ());
...
*/
   void application::on_request(::ca::create_context * pcreatecontext)
   {
      ...
      {
         devedge::application_interface::m_ptemplateEdge->open_document_file(pcreatecontext);
      }
      ...
      if(pmaindoc != NULL)
      {
         ...
         if(pview != NULL)
         {
            if(strExtension.CompareNoCase("ca2solution") == 0)
            {
               ...
               pdoc = m_ptemplate_solution->open_document_file(pcreatecontext);
            }
            else
            {
