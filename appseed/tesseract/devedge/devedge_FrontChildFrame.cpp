#include "StdAfx.h"
#include "FrontChildFrame.h"

devedgeFrontChildFrame::devedgeFrontChildFrame(::ca::application * papp) :
   ca(papp),
   ...
   m_toolbar(papp)
{
   IGUI_WIN_MSG_LINK(gen::application::APPM_LANGUAGE, this, this, &devedgeFrontChildFrame::_001OnAppLanguage);
}

devedgeFrontChildFrame::~devedgeFrontChildFrame()
{
}

bool devedgeFrontChildFrame::CreateBars()
{
...
BOOL devedgeFrontChildFrame::PreCreateWindow(CREATESTRUCT& cs)
{
...
bool devedgeFrontChildFrame::DestroyBars()
{
...
bool devedgeFrontChildFrame::_001OnCmdMsg(BaseCmdMsg * pcmdmsg)  
{
...
void devedgeFrontChildFrame::OnChangeEditSearch()
{
...
int devedgeFrontChildFrame::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void devedgeFrontChildFrame::_001OnAppLanguage(gen::signal_object * pobj)
{
   CreateBars();
   pobj->m_bRet = false;
}
...
FileManagerInterface * devedgeFrontChildFrame::GetFileManager()
{
   return dynamic_cast <FileManagerInterface *>(GetActiveDocument());
}

/*void devedgeFrontChildFrame::GetSelected(::fs::item_array &itema)
{
