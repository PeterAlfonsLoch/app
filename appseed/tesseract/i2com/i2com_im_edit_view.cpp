...
//      ::userbase::edit_plain_text_view::_001OnAfterChangeText();
   ...
   void im_edit_view::install_message_handling(::user::win::message::dispatch * pinterface)
   {
   ...
   void im_edit_view::_001OnCreate(gen::signal_object * pobj)
   {
      ...
      get_html_data()->load("<span style=\"color: #880088;\"></span>");
      layout();
   }
...
//      bool bShift = (::GetKeyState(VK_SHIFT) & 0x80000000) != 0;
   ...
   void im_edit_view::post()
   {
      ...
      System.url().set(strPath, "topic", "message");
      System.url().set(strPath, "recipient", m_pimview->m_strRecipient);
      ...
      TRACE0(str);
      _001SetText("<span style=\"color: #880088;\"></span>");
