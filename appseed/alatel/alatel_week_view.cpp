...
namespace alatel
{
   ...
   void week_view::install_message_handling(::user::win::message::dispatch * pinterface)
   {
      split_view::install_message_handling(pinterface);
   ...
   bool week_view::create_views()
   {
      ...
      m_palarmlistview = create_view < alarm_list_view > ();
      ...
      m_pdocWeekday->open_document(Application.dir().matter("alatel/week.html"));
