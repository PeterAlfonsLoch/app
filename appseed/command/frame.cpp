...
int command_frame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
/* 	if (!m_menubar.CreateEx(this))
   ...
   string str = Application.file().as_string(
      System.dir().matter("command\\toolbar.xml"));
...
void command_frame::_001OnTimer(gen::signal_object * pobj) 
{
...
void command_frame::SetAnimatedStatusBarText(const char * lpcsz)
{
...
void command_frame::AnimateStatusBar()
{
   if(m_strAnimatedStatusBarText.is_empty())
      return;
...
void command_frame::ShowControlBars(bool bShow)
{
   UINT nShow;
   if(bShow)
   {
...
void command_frame::OnHoverAction(bool bShowWinActionArea)
{
   if(!IsWindowVisible())
   {
...
void command_frame::_001InstallMessageHandling(::user::win::message::dispatch * pinterface)
{
   simple_frame_window::_001InstallMessageHandling(pinterface);
   IGUI_WIN_MSG_LINK(WM_CREATE, pinterface, this, &command_frame::_001OnCreate);
   IGUI_WIN_MSG_LINK(WM_CLOSE, pinterface, this, &command_frame::_001OnClose);
   IGUI_WIN_MSG_LINK(WM_TIMER, pinterface, this, &command_frame::_001OnTimer);
   IGUI_WIN_MSG_LINK(WM_MOVE, pinterface, this, &command_frame::_001OnMove);
   IGUI_WIN_MSG_LINK(WM_SHOWWINDOW, pinterface, this, &command_frame::_001OnShowWindow);
   IGUI_WIN_MSG_LINK(WM_APP + 2000  , pinterface, this, &command_frame::_001OnApp2000);
}

void command_frame::_001OnCreate(gen::signal_object * pobj)
{
...
void command_frame::_001OnMove(gen::signal_object * pobj)
{
...
void command_frame::_001OnShowWindow(gen::signal_object * pobj)
{
...
void command_frame::message_window_message_handler(gen::signal_object * pobj)
{
...
void command_frame::_001OnApp2000(gen::signal_object * pobj)
{
   SCAST_PTR(::user::win::message::base, pbase, pobj)
...
bool command_frame::_001OnCommand(id id)
{
   if(id == "app_exit")
   {
...
bool command_frame::_001OnUpdateCmdUi(cmd_ui * pcmdui)
{
