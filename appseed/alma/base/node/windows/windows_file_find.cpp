...
namespace windows
{
   ...
   bool file_find::FindFile(const char * pstrName /* = NULL */, DWORD dwUnused /* = 0 */)
   {
      ...
      m_hContext = ::windows::shell::FindFirstFile(wstrName, (WIN32_FIND_DATAW*) m_pNextInfo);
   ...
   bool file_find::FindNextFile()
   {
      ...
      return ::windows::shell::FindNextFile(m_hContext, (LPWIN32_FIND_DATAW) m_pNextInfo);
   }
