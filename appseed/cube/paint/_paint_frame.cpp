...
// IMPLEMENT_DYNCREATE(paint_frame, simple_frame_window)

 // BEGIN_MESSAGE_MAP(paint_frame, simple_frame_window)
...
paint_frame::paint_frame(::ca::application * papp) :
   ca(papp),
...
/*    if (!m_menubar.CreateEx(this))
   ...
   m_pimagelist->add_icon("system/language_change.ico");
...
#ifdef _DEBUG
void paint_frame::assert_valid() const
{
   simple_frame_window::assert_valid();
}

void paint_frame::dump(dump_context & dumpcontext) const
{
...
void paint_frame::SetAnimatedStatusBarText(const char * lpcsz)
{
