...
class CLASS_DECL_MPLITE MusicalPlayerLightDoc :
   virtual public BaseDocument,
   virtual public mediaplay::MediaDocInterface 
{
public:
	MusicalPlayerLightDoc(bergedge_application * papp);
