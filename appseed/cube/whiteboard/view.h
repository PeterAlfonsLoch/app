...
namespace whiteboard
{
   ...
   public:
      ...
      afx_msg void OnViewMrts();
      afx_msg void OnUpdateViewMrts(cmd_ui *pcmdui);
      afx_msg void OnUpdateViewMrtsQuerylist(cmd_ui *pcmdui);
      afx_msg void OnViewMrtsQuerylist();
