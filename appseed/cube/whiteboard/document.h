...
namespace whiteboard
{
   ...
   class CLASS_DECL_CA2_CUBE update_hint :
      public ::radix::object
   {
   public:
   ...
   class CLASS_DECL_CA2_CUBE document : public html_document
   {
   public:
   ...
   public:
      ...
      void OnBeforeNavigate2(html::data * pdata, const char * lpszUrl, DWORD nFlags, const char * lpszTargetFrameName, byte_array& baPostedData, const char * lpszHeaders, BOOL* pbCancel);
      ...
      bool                    m_bRead;
      CMapStringToPtr         m_mapTargetHtmlView;
