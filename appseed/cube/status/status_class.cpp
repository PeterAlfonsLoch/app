...
namespace status
{
   ...
   void status_class::perform()
   {
      ...
      {
         System.m_puiInitialPlaceHolderContainer->GetClientRect(rectOpen);
      }
      else
      {
   ...
   void status_class::on_create_view(view_data * pviewdata)
   {
   ...
   void status_class::OnBeforeNavigate2(html::data * pdata, const char * lpszUrl, DWORD nFlags, const char * lpszTargetFrameName, byte_array& baPostedData, const char * lpszHeaders, BOOL* pbCancel)
   {
