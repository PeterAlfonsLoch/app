...
namespace music
{
   class CLASS_DECL_CA2_CUBE in2_list_song :
   ...
   public:
      ...
      var m_styletitle;
      var m_db;
      music::performer * m_pperformer;
      music::performer * m_previous_artist;
      music::performer * m_next_artist;
      music::performer_ptr_array * m_partista;
      var m_topictype;
      ...
      virtual void print_row(music:: song * psong, var line);
