...
var dso_base::call(const char * pszName, 
      var var01,
      var var02,
      var var03,
      var var04,
...
//   ::ca::ca * pca = this;
   ...
   //   ?function_example0@dso@@QAE?AVvar@@XZ
   //   ?function_example1@dso@@QAE?AVvar@@V2@@Z
      //?function_example2@dso@@QAE?AVvar@@V2@0@Z

//      dso_base * pdsoThis = this;
//      dso_base * pdso = offset_cast(strClassName);
...
var dso_base::function_example0()
{
   return gen::g_emptyconst;
}
var dso_base::function_example1(var var1)
{
   return gen::g_emptyconst;
}
var dso_base::function_example2(var var1, var var2)
{
   return gen::g_emptyconst;
}

::ca::ca * dso_base::clone()
{
   dso_base * pdso = create_object();
   if(pdso == NULL)
      return NULL;
...
string dso_base::get_base_classes_name()
{
   return typeid(*this).raw_name();
}

dso_base * dso_base::offset_cast(const char * psz)
{
   if(string(psz) == string(typeid(::dso_base).raw_name()))
   {
...
var dso_base::this_call(const char * psz, FARPROC farproc)
{
...
var dso_base::this_call(const char * psz, FARPROC farproc, var & var01)
{
   UNREFERENCED_PARAMETER(psz);
   UNREFERENCED_PARAMETER(farproc);
...
var dso_base::this_call(const char * psz, FARPROC farproc, var & var01, var & var02)
{
   UNREFERENCED_PARAMETER(psz);
   UNREFERENCED_PARAMETER(farproc);
   UNREFERENCED_PARAMETER(var01);
