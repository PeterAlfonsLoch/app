...
class CLASS_DECL_CA2_CUBE fontopus_database :
...
public:
   ...
   music_database_cache * m_pmusicdatabasecache;
   ...
   music::song_ptr_array * get_songs(
      var req_params, 
      var query,
      var song, 
      var lyrics, 
   ...
   ::music::song_source * get_song_source(var sourceid);
...
CLASS_DECL_CA2_CUBE string ida_to_condition(string list);


CLASS_DECL_CA2_CUBE var cgcl_ltgt_to_array(string str);
