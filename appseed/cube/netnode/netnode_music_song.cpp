...
*/
   ...
   var song::get_performera_html_link(var css_class)
   {
      ...
      {
         performerlinka.add(m_propertyset["pperformera"].at(i).ca2 < music::person > ()->get_html_link(css_class));
      }
   ...
   var song::get_performer_namea()
   {
      ...
      for(int i = 0; i < m_propertyset["pperformera"].array_get_count(); i++)
      {
         performernamea.add((const char *) m_propertyset["pperformera"].at(i).ca2 < music::person > ()->m_propertyset["name"]);
      }
   ...
   var song::get_performer_ida()
   {
      ...
      for(int i = 0; i < m_propertyset["pperformera"].array_get_count(); i++)
      {
         performerida.add((const char *) m_propertyset["pperformera"].at(i).ca2 < music::person > ()->m_propertyset["id"]);
      }
      return performerida;
   }
