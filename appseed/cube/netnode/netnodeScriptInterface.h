...
class CLASS_DECL_CA2_CUBE netnodeScriptInterface :
   virtual public ::html::file
{
public:
   netnodeScriptInterface();
   virtual ~netnodeScriptInterface();
   ...
   virtual class netnode::profiler * profiler() = 0;
   ...
   virtual netnodeScriptManager * get_manager() = 0;
   ...
   virtual class fun & fun() = 0;
   virtual fontopus_database & musicdb() = 0;
   virtual fontopus_database & musicdb_se() = 0;
   virtual fontopus_database & admindb() = 0;
   virtual class secure & secure() = 0;
   virtual netnode::music & music() = 0;
   virtual cynce_database & cyncedb() = 0;
   virtual class cynce & cynce() = 0;
   virtual class netnode::user & user() = 0;
   virtual class netnode::wb & wb() = 0;
   ...
   virtual void simage_add_accepta(netnode::simage_accepta * paccepta) = 0;
   ...
   virtual netnodeScriptInterface & main() = 0;
   ...
   virtual void menuleft_printVert001(ui_menu * pmenu, int iPanelIndex) = 0;
   ...
   virtual bool      fs_add_user_dir         (const char * pszFolder, const char * pszName);
