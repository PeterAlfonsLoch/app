...
class netnodeScriptInterface;


class CLASS_DECL_CA2_CUBE ui_redir_lang
{
public:
   string m_strLang;
   string m_strTarget;
...
class CLASS_DECL_CA2_CUBE ui_redir_style : 
...
class CLASS_DECL_CA2_CUBE ui_redir_root : 
...
class CLASS_DECL_CA2_CUBE ui_redir : 
