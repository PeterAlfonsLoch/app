...
class CLASS_DECL_CA2_CUBE netnodeScriptImpl :
   public netnodeScriptInterface
{
public:
   ...
   // Implementation
   netnodeScriptImpl(netnodeScript * pscript);
   virtual ~netnodeScriptImpl();
   ...
   fontopus_database * m_pmusicdb;
   fontopus_database * m_pmusicsedb;
   fontopus_database * m_pnetnodedb;
   fontopus_database * m_padmindb;
   class secure * m_psecure;
   netnode::music * m_pmusic;
   cynce_database * m_pcyncedb;
   class cynce * m_pcynce;
   class netnode::user * m_pui;
   class netnode::profiler * m_pprofiler;
   class netnode::wb * m_pwb;
   ...
   netnodeSocket & netnode();

   netnodeSocket * m_pnetnodesocket;
   ui_str * m_puistr;
   ::http::memory_file m_memoryfileFallback;

   void root_init();

   class ui_redir & uiredir();
   ...
   virtual netnodeScriptManager * get_manager();
   ...
   virtual class netnode::profiler * profiler();
   ...
   using netnodeScriptInterface::this_url;
   string this_url();
   ...
   bool read_file(const char * lpcsz, array_ptr_alloc < int_array > * prangea = NULL);
   ...
   void menuleft_printVert001(ui_menu * pmenu, int iPanelIndex);
   ...
   virtual class fun & fun();
   virtual fontopus_database & musicdb();
   virtual fontopus_database & musicdb_se();
   virtual fontopus_database & netnodedb();
   virtual fontopus_database & admindb();
   virtual class secure & secure();
   virtual netnode::music & music();
   virtual cynce_database & cyncedb();
   virtual class cynce & cynce();
   virtual class netnode::user & user();
   virtual class netnode::wb & wb();
   ...
   using netnodeScriptInterface::array_unshift;
   ...
   virtual void simage_add_accepta(netnode::simage_accepta * paccepta);
   ...
   virtual netnodeScriptInterface & main();
   ...
   virtual string    low_fs_file_path        (const char * hash, __int64 key, __int64 size, const char * mimetype, const char * extension);
