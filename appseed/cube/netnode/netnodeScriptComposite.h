...
class CLASS_DECL_CA2_CUBE netnodeScriptComposite :
   virtual public netnodeScriptInterface
{
public:
   netnodeScriptComposite();
   virtual ~netnodeScriptComposite();

   netnodeScriptInterface * m_pinterface;
   ...
   virtual void menuleft_printVert001(ui_menu * pmenu, int iPanelIndex);
