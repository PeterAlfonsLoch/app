...
void devedge_child_frame::_001InstallMessageHandling(::user::win::message::dispatch * pinterface)
{
...
bool devedge_child_frame::CreateBars()
{
   ...
   if(!spfile->open(System.dir().matter("devedge\\devedge_toolbar.xml"), ::ex1::file::type_text | ::ex1::file::mode_read))
      return false;
