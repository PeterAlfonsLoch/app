...
namespace userex
{
   ...
   namespace autocomplete
   {
      ...
      void handler::OnBeforeNavigate2(html::data * pdata, const char * lpszUrl, DWORD nFlags, const char * lpszTargetFrameName, byte_array& baPostedData, const char * lpszHeaders, BOOL* pbCancel)
      {
         ...
         *pbCancel = true;
         m_pformview->GetParentFrame()->ShowWindow(SW_HIDE);
         m_pinteraction->autocomplete_set_text(lpszUrl);
      }
