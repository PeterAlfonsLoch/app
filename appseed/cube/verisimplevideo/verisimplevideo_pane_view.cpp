...
//      SCAST_PTR(::user::win::message::create, pcreate, pobj)
   ...
   void pane_view::on_create_view(view_data * pviewdata)
   {
      ...
      case PaneViewVideo:
         {
            verisimplevideo::document * pdoc = dynamic_cast < verisimplevideo::document * > (papp->m_ptemplateVideo->open_document_file(NULL, true, this));
            if(pdoc != NULL)
            {
            ...
            /*         create_context cc;
            cc.m_pCurrentDoc = get_document();
            cc.m_typeinfoNewView =  &typeid(verisimplevideo::view);
