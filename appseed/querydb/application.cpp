...
namespace querydb
{
   ...
   bool application::initialize_instance()
   {
      ...
      factory().creatable_small < querydb::pane_view >();
      factory().creatable_small < querydb::menu_right_view >();
      factory().creatable_small < querydb::menu_view >();
      factory().creatable_small < querydb::query_view >();
      factory().creatable_small < querydb::table_view >();
   ...
   bool application::bergedge_start()
   {
      ...
      m_ptemplate_html->open_document_file(NULL, true);
...
CLASS_DECL_CA2_QUERYDB ::ca::application * get_new_app()
{
   return new querydb::application;
}
