...
__STATIC long CLASS_DECL_DRAW2D_DIRECT2D _gen::MultMultDivDiv(
...
::draw2d::object* preview_dc::SelectStockObject(int nIndex)
{
   ...
   case DEFAULT_GUI_FONT:
      ...
      {
         ::draw2d::object* pObject = ::draw2d_direct2d::object::from_handle(
   ...
   default:
      ...
      return ::draw2d_direct2d::object::from_handle(::SelectObject(get_handle2(), hObj));
   }
}
...
::draw2d::font* preview_dc::SelectObject(::draw2d::font* pFont)
{
   ...
   ::draw2d::font* pOldFont = (::draw2d::font*) ::draw2d_direct2d::object::from_handle(
...
__STATIC int CLASS_DECL_DRAW2D_DIRECT2D _gen::ComputeNextTab(int x, UINT nTabStops, LPINT lpnTabStops, int nTabOrigin, int nTabWidth)
{
   ENSURE(nTabWidth!=0);
