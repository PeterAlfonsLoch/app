...
namespace projection
{
   ...
   void pane_view::_001OnCreate(gen::signal_object * pobj) 
   {
      ...
      add_tab("projection", ::projection::PaneViewFlag);
      add_tab("file manager", ::projection::PaneViewFileManager);

      set_cur_tab_by_id(::projection::PaneViewFlag);
   ...
   void pane_view::on_create_view(::user::view_creator_data * pcreatordata)
   {
      ...
      case PaneViewFlag:
         {
            ::projection::document * pdoc = dynamic_cast < ::projection::document * > (Application.m_ptemplateVideo->open_document_file(NULL, true, this));
            if(pdoc != NULL)
            {
               ...
               if(pview != NULL)
               {
                  ::projection::frame * pframe = dynamic_cast < ::projection::frame * > (pview->GetParentFrame());
                  if(pframe != NULL)
                  {
