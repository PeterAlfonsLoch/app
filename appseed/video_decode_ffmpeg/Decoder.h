...
namespace video_decode_ffmpeg
{
   ...
   public:
      ...
      class CLASS_DECL_VIDDEC_FFMPEG_BRIDGE packet_thread :
      ...
      class CLASS_DECL_VIDDEC_FFMPEG_BRIDGE video_decode_thread :
         virtual public simple_thread
      {
      public:


         class CLASS_DECL_VIDDEC_FFMPEG_BRIDGE frame
         {
         public:
      ...
      class CLASS_DECL_VIDDEC_FFMPEG_BRIDGE video_scale_thread :
         virtual public simple_thread
      {
      public:
      ...
      class CLASS_DECL_VIDDEC_FFMPEG_BRIDGE audio_decode_thread :
         virtual public simple_thread
      {
      public:
