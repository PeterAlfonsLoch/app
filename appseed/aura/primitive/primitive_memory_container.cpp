...
namespace primitive
{
   ...
   memory_container ::memory_container(sp(::aura::application) papp) :
      element(papp)
   {
...
//      m_spmemory = canew(primitive::memory(papp));
   ...
   memory_container ::memory_container(sp(::aura::application) papp, void * pmemory, memory_size dwSize) :
      element(papp)
   {
   ...
   memory_container ::memory_container(sp(::aura::application) papp, memory_base * pmemory) :
      element(papp)
   {
      m_spmemory = pmemory;
   }
