...
#include "collection_array_decl.h"

// raw_array is an array that does not call constructors or destructor in elements by default
// array is an array that call only copy constructor and destructor in elements
// array is an array that call default constructors, copy constructs and destructors in elements


template<class TYPE,class ARG_TYPE = const TYPE &,class ALLOCATOR = ::allocator::nodef < TYPE > >
using raw_array = array < TYPE, ARG_TYPE, ALLOCATOR >;
