...
public:
   ...
   inline string_composite(string_interface & strinterface) : m_pstring(NULL),m_pinterface(&strinterface) {}
   inline string_composite(const string_interface & strinterface) : m_pstring(NULL), m_pinterface(const_cast < string_interface * > (&strinterface))  {}
