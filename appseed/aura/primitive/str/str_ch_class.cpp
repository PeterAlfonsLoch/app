...
//            int32_t retEnd;
            ...
            case 's':
               cc->add_category("Z");
               cc->add_char(string(unichar(0x09), 1));
               cc->add_char(string(unichar(0x0A), 1));
               cc->add_char(string(unichar(0x0C), 1));
               cc->add_char(string(unichar(0x0D), 1));
               break;
            case 'S':
               cc_temp.fill();
               cc_temp.clear_category("Z");
               cc_temp.clear_char(string(unichar(0x09), 1));
               cc_temp.clear_char(string(unichar(0x0A), 1));
               cc_temp.clear_char(string(unichar(0x0C), 1));
               cc_temp.clear_char(string(unichar(0x0D), 1));
               cc->add_class(cc_temp);
               break;
            default:
               index retEnd;
   ...
   {
      int64_t iChar = ::str::ch::uni_index(pszUtf8Char);
   ...
   {
      int64_t iCharStart = ::str::ch::uni_index(s);
      int64_t iCharEnd = ::str::ch::uni_index(e);
