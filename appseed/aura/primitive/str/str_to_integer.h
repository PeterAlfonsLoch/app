...
CLASS_DECL_AXIS int32_t atoi_dup(const char * sz, const char ** pszEnd, int32_t iBase);
CLASS_DECL_AXIS int32_t atoi_dup(const char * sz, const char ** pszEnd);
CLASS_DECL_AXIS int32_t atoi_dup(const char * sz);

CLASS_DECL_AXIS uint32_t atoui_dup(const char * sz, const char ** pszEnd, int32_t iBase);
CLASS_DECL_AXIS uint32_t atoui_dup(const char * sz, const char ** pszEnd);
CLASS_DECL_AXIS uint32_t atoui_dup(const char * sz);

CLASS_DECL_AXIS int32_t natoi_dup(const char * sz, const char ** pszEnd, int32_t iBase, size_t iLen);
...
CLASS_DECL_AXIS int64_t atoi64_dup(const char * sz, char ** pszEnd, int32_t iBase);
CLASS_DECL_AXIS int64_t atoi64_dup(const char * sz, char ** pszEnd);
CLASS_DECL_AXIS int64_t atoi64_dup(const char * sz);

CLASS_DECL_AXIS uint64_t atoui64_dup(const char * sz, char ** pszEnd, int32_t iBase);
CLASS_DECL_AXIS uint64_t atoui64_dup(const char * sz, char ** pszEnd);
CLASS_DECL_AXIS uint64_t atoui64_dup(const char * sz);


CLASS_DECL_AXIS int64_t natoi64_dup(const char * sz, char ** pszEnd, int32_t iBase, size_t iLen);
...
CLASS_DECL_AXIS int64_t wtoi64_dup(const wchar_t * sz, const wchar_t ** pszEnd, int32_t iBase);
