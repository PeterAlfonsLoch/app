...
static const struct { unsigned short aura; unsigned short composed; } viet_comp_table_data[] = {
...
struct viet_decomp { unsigned short composed; unsigned int aura : 12; int comb1 : 4; };
