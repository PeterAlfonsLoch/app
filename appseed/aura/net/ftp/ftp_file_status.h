...
namespace ftp
{
   ...
   class CLASS_DECL_AURA file_status :
   ...
   public:
      ...
      e_size      m_esize;
      file_size_t m_filesize;                   ///< number of octets
      ...
      file_status(::aura::application * papp);
   ...
   class CLASS_DECL_AURA file_status_sort
   {
   ...
   typedef spa(file_status) file_status_ptra;
