...
bool thread::post_message(::aura::user::interaction * pui, UINT message, WPARAM wParam, lparam lParam)
{
...
void thread::add(::aura::user::interaction * pui)
{
...
void thread::remove(::aura::user::interaction * pui)
{
...
::aura::user::interaction * thread::get_ui(index iIndex)
{
...
void thread::set_timer(::aura::user::interaction * pui, uint_ptr nIDEvent, UINT nEllapse)
{
...
void thread::unset_timer(::aura::user::interaction * pui, uint_ptr nIDEvent)
{
...
::aura::user::interaction * thread::get_active_ui()
{
...
::aura::user::interaction * thread::set_active_ui(::aura::user::interaction * pui)
{
