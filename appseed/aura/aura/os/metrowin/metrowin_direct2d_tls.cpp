...
//{
//
//   IDWriteFactory * pfactory = (IDWriteFactory *) thread_get_data(TLS_WRITE_FACTORY);
//
//   if(pfactory != NULL)
//      return pfactory;
//
...
//
//   thread_set_data(TLS_WRITE_FACTORY, pfactory);
//
//   if(FAILED(hr))
//      return NULL;
//
...
//{
//
//   ID3D11Device * pdevice = (ID3D11Device *) thread_get_data(TLS_d3_1);
//
//   if(pdevice != NULL)
//      return pdevice;
//
...
//            );
//
//   thread_set_data(TLS_d3_1, pdevice);
//   thread_set_data(TLS_d3_2, pcontext);
//
//   if(FAILED(hr))
//       return NULL;
//
...
//{
//
//   ID3D11DeviceContext * pcontext = (ID3D11DeviceContext *) thread_get_data(TLS_d3_2);
//
//   if(pcontext != NULL)
//      return pcontext;
//
...
//      return NULL;
//
//   pcontext = (ID3D11DeviceContext *) thread_get_data(TLS_d3_2);
//
//   if(pcontext == NULL)
//      return NULL;
//   
...
//{
//
//   ID3D11Device1 * pdevice1 = (ID3D11Device1 *) thread_get_data(TLS_d3_3);
//
//   if(pdevice1 != NULL)
//      return pdevice1;
//
...
//
//   thread_set_data(TLS_d3_3, pdevice1);
//
//   if(pdevice1 == NULL)
//      return NULL;
//
...
//{
//
//   IDXGIDevice * pdxgidevice = (IDXGIDevice *) thread_get_data(TLS_d3_4);
//
//   if(pdxgidevice != NULL)
//      return pdxgidevice;
//
...
//
//   thread_set_data(TLS_d3_4, pdxgidevice);
//
//   if(pdxgidevice == NULL)
//      return NULL;
//
