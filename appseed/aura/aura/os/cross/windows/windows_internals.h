...
inline void WINAPI DbgBreakPoint(void) {
    ...
    CLASS_DECL_AURA void WINAPI DbgBreakPoint(void);
    ...
    CLASS_DECL_AURA NTSTATUS WINAPI NtClearEvent(HANDLE);
    ...
    CLASS_DECL_AURA NTSTATUS WINAPI NtCreateTimer(HANDLE*, ACCESS_MASK, const OBJECT_ATTRIBUTES*, TIMER_TYPE);
    CLASS_DECL_AURA NTSTATUS WINAPI NtCreateToken(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, TOKEN_TYPE, PLUID, PLARGE_INTEGER, PTOKEN_USER, PTOKEN_GROUPS, PTOKEN_PRIVILEGES, PTOKEN_OWNER, PTOKEN_PRIMARY_GROUP, PTOKEN_DEFAULT_DACL, PTOKEN_SOURCE);
    CLASS_DECL_AURA NTSTATUS WINAPI NtDelayExecution(int_bool, const LARGE_INTEGER*);
    CLASS_DECL_AURA NTSTATUS WINAPI NtDeleteAtom(RTL_ATOM);
    ...
    CLASS_DECL_AURA NTSTATUS WINAPI NtOpenMutant(PHANDLE, ACCESS_MASK, const OBJECT_ATTRIBUTES*);
    CLASS_DECL_AURA NTSTATUS WINAPI NtOpenObjectAuditAlarm(PUNICODE_STRING, PHANDLE, PUNICODE_STRING, PUNICODE_STRING, PSECURITY_DESCRIPTOR, HANDLE, ACCESS_MASK, ACCESS_MASK, PPRIVILEGE_SET, int_bool, int_bool, PBOOLEAN);
    CLASS_DECL_AURA NTSTATUS WINAPI NtOpenProcess(PHANDLE, ACCESS_MASK, const OBJECT_ATTRIBUTES*, const CLIENT_ID*);
    CLASS_DECL_AURA NTSTATUS WINAPI NtOpenProcessToken(HANDLE, DWORD, HANDLE *);
    CLASS_DECL_AURA NTSTATUS WINAPI NtOpenProcessTokenEx(HANDLE, DWORD, DWORD, HANDLE *);
    CLASS_DECL_AURA NTSTATUS WINAPI NtOpenSection(HANDLE*, ACCESS_MASK, const OBJECT_ATTRIBUTES*);
    CLASS_DECL_AURA NTSTATUS WINAPI NtOpenSemaphore(PHANDLE, ACCESS_MASK, const OBJECT_ATTRIBUTES*);
    CLASS_DECL_AURA NTSTATUS WINAPI NtOpenSymbolicLinkObject(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES);
    CLASS_DECL_AURA NTSTATUS WINAPI NtOpenThread(HANDLE*, ACCESS_MASK, const OBJECT_ATTRIBUTES*, const CLIENT_ID*);
    ...
    CLASS_DECL_AURA NTSTATUS WINAPI NtTestAlert(VOID);
    ...
    CLASS_DECL_AURA NTSTATUS WINAPI RtlActivateActivationContext(DWORD, HANDLE, ULONG_PTR*);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlAddAce(PACL, DWORD, DWORD, PACE_HEADER, DWORD);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlAddAccessAllowedAce(PACL, DWORD, DWORD, PSID);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlAddAccessAllowedAceEx(PACL, DWORD, DWORD, DWORD, PSID);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlAddAccessDeniedAce(PACL, DWORD, DWORD, PSID);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlAddAccessDeniedAceEx(PACL, DWORD, DWORD, DWORD, PSID);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlAddAtomToAtomTable(RTL_ATOM_TABLE, const WCHAR*, RTL_ATOM*);
    ...
    CLASS_DECL_AURA NTSTATUS WINAPI RtlAnsiStringToUnicodeString(PUNICODE_STRING, PCANSI_STRING, int_bool);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlAppendAsciizToString(STRING *, LPCSTR);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlAppendStringToString(STRING *, const STRING *);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlAppendUnicodeStringToString(UNICODE_STRING *, const UNICODE_STRING *);
    ...
    CLASS_DECL_AURA NTSTATUS WINAPI RtlDeleteTimerQueueEx(HANDLE, HANDLE);
    CLASS_DECL_AURA PRTL_USER_PROCESS_PARAMETERS WINAPI RtlDeNormalizeProcessParams(RTL_USER_PROCESS_PARAMETERS*);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlDeregisterWait(HANDLE);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlDeregisterWaitEx(HANDLE, HANDLE);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlDestroyAtomTable(RTL_ATOM_TABLE);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlDestroyEnvironment(PWSTR);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlDestroyHandleTable(RTL_HANDLE_TABLE *);
    CLASS_DECL_AURA HANDLE WINAPI RtlDestroyHeap(HANDLE);
    CLASS_DECL_AURA void WINAPI RtlDestroyProcessParameters(RTL_USER_PROCESS_PARAMETERS*);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlDestroyQueryDebugBuffer(PDEBUG_BUFFER);
    CLASS_DECL_AURA DOS_PATHNAME_TYPE WINAPI RtlDetermineDosPathNameType_U(PCWSTR);
    ...
    CLASS_DECL_AURA NTSTATUS WINAPI RtlDuplicateUnicodeString(int32_t, const UNICODE_STRING*, UNICODE_STRING*);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlEmptyAtomTable(RTL_ATOM_TABLE, int_bool);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlEnterCriticalSection(RTL_CRITICAL_SECTION *);
    CLASS_DECL_AURA void WINAPI RtlEraseUnicodeString(UNICODE_STRING*);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlEqualComputerName(const UNICODE_STRING*, const UNICODE_STRING*);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlEqualDomainName(const UNICODE_STRING*, const UNICODE_STRING*);
    CLASS_DECL_AURA int_bool WINAPI RtlEqualLuid(const LUID*, const LUID*);
    CLASS_DECL_AURA int_bool WINAPI RtlEqualPrefixSid(PSID, PSID);
    ...
    CLASS_DECL_AURA NTSTATUS WINAPI RtlImpersonateSelf(SECURITY_IMPERSONATION_LEVEL);
    CLASS_DECL_AURA void WINAPI RtlInitString(PSTRING, PCSZ);
    CLASS_DECL_AURA void WINAPI RtlInitAnsiString(PANSI_STRING, PCSZ);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlInitAnsiStringEx(PANSI_STRING, PCSZ);
    ...
    CLASS_DECL_AURA NTSTATUS WINAPI RtlLookupAtomInAtomTable(RTL_ATOM_TABLE, const WCHAR*, RTL_ATOM*);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlMakeSelfRelativeSD(PSECURITY_DESCRIPTOR, PSECURITY_DESCRIPTOR, LPDWORD);
    CLASS_DECL_AURA void WINAPI RtlMapGenericMask(PACCESS_MASK, const GENERIC_MAPPING*);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlMultiByteToUnicodeN(LPWSTR, DWORD, LPDWORD, LPCSTR, DWORD);
    ...
    CLASS_DECL_AURA NTSTATUS WINAPI RtlSetDaclSecurityDescriptor(PSECURITY_DESCRIPTOR, int_bool, PACL, int_bool);
    ...
    CLASS_DECL_AURA void WINAPI RtlTimeToElapsedTimeFields(const LARGE_INTEGER *, PTIME_FIELDS);
    CLASS_DECL_AURA int_bool WINAPI RtlTimeToSecondsSince1970(const LARGE_INTEGER *, LPDWORD);
    CLASS_DECL_AURA int_bool WINAPI RtlTimeToSecondsSince1980(const LARGE_INTEGER *, LPDWORD);
    CLASS_DECL_AURA int_bool WINAPI RtlTryEnterCriticalSection(RTL_CRITICAL_SECTION *);
...
#ifdef __x86_64__
    CLASS_DECL_AURA void WINAPI RtlUnwindEx(PVOID, PVOID, PEXCEPTION_RECORD, PVOID, PCONTEXT, PUNWIND_HISTORY_TABLE);
#elif defined(__ia64__)
    CLASS_DECL_AURA void WINAPI RtlUnwind2(FRAME_POINTERS, PVOID, PEXCEPTION_RECORD, PVOID, PCONTEXT);
    CLASS_DECL_AURA void WINAPI RtlUnwindEx(FRAME_POINTERS, PVOID, PEXCEPTION_RECORD, PVOID, PCONTEXT, PUNWIND_HISTORY_TABLE);
#endif
    CLASS_DECL_AURA WCHAR WINAPI RtlUpcaseUnicodeChar(WCHAR);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlUpcaseUnicodeString(UNICODE_STRING*, const UNICODE_STRING *, int_bool);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlUpcaseUnicodeStringToAnsiString(STRING*, const UNICODE_STRING*, int_bool);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlUpcaseUnicodeStringToCountedOemString(STRING*, const UNICODE_STRING*, int_bool);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlUpcaseUnicodeStringToOemString(STRING*, const UNICODE_STRING*, int_bool);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlUpcaseUnicodeToMultiByteN(LPSTR, DWORD, LPDWORD, LPCWSTR, DWORD);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlUpcaseUnicodeToOemN(LPSTR, DWORD, LPDWORD, LPCWSTR, DWORD);
    CLASS_DECL_AURA NTSTATUS WINAPI RtlUpdateTimer(HANDLE, HANDLE, DWORD, DWORD);
    CLASS_DECL_AURA CHAR WINAPI RtlUpperChar(CHAR);
    CLASS_DECL_AURA void WINAPI RtlUpperString(STRING *, const STRING *);
    ...
    CLASS_DECL_AURA LONGLONG WINAPI RtlExtendedMagicDivide(LONGLONG, LONGLONG, INT);
    CLASS_DECL_AURA LONGLONG WINAPI RtlExtendedIntegerMultiply(LONGLONG, INT);
    CLASS_DECL_AURA LONGLONG WINAPI RtlExtendedLargeIntegerDivide(LONGLONG, INT, INT *);
    CLASS_DECL_AURA LONGLONG WINAPI RtlLargeIntegerAdd(LONGLONG, LONGLONG);
    CLASS_DECL_AURA LONGLONG WINAPI RtlLargeIntegerArithmeticShift(LONGLONG, INT);
    CLASS_DECL_AURA ULONGLONG WINAPI RtlLargeIntegerDivide(ULONGLONG, ULONGLONG, ULONGLONG *);
    CLASS_DECL_AURA LONGLONG WINAPI RtlLargeIntegerNegate(LONGLONG);
    ...
    CLASS_DECL_AURA NTSTATUS CDECL wine_nt_to_unix_file_name(const UNICODE_STRING *nameW, ANSI_STRING *unix_name_ret,
            UINT disposition, int_bool check_case);
    CLASS_DECL_AURA NTSTATUS CDECL wine_unix_to_nt_file_name(const ANSI_STRING *name, UNICODE_STRING *nt);
