...
assert_exception::assert_exception(sp(::aura::application) papp, const char * pszFile, long lLine) :
   element(papp),
   ::call_stack(papp),
   ::exception::base(papp),
...
misc_exception::misc_exception(sp(::aura::application) papp, const char * pszMessage) :
   element(papp),
   ::call_stack(papp),
   ::exception::base(papp),
   simple_exception(papp)
