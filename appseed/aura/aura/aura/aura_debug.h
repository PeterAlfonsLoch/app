...
typedef int32_t(DECL_C * _CRT_REPORT_HOOKW)(int32_t, unichar *, int32_t *);
...
#else
//#if !defined(_M_CEE_PURE)
//CLASS_DECL_AURA extern long _crtAssertBusy;
//#endif /* !defined(_M_CEE_PURE) */
//
//#if !defined(_M_CEE_PURE)
//CLASS_DECL_AURA _CRT_REPORT_HOOK DECL_C _CrtGetReportHook(
//    void
//    );
//#endif
 ...
 */
CLASS_DECL_AURA _CRT_REPORT_HOOK DECL_C _CrtSetReportHook(_CRT_REPORT_HOOK _PFnNewHook);
//CLASS_DECL_AURA int32_t DECL_C _CrtSetReportHook2(int32_t _Mode, _CRT_REPORT_HOOK _PFnNewHook);
//CLASS_DECL_AURA int32_t DECL_C _CrtSetReportHookW2(int32_t _Mode, _CRT_REPORT_HOOKW _PFnNewHook);
//
//CLASS_DECL_AURA int32_t DECL_C _CrtSetReportMode(int32_t _ReportType, int32_t _ReportMode);
//CLASS_DECL_AURA _HFILE DECL_C _CrtSetReportFile(int32_t _ReportType, _HFILE _ReportFile);
...
//CLASS_DECL_AURA size_t DECL_C _CrtSetDebugFillThreshold(size_t _NewDebugFillThreshold);
...
//
//#if !defined(_M_CEE_PURE)
//CLASS_DECL_AURA extern long _crtBreakAlloc;      /* Break on this allocation */
//#endif /* !defined(_M_CEE_PURE) */
//
//CLASS_DECL_AURA long DECL_C _CrtSetBreakAlloc(long _BreakAlloc);
//
//CLASS_DECL_AURA void * DECL_C _malloc_dbg(size_t _Size, int32_t _BlockType, const char * _Filename, int32_t _LineNumber);
//CLASS_DECL_AURA void * DECL_C _calloc_dbg(size_t _Count, size_t _Size, int32_t _BlockType, const char * _Filename, int32_t _LineNumber);
//CLASS_DECL_AURA void * DECL_C _realloc_dbg(void * _Memory, size_t _NewSize, int32_t _BlockType, const char * _Filename, int32_t _LineNumber);
//CLASS_DECL_AURA void * DECL_C _recalloc_dbg(void * _Memory, size_t _NumOfElements, size_t _SizeOfElements, int32_t _BlockType, const char * _Filename, int32_t _LineNumber);
//CLASS_DECL_AURA void * DECL_C _expand_dbg(void * _Memory, size_t _NewSize, int32_t _BlockType, const char * _Filename, int32_t _LineNumber);
//CLASS_DECL_AURA void DECL_C _free_dbg(void * _Memory, int32_t _BlockType);
//CLASS_DECL_AURA size_t DECL_C _msize_dbg(void * _Memory, int32_t _BlockType);
//CLASS_DECL_AURA size_t DECL_C _aligned_msize_dbg(void * _Memory, size_t _Alignment, size_t _Offset);
//CLASS_DECL_AURA void * DECL_C _aligned_malloc_dbg(size_t _Size, size_t _Alignment, const char * _Filename, int32_t _LineNumber);
//CLASS_DECL_AURA void * DECL_C _aligned_realloc_dbg(void * _Memory, size_t _NewSize, size_t _Alignment, const char * _Filename, int32_t _LineNumber);
//CLASS_DECL_AURA void * DECL_C _aligned_recalloc_dbg(void * _Memory, size_t _NumOfElements, size_t _SizeOfElements, size_t _Alignment, const char * _Filename, int32_t _LineNumber);
//CLASS_DECL_AURA void * DECL_C _aligned_offset_malloc_dbg(size_t _Size, size_t _Alignment, size_t _Offset, const char * _Filename, int32_t _LineNumber);
//CLASS_DECL_AURA void * DECL_C _aligned_offset_realloc_dbg(void * _Memory, size_t _NewSize, size_t _Alignment, size_t _Offset, const char * _Filename, int32_t _LineNumber);
...
//CLASS_DECL_AURA unichar * DECL_C _wcsdup_dbg(const unichar * _Str, int32_t _BlockType, const char * _Filename, int32_t _LineNumber);
...
//CLASS_DECL_AURA unichar * DECL_C _wtempnam_dbg(const unichar * _DirName, const unichar * _FilePrefix, int32_t _BlockType, const char * _Filename, int32_t _LineNumber);
...
//CLASS_DECL_AURA unichar * DECL_C _wfullpath_dbg(unichar * _FullPath, const unichar * _Path, size_t _SizeInWords, int32_t _BlockType, const char * _Filename, int32_t _LineNumber);
...
//CLASS_DECL_AURA unichar * DECL_C _wgetcwd_dbg(unichar * _DstBuf, int32_t _SizeInWords, int32_t _BlockType, const char * _Filename, int32_t _LineNumber);
...
//CLASS_DECL_AURA unichar * DECL_C _wgetdcwd_dbg(int32_t _Drive, unichar * _DstBuf, int32_t _SizeInWords, int32_t _BlockType, const char * _Filename, int32_t _LineNumber);
//
...
//unichar * DECL_C _wgetdcwd_lk_dbg(int32_t _Drive, unichar * _DstBuf, int32_t _SizeInWords, int32_t _BlockType, const char * _Filename, int32_t _LineNumber);
//
...
//CLASS_DECL_AURA errno_t DECL_C _wdupenv_s_dbg(unichar ** _PBuffer, size_t * _PBufferSizeInWords, const unichar * _VarName, int32_t _BlockType, const char * _Filename, int32_t _LineNumber);
//
///*_Success_(return!=0)
...
//);
//
//_Check_return_ _Ret_opt_bytecap_(_NewSize) CLASS_DECL_AURA void * DECL_C _expand_dbg(
...
//        );
//
//CLASS_DECL_AURA void DECL_C _free_dbg(
//        _Post_ptr_invalid_ void * _Memory,
//        _In_ int32_t _BlockType
//        );
//
//CLASS_DECL_AURA size_t DECL_C _msize_dbg (
//        _Pre_notnull_ void * _Memory,
//        _In_ int32_t _BlockType
//        );
//
//CLASS_DECL_AURA size_t DECL_C _aligned_msize_dbg (
//        _Pre_notnull_ void * _Memory,
//        _In_ size_t _Alignment,
//        _In_ size_t _Offset
//        );
//
//_Check_return_ _Ret_opt_bytecap_(_Size) CLASS_DECL_AURA void * DECL_C _aligned_malloc_dbg(
//        _In_ size_t _Size,
//        _In_ size_t _Alignment,
//        _In_opt_z_ const char * _Filename,
//        _In_ int32_t _LineNumber
...
//
//_Success_(return!=0)
//_Check_return_ _Ret_opt_bytecap_(_NewSize) CLASS_DECL_AURA void * DECL_C _aligned_realloc_dbg(
//        _Post_ptr_invalid_ void * _Memory,
//        _In_ size_t _NewSize,
//        _In_ size_t _Alignment,
//        _In_opt_z_ const char * _Filename,
...
//
//_Success_(return!=0)
//_Check_return_ _Ret_opt_bytecap_x_(_NumOfElements*_SizeOfElements) CLASS_DECL_AURA void * DECL_C _aligned_recalloc_dbg
//(
//        _Post_ptr_invalid_ void * _Memory,
//        _In_ size_t _NumOfElements,
//        _In_ size_t _SizeOfElements,
...
//);
//
//_Check_return_ _Ret_opt_bytecap_(_Size) CLASS_DECL_AURA void * DECL_C _aligned_offset_malloc_dbg(
//        _In_ size_t _Size,
//        _In_ size_t _Alignment,
//        _In_ size_t _Offset,
//        _In_opt_z_ const char * _Filename,
...
//
//_Success_(return!=0)
//_Check_return_ _Ret_opt_bytecap_(_NewSize) CLASS_DECL_AURA void * DECL_C _aligned_offset_realloc_dbg(
//        _Post_ptr_invalid_ void * _Memory,
//        _In_ size_t _NewSize,
//        _In_ size_t _Alignment,
//        _In_ size_t _Offset,
...
//
//_Success_(return!=0)
//_Check_return_ _Ret_opt_bytecap_x_(_NumOfElements*_SizeOfElements) CLASS_DECL_AURA void * DECL_C _aligned_offset_recalloc_dbg
//(
//        _Post_ptr_invalid_ void * _Memory,
//        _In_ size_t _NumOfElements,
//        _In_ size_t _SizeOfElements,
...
//);
//
//CLASS_DECL_AURA void DECL_C _aligned_free_dbg(
//        _Post_ptr_invalid_ void * _Memory
//        );
//
//_Check_return_ _Ret_opt_z_ CLASS_DECL_AURA char * DECL_C _strdup_dbg(
...
//        );
//
//_Check_return_ _Ret_opt_z_ CLASS_DECL_AURA unichar * DECL_C _wcsdup_dbg(
//        _In_opt_z_ const unichar * _Str,
//        _In_ int32_t _BlockType,
//        _In_opt_z_ const char * _Filename,
//        _In_ int32_t _LineNumber
//        );
//
//_Check_return_ _Ret_opt_z_ CLASS_DECL_AURA char * DECL_C _tempnam_dbg(
...
//        );
//
//_Check_return_ _Ret_opt_z_ CLASS_DECL_AURA unichar * DECL_C _wtempnam_dbg(
//        _In_opt_z_ const unichar * _DirName,
//        _In_opt_z_ const unichar * _FilePrefix,
//        _In_ int32_t _BlockType,
//        _In_opt_z_ const char * _Filename,
//        _In_ int32_t _LineNumber
//        );
//
//_Check_return_ _Ret_opt_z_ CLASS_DECL_AURA char * DECL_C _fullpath_dbg(
...
//        );
//
//_Check_return_ _Ret_opt_z_ CLASS_DECL_AURA unichar * DECL_C _wfullpath_dbg(
//        _Out_opt_z_cap_(_SizeInWords) unichar * _FullPath,
//        _In_z_ const unichar * _Path,
...
//        );
//
//_Check_return_ _Ret_opt_z_ CLASS_DECL_AURA char * DECL_C _getcwd_dbg(
...
//        );
//
//_Check_return_ _Ret_opt_z_ CLASS_DECL_AURA unichar * DECL_C _wgetcwd_dbg(
//        _Out_opt_z_cap_(_SizeInWords) unichar * _DstBuf,
...
//        );
//
//_Check_return_ _Ret_opt_z_ CLASS_DECL_AURA char * DECL_C _getdcwd_dbg(
//        _In_ int32_t _Drive,
//        _Out_opt_z_cap_(_SizeInBytes) char * _DstBuf,
//        _In_ int32_t _SizeInBytes,
//        _In_ int32_t _BlockType,
...
//        );
//
//_Check_return_ _Ret_opt_z_ CLASS_DECL_AURA unichar * DECL_C _wgetdcwd_dbg(
//        _In_ int32_t _Drive,
//        _Out_opt_z_cap_(_SizeInWords) unichar * _DstBuf,
//        _In_ int32_t _SizeInWords,
//        _In_ int32_t _BlockType,
...
//        );
//
//_Check_return_ _Ret_opt_z_ unichar * DECL_C _wgetdcwd_lk_dbg(
//        _In_ int32_t _Drive,
//        _Out_opt_z_cap_(_SizeInWords) unichar * _DstBuf,
//        _In_ int32_t _SizeInWords,
//        _In_ int32_t _BlockType,
...
//        );
//
//_Check_return_wat_ CLASS_DECL_AURA errno_t DECL_C _dupenv_s_dbg(
...
//        _Out_ _Deref_post_opt_z_cap_(*_PBufferSizeInWords) unichar ** _PBuffer,
//        _Out_opt_ size_t * _PBufferSizeInWords,
//        _In_z_ const unichar * _VarName,
//        _In_ int32_t _BlockType,
//        _In_opt_z_ const char * _Filename,
//        _In_ int32_t _LineNumber
//        );
...
// ***************************************************************************/
//#if !defined(_M_CEE_PURE)
//CLASS_DECL_AURA _CRT_ALLOC_HOOK DECL_C _CrtGetAllocHook
//(
//    void
//);
//#endif
...
// */
//#if !defined(_M_CEE_PURE)
//CLASS_DECL_AURA _CRT_ALLOC_HOOK DECL_C _CrtSetAllocHook
//(
...
//
//#if !defined(_M_CEE_PURE)
//CLASS_DECL_AURA extern int32_t _crtDbgFlag;
//#endif /* !defined(_M_CEE_PURE) */
//
//CLASS_DECL_AURA int32_t DECL_C _CrtCheckMemory();
//CLASS_DECL_AURA int32_t DECL_C _CrtSetDbgFlag(int32_t _NewFlag);
//CLASS_DECL_AURA void DECL_C _CrtDoForAllClientObjects(void (DECL_C *_PFn)(void *, void *), void * _Context);
//CLASS_DECL_AURA int32_t DECL_C _CrtIsValidPointer(const void * _Ptr, uint32_t _Bytes, int32_t _ReadWrite);
//CLASS_DECL_AURA int32_t DECL_C _CrtIsValidHeapPointer(const void * _HeapPtr);
//CLASS_DECL_AURA int32_t DECL_C _CrtIsMemoryBlock(const void * _Memory, uint32_t _Bytes, long * _RequestNumber, char ** _Filename, int32_t * _LineNumber);
//CLASS_DECL_AURA int32_t DECL_C _CrtReportBlockType(const void * _Memory);
//
//
// /****************************************************************************
// *
...
//
//#if !defined(_M_CEE_PURE)
//CLASS_DECL_AURA _CRT_DUMP_CLIENT DECL_C _CrtGetDumpClient
//(
//    void
//);
//#endif
...
// */
//#if !defined(_M_CEE_PURE)
//CLASS_DECL_AURA _CRT_DUMP_CLIENT DECL_C _CrtSetDumpClient
//(
...
//#endif
//
//CLASS_DECL_AURA void DECL_C _CrtMemCheckpoint(_CrtMemState * _State);
//CLASS_DECL_AURA int32_t DECL_C _CrtMemDifference(_CrtMemState * _State, const _CrtMemState * _OldState, const _CrtMemState * _NewState);
//CLASS_DECL_AURA void DECL_C _CrtMemDumpAllObjectsSince(const _CrtMemState * _State);
//CLASS_DECL_AURA void DECL_C _CrtMemDumpStatistics(const _CrtMemState * _State);
//CLASS_DECL_AURA int32_t DECL_C _CrtDumpMemoryLeaks();
//CLASS_DECL_AURA int32_t DECL_C _CrtSetCheckCount(int32_t _CheckCount);
//CLASS_DECL_AURA int32_t DECL_C _CrtGetCheckCount();
//
#endif  /* DEBUG */
