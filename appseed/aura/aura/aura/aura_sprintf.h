...
CLASS_DECL_AURA int32_t swnprintf_dup(unichar *dest, size_t n, const unichar *fmt, ...);
CLASS_DECL_AURA int32_t vswprintf_dup(unichar *dest, size_t n, const unichar *fmt, va_list args);
