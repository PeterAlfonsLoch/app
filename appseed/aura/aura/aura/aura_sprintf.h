...
CLASS_DECL_AURA int32_t swnprintf_dup(wchar_t *dest, size_t n, const wchar_t *fmt, ...);
CLASS_DECL_AURA int32_t vswprintf_dup(wchar_t *dest, size_t n, const wchar_t *fmt, va_list args);
