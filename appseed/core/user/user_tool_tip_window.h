...
namespace user
{
   ...
   class tool_tip_window : public ::core::window
   {
   public:
      ...
      sp(::user::interaction)      m_pwnd;           // ::core::window associate with this tool tip wnd
      ...
      void SetPositionHint(sp(::core::window) pwnd, e_position eposition);
