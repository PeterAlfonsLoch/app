...
namespace uinteraction
{
   ...
   namespace frame
   {
      ...
      public:
         ...
         sp(::uinteraction::frame::control_box)       m_spcontrolbox;
         ...
         virtual void on_appearance_mode_change();
         ...
         virtual sp(::uinteraction::frame::control_box) get_control_box();
