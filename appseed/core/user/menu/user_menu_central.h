...
{
public:
   static BaseMenuCentral * GetMenuCentral(sp(::base::application) papp);
   BaseMenuCentral(sp(::base::application) papp);
...
public:
   ...
   virtual bool initialize_central_container(sp(::base::application) papp);
