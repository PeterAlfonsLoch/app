...
namespace filemanager
{
   ...
   namespace _shell
   {
      ...
      public:
         ...
         ImageSet(sp(::aura::application) papp);
         virtual ~ImageSet();
...
//      string CLASS_DECL_CORE _017FilePathGetParent(const char * lpcsz);
      ...
      bool CLASS_DECL_CORE _017HasSubFolder(sp(::aura::application) papp, LPITEMIDLIST lpiidl, const char * lpcszExtra);
#endif
      EFolder CLASS_DECL_CORE GetFolderType(sp(::aura::application) papp, const wchar_t * lpcszPath);
      EFolder CLASS_DECL_CORE GetFolderType(sp(::aura::application) papp, const char * lpcszPath);
