...
void simple_list_data::set_item_text(::user::list * plist, index iItem, index iSubItem, const char * lpcsz)
{
...
void simple_list_data::set_column_data(::user::list * plist,stringa & stra,int_ptr iColumn)
{
...
void simple_list_data::set_data(::user::list * plist,stringa &stra)
{
