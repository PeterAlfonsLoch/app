...
namespace user
{
   ...
   public:
      ...
      multiple_document_template(sp(::axis::application) papp, const char * pszMatter, sp(type) pDocClass, sp(type) pFrameClass, sp(type) pViewClass);
      ...
      virtual sp(::user::document) get_document(index index) const;
