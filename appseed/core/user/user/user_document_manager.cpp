...
#define DEFAULT_ICON_INDEX 0
   ...
   *lpszLast = '\0';
   ...
   {
   //         TRACE(::base::trace::category_AppMsg, 0, "Warning: registration database update failed for key '%s'.\n",
   //          lpszKey);
   return FALSE;
   }
   return TRUE;
   ...
   */
   document_manager::document_manager(sp(::base::application) papp) :
      element(papp)
   {
   }
   ...
   */
   ...
   bool document_manager::do_prompt_file_name(var & varFile, UINT nIDSTitle, uint32_t lFlags, bool bOpenFileDialog, sp(::user::impact_system) ptemplate, sp(::user::document) pdocument)
   {
   ...
   {
   TRACE(::base::trace::category_AppMsg, 0, "Error: no document templates registered with application.\n");
      ...
      */
      ...
      if (pOpenDocument != NULL)
      {
         ...
         if(pview != NULL)
         {
            ...
            if (pFrame == NULL)
               TRACE(::base::trace::category_AppMsg, 0, "Error: Can not find a frame for document to activate.\n");
            else
            {
            ...
            TRACE(::base::trace::category_AppMsg, 0, "Error: Can not find a ::user::impact for document to activate.\n");
