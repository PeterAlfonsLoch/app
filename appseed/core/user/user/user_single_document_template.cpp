...
namespace user
{
   ...
   single_document_template::single_document_template(sp(::axis::application) papp, const char * pszMatter, sp(type) pDocClass, sp(type) pFrameClass, sp(type) pViewClass) :
      element(papp),
