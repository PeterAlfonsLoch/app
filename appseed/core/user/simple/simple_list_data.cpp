...
void simple_list_data::set_item_text(::user::mesh * pmesh,index iItem,index iSubItem,const char * lpcsz)
{
...
void simple_list_data::set_column_data(::user::mesh * pmesh,stringa & stra,int_ptr iColumn)
{
...
void simple_list_data::set_data(::user::mesh * pmesh,stringa &stra)
{
