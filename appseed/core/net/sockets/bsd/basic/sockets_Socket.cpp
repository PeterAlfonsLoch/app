...
namespace sockets
{
   ...
   SOCKET socket::CreateSocket(int32_t af,int32_t iType, const string & strProtocol)
   {
      ...
      if (s == INVALID_SOCKET)
      {
         Handler().LogError(this, "socket", Errno, StrError(Errno), ::core::log::level_fatal);
         SetCloseAndDelete();
...
/*   ipaddr_t socket::GetRemoteIP4()
   {
      ...
      if(m_bIpv6)
      {
         Handler().LogError(this, "GetRemoteIP4", 0, "get ipv4 address for ipv6 socket", ::core::log::level_warning);
      }
   ...
   /*struct in6_addr socket::GetRemoteIP6()
   {
      if(!m_bIpv6)
      {
         Handler().LogError(this, "GetRemoteIP6", 0, "get ipv6 address for ipv4 socket", ::core::log::level_warning);
      }
...
/*      if(m_addressRemote.m_p == NULL)
   ...
   bool socket::SetSoReuseaddr(bool x)
   {
      ...
      return true;
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_REUSEADDR", ::core::log::level_info);
      return false;
   #endif
   }
   ...
   bool socket::SetSoKeepalive(bool x)
   {
      ...
      return true;
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_KEEPALIVE", ::core::log::level_info);
      return false;
   #endif
   }
   ...
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_ACCEPTCONN", ::core::log::level_info);
   #endif
   ...
   bool socket::SetSoBroadcast(bool x)
   {
      ...
      return true;
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_BROADCAST", ::core::log::level_info);
      return false;
   #endif
   }
   ...
   bool socket::SetSoDebug(bool x)
   {
      ...
      return true;
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_DEBUG", ::core::log::level_info);
      return false;
   #endif
   }
   ...
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_ERROR", ::core::log::level_info);
   #endif
      return value;
   }
   ...
   bool socket::SetSoDontroute(bool x)
   {
      ...
      return true;
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_DONTROUTE", ::core::log::level_info);
      return false;
   #endif
   }
   ...
   bool socket::SetSoLinger(int32_t onoff, int32_t linger)
   {
      ...
      return true;
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_LINGER", ::core::log::level_info);
      return false;
   #endif
   }
   ...
   bool socket::SetSoOobinline(bool x)
   {
      ...
      return true;
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_OOBINLINE", ::core::log::level_info);
      return false;
   #endif
   }
   ...
   bool socket::SetSoRcvlowat(int32_t x)
   {
      ...
      return true;
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_RCVLOWAT", ::core::log::level_info);
      return false;
   #endif
   }
   ...
   bool socket::SetSoSndlowat(int32_t x)
   {
      ...
      return true;
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_SNDLOWAT", ::core::log::level_info);
      return false;
   #endif
   }
   ...
   bool socket::SetSoRcvtimeo(struct timeval& tv)
   {
      ...
      return true;
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_RCVTIMEO", ::core::log::level_info);
      return false;
   #endif
   }
   ...
   bool socket::SetSoSndtimeo(struct timeval& tv)
   {
      ...
      return true;
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_SNDTIMEO", ::core::log::level_info);
      return false;
   #endif
   }
   ...
   bool socket::SetSoRcvbuf(int32_t x)
   {
      ...
      return true;
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_RCVBUF", ::core::log::level_info);
      return false;
   #endif
   }
   ...
   bool socket::SetSoSndbuf(int32_t x)
   {
      ...
      return true;
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_SNDBUF", ::core::log::level_info);
      return false;
   #endif
   }
   ...
   #else
      Handler().LogError(this, "socket option not available", 0, "SO_TYPE", ::core::log::level_info);
   #endif
      return value;
   }
