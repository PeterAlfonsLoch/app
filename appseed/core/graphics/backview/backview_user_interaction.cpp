   ...
   namespace user
   {
      ...
      string interaction::BackViewGetNextBackgroundImagePath()
      {
         ...
         if(m_spfilesetBackgroundImage.is_set())
         {
            ...
            data_get("::backview::CurrentBackgroundImagePath", ::core::system::idEmpty, strCurrentImagePath);
      ...
      void interaction::BackViewSetCurrentBackgroundImagePath(const char * psz)
      {
         ...
         data_set("::backview::CurrentBackgroundImagePath", ::core::system::idEmpty, psz);
