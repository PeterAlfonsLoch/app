...
CLASS_DECL_CORE int32_t __cdecl _CrtReportBlockType(const void * p);

CLASS_DECL_CORE int32_t __cdecl _CrtSetReportMode(int32_t,int32_t);

CLASS_DECL_CORE int32_t __cdecl _CrtSetReportHook2(int32_t,int32_t (__cdecl*)(int32_t,char *,int32_t *));

CLASS_DECL_CORE _CRT_DUMP_CLIENT DECL_C _CrtSetDumpClient(_CRT_DUMP_CLIENT _PFnNewDump);

CLASS_DECL_CORE int32_t __cdecl _CrtSetDbgFlag(int32_t);

CLASS_DECL_CORE int32_t __cdecl _CrtDumpMemoryLeaks();

CLASS_DECL_CORE int32_t DECL_C _CrtCheckMemory();
...
CLASS_DECL_CORE int32_t DECL_C _CrtDbgReportW(
        int32_t _ReportType,
