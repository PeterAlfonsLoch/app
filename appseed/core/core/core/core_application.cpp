...
#if defined(APPLEOS)
                     strPath = "/usr/bin/open -W -n " + strPath + " --args : app=" + notinstalled.m_strId + " install build_number=" + strBuildNumber + " locale=" + notinstalled.m_strLocale + " schema=" + notinstalled.m_strSchema;
#else
