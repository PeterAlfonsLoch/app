...
#define ON_MESSAGE_VOID(message, memberFxn) \
   { message, 0, 0, 0, ::core::Sig_vv, \
      (__PMSG)(__PMSGW)(void (__MSG_CALL ::user::window::*)(void))&memberFxn },
...
struct __SIZEPARENTPARAMS
{
   ...
   int_bool bStretch;   // should stretch to fill all space
};
...
CLASS_DECL_ca2 void ::core::RepositionWindow(__SIZEPARENTPARAMS* lpLayout,
