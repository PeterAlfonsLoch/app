...
//            create_context cc;
  //          cc.m_pCurrentDoc = get_document();
    //        cc.m_typeinfoNewView =  System.type_info < ::user::menu_list_view > ();
            ...
            sp(::user::menu_list_view) pview =  (impact::create_view(System.type_info < ::user::menu_list_view > (), get_document(), this, 101).m_p);
            if(pview != NULL)
            {
...
//            create_context cc;
  //          cc.m_pCurrentDoc = get_document();
    //        cc.m_typeinfoNewView =  System.type_info < ::nature::view > ();
            ...
            sp(::user::interaction) pview =  (impact::create_view(System.type_info < ::nature::view > (), get_document(), this, 101).m_p);
            if(pview != NULL)
            {
               pcreatordata->m_pdoc = get_document();
               pcreatordata->m_pwnd = pview;
