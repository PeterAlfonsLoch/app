...
namespace crypto
{
   ...
   namespace sha1 
   {
      ...
      class CLASS_DECL_CORE CContextBase
      {
      protected:
         sha1_ctx_t     m_ctx;
         uint64_t         _count;
...
//         void PrepareBlock(uint32_t *block, uint32_t size) const;
      ...
      class CLASS_DECL_CORE CContextBase2: public CContextBase
      {
      protected:
         uint32_t _count2;
      ...
      class CLASS_DECL_CORE CContext: public CContextBase2
      {
      public:
      ...
      class CLASS_DECL_CORE CContext32: public CContextBase2
      {
      public:
