...
namespace datetime
{
   ...
   value element::get_value(sp(::base::application) pbaseapp, ::user::str_context * pcontext, int32_t & iPath, int32_t & iPathCount) const
   {
   ...
   string element::get_expression(sp(::base::application) pbaseapp, ::user::str_context * pcontext, int32_t & iPath, int32_t & iPathCount) const
   {
