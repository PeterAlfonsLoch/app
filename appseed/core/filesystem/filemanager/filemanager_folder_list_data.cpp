...
namespace filemanager
{
   ...
   void folder_list_data::_001GetItemText(::user::list_item * pitem)
   {
      ...
      {
         bool_array ba;
         if(!data_get("recursive", ::base_system::idEmpty, ba))
         {
            pitem->m_bOk = false;
            return;
         }
   ...
   {
      stringa wstraTotal;
      if(!data_get(::base_system::idEmpty, ::base_system::idEmpty, wstraTotal))
         return;
   ...
   {
      stringa straTotal;
      if(!data_get(::base_system::idEmpty, ::base_system::idEmpty, straTotal))
         return -1;
   ...
   {
      stringa straData;
      data_get(::base_system::idEmpty, ::base_system::idEmpty, straData);
      bool_array baData;
      data_get("recursive", ::base_system::idEmpty, baData);
      ...
      if(!data_set(::base_system::idEmpty, ::base_system::idEmpty, straData))
         return false;
      if(!data_set("recursive", ::base_system::idEmpty, baData))
         return false;
      return true;
   }
   ...
   {
      stringa straData;
      if(!data_get(::base_system::idEmpty, ::base_system::idEmpty, straData))
         return true;
      bool_array baData;
      data_get("recursive", ::base_system::idEmpty, baData);
      index iFind;
