...
//      IShellFolder * lpsfDesktop;
   ...
   void SimpleFileListInterface::_001OnHScroll(signal_details * pobj)
   {
      pobj->m_bRet = false;
   }
   ...
   void SimpleFileListInterface::_001OnFileRename(signal_details * pobj)
   {
   ...
   void SimpleFileListInterface::_001OnUpdateFileRename(signal_details * pobj)
   {
