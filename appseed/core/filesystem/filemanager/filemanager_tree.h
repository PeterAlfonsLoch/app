...
namespace filemanager
{
   ...
   public:
      ...
      virtual void filemanager_tree_insert(const string & strPath, stringa & patha,stringa & straTitle,int64_array & iaSize,bool_array & ba,::action::context actioncontext, bool bOnlyParent = false);
