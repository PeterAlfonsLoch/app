...
namespace filemanager
{
   ...
   ::filemanager::preview::::filemanager::preview(sp(base_application) papp) :
      element(papp),
   ...
   void ::filemanager::preview::install_message_handling(::message::dispatch * pdispatch)
   {
   ...
   void ::filemanager::preview::on_update(sp(::user::view) pSender, LPARAM lHint, object* phint) 
   {
...
#include "framework.h"
   ...
   namespace filemanager
   {
      ...
      SimplePreviewInterface::SimplePreviewInterface(sp(base_application) papp) :
         element(papp),
