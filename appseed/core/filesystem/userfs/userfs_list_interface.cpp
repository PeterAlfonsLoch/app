...
namespace userfs
{
   ...
   list_interface::list_interface(sp(base_application) papp) :
      element(papp),
...
//      HRESULT hr;
   ...
   void list_interface::_017UpdateList(const char * lpcsz)
   {
      ...
      ::data::data::writing writing(get_fs_list_data());
...
//      SCAST_PTR(::message::scroll, pscroll, pobj)
   ...
   void list_interface::_001OnHScroll(signal_details * pobj)
   {
      pobj->m_bRet = false;
   }
   ...
   void list_interface::_001OnFileRename(signal_details * pobj)
   {
   ...
   void list_interface::_001OnUpdateFileRename(signal_details * pobj)
   {
...
/*   list_interface::create_image_list_thread::create_image_list_thread(sp(base_application) papp) :
      element(papp),
      thread(papp)
   {
   }
