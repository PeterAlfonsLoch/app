...
public:
   ...
   virtual bool data_server_load(::database::client * pclient, ::database::id idSection, ::database::id id, ::database::id idIndex, ::core::writable & writable, ::database::update_hint * phint = NULL);

   using database::server::data_server_save;
   virtual bool data_server_save(::database::client * pclient, ::database::id idSection, ::database::id id, ::database::id idIndex, ::core::readable & readable, ::database::update_hint * phint = NULL);
   ...
   bool load(const char * lpKey, ::core::writable & writer);

   bool save(const char * lpKey, const char * psz);
   bool save(const char * lpKey, ::core::readable & reader);
