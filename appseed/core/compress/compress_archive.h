...
namespace libcompress
{
   ...
   class CLASS_DECL_BASE archive_open_callback_interface :
   ...
   class CLASS_DECL_BASE archive_extract_callback_interface :
...
//virtual HRes GetStream(const char * name, ::file::input_stream **inStream) specifier; \ // input stream should be seekable, so by the time using ::file::binary_buffer interface
   ...
   class CLASS_DECL_BASE archive_open_volume_callback_interface
   {
   public:
   ...
   class CLASS_DECL_BASE input_archive_get_stream_interface
   {
   public:
   ...
   class CLASS_DECL_BASE input_archive_open_set_sub_archive_name_interface
   {
   public:
   ...
   */
   ...
   class CLASS_DECL_BASE input_archive_interface :
      virtual public object
   {
   public:
   ...
   class CLASS_DECL_BASE archive_open_input_stream :
      virtual public object
   {
   public:
   ...
   class CLASS_DECL_BASE archive_update_callback_interface :
      virtual public ::core::progress_interface
   {
   public:
   ...
   class CLASS_DECL_BASE archive_update_callback2_interface :
   ...
   class CLASS_DECL_BASE output_archive_interface
   {
   public:
   ...
   class CLASS_DECL_BASE set_properties_interface
   {
   public:
