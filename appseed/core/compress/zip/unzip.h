...
extern int32_t CLASS_DECL_CORE unzStringFileNameCompare OF ((const char* fileName1,
...
extern unzFile CLASS_DECL_CORE unzOpen OF((const char *path));
/*
...
extern unzFile CLASS_DECL_CORE unzOpen2 OF((const char *path,
...
extern int32_t CLASS_DECL_CORE unzClose OF((unzFile file));
/*
...
extern int32_t CLASS_DECL_CORE unzGetGlobalInfo OF((unzFile file,
...
extern int32_t CLASS_DECL_CORE unzGetGlobalComment OF((unzFile file,
                                           char *szComment,
                                           uint_ptr uSizeBuf));
/*
...
extern int32_t CLASS_DECL_CORE unzGoToFirstFile OF((unzFile file));
/*
  set the current file of the zipfile to the first spfile->
  return UNZ_OK if there is no problem
*/

extern int32_t CLASS_DECL_CORE unzGoToNextFile OF((unzFile file));
/*
...
extern int32_t CLASS_DECL_CORE unzLocateFile OF((unzFile file,
...
extern int32_t CLASS_DECL_CORE unzGetCurrentFileInfo OF((unzFile file,
...
extern int32_t CLASS_DECL_CORE unzOpenCurrentFile OF((unzFile file));
/*
  open for reading data the current file in the zipfile.
  If there is no error, the return value is UNZ_OK.
*/

extern int32_t CLASS_DECL_CORE unzOpenCurrentFilePassword OF((unzFile file,
                                                  const char* password));
/*
  open for reading data the current file in the zipfile.
...
extern int32_t CLASS_DECL_CORE unzOpenCurrentFile2 OF((unzFile file,
                                           int32_t* method,
                                           int32_t* level,
                                           int32_t raw));
/*
...
extern int32_t CLASS_DECL_CORE unzOpenCurrentFile3 OF((unzFile file,
                                           int32_t* method,
                                           int32_t* level,
                                           int32_t raw,
                                           const char* password));
...
extern int32_t CLASS_DECL_CORE unzCloseCurrentFile OF((unzFile file));
/*
  close the file in zip opened with unzOpenCurrentFile
  Return UNZ_CRCERROR if all the file was read but the CRC is not good
*/

extern int32_t CLASS_DECL_CORE unzReadCurrentFile OF((unzFile file,
                      voidp buf,
                      uint32_t len));
/*
...
extern int_ptr CLASS_DECL_CORE unztell OF((unzFile file));
/*
  Give the current position in uncompressed data
*/

extern int32_t CLASS_DECL_CORE unzeof OF((unzFile file));
/*
  return 1 if the end of file was reached, 0 elsewhere
*/

extern int32_t CLASS_DECL_CORE unzGetLocalExtrafield OF((unzFile file,
                                             voidp buf,
                                             uint32_t len));
/*
