...
namespace iexca2
{
   ...
   STDMETHODIMP ole_inplace_active_object::GetWindow(HWND *pHwnd)
   {
       if( NULL == pHwnd )
           return E_POINTER;
   ...
   STDMETHODIMP ole_inplace_active_object::EnableModeless(BOOL fEnable)
   {
       return S_OK;
   }

   STDMETHODIMP ole_inplace_active_object::ContextSensitiveHelp(BOOL fEnterMode)
   {
       return E_NOTIMPL;
   }
   ...
   STDMETHODIMP ole_inplace_active_object::OnDocWindowActivate(BOOL fActivate)
   {
       return S_OK;
   }

   STDMETHODIMP ole_inplace_active_object::ResizeBorder(LPCRECT prcBorder, LPOLEINPLACEUIWINDOW pUIWindow, BOOL fFrameWindow)
   {
       return S_OK;
   }
