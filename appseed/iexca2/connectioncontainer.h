...
namespace iexca2
{
   ...
   public:
      ...
      simple_attrib_map<DWORD, LPUNKNOWN> _connections;
   ...
   public:
      ...
      simple_array<LPCONNECTIONPOINT> _v_cps;
      simple_array<class dispatch_event *> _q_events;


      connection_point_container(host *p_instance);
