...
int find_last(RECURSION_VECT &Vector, const CScriptVar * Key)
{
   for(int i = Vector.get_upper_bound(); i>= 0; i--)
   {
      if(Vector[i]==Key)
         return ++i;
   }
...
void tinyjs::throwError(bool &execute, const string &message, int pos /*=-1*/) {
