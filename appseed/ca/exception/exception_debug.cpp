...
assert_exception::assert_exception(::ca::applicationsp papp, const char * pszFile, long lLine) :
   ca(papp),
   ::call_stack(papp),
   ::base_exception(papp),
...
misc_exception::misc_exception(::ca::applicationsp papp, const char * pszMessage) :
   ca(papp),
   ::call_stack(papp),
   ::base_exception(papp),
   simple_exception(papp)
