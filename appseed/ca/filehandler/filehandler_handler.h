...
namespace filehandler
{
   ...
   public:
      ...
      ::ca::tree_item * get_extension_tree_item(const char * pszExtension, bool bCreate);
      ::ca::tree_item * get_mime_type_tree_item(const char * pszMimeType, bool bCreate);
