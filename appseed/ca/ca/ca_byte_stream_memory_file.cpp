...
namespace ca
{
   ...
   byte_stream_memory_file::byte_stream_memory_file(::ca::applicationsp papp, ::primitive::memory_size iSize) :
      ca(papp),
   ...
   byte_stream_memory_file::byte_stream_memory_file(::ca::applicationsp papp, void * pMemory, primitive::memory_size dwSize) :
      ca(papp),
   ...
   byte_stream_memory_file::byte_stream_memory_file(::ca::applicationsp papp, const memory_file & memoryfile) :
      ca(papp),
      memory_container(papp),
   ...
   byte_stream_memory_file::byte_stream_memory_file(::ca::applicationsp papp, ::primitive::memory_base * pmemory) :
      ca(papp),
