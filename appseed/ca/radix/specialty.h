...
#define CATCH(class, e) } catch (class* e) \
   { ASSERT(e->is_kind_of(System.type_info < class > ())); UNUSED(e);
...
#define CATCH_ALL(e) } catch (base_exception* e) \
   { { ASSERT(e->is_kind_of(System.type_info < base_exception > ())); UNUSED(e);
...
#define END_TRY } catch (base_exception* e) \
   { ASSERT(e->is_kind_of(System.type_info < base_exception > ())); e->Delete(); } }
