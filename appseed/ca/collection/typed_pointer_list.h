...
// Construction
   ...
   POSITION add_head(object_list* newElement)
      { return _typed_pointer_list<object_list, object_list*>::add_head((::radix::object*)newElement); }
   POSITION add_tail(object_list* newElement)
      { return _typed_pointer_list<object_list, object_list*>::add_tail((::radix::object*)newElement); }
