...
namespace sockets
{
   ...
   private:
      ...
      EventHandler(::ca::applicationsp papp, const EventHandler& ) : ca(papp), socket_handler(papp) {} // copy constructor
   ...
   public:
      ...
      EventHandler(::ca::applicationsp papp, StdLog * = ::null());
      EventHandler(::ca::applicationsp papp, mutex &,StdLog * = ::null());
      ~EventHandler();
