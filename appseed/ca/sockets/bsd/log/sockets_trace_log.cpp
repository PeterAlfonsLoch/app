...
namespace sockets
{
   ...
   void trace_log::error(socket_handler_base * phandler, socket * sock, const string & strCall, int32_t iError, const string & strSystemError, ::gen::log::level::e_level elevel)
   {
