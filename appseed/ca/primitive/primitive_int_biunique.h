...
void serialize_write(gen::byte_output_stream & ostream, ::collection::map < t1, t2, t3, t4 > & m)
{
...
template < class t1, class t2, class t3, class t4 >
void serialize_read(gen::byte_input_stream & istream, ::collection::map < t1, t2, t3, t4 > & m)
{
   try
   {
      t1 iCount;
...
template < class T, class T_to_T >
void biunique < T, T_to_T > ::write(gen::byte_output_stream & ostream)
{
...
template < class T, class T_to_T >
void biunique < T, T_to_T > ::read(gen::byte_input_stream & istream)
{
   try
   {
...
class CLASS_DECL_ca index_biunique :
