...
*/
   ...
   private:
      ...
      string   m_strLocal; ///< local hostname
      string   m_strLocalIp; ///< local ip address in string format
      string   m_strLocalIp6; ///< local ip address in string format
      bool     m_bLocalResolved; ///< ResolveLocal has been called if true
