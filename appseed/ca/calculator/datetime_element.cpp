...
namespace datetime
{
   ...
   value element::get_value(::ca::applicationsp pcaapp, ::user::str_context * pcontext, int32_t & iPath, int32_t & iPathCount) const
   {
   ...
   string element::get_expression(::ca::applicationsp pcaapp, ::user::str_context * pcontext, int32_t & iPath, int32_t & iPathCount) const
   {
