...
namespace datetime
{
   ...
   value element::get_value(::ca::application * pcaapp, ::user::str_context * pcontext, int32_t & iPath, int32_t & iPathCount) const
   {
   ...
   string element::get_expression(::ca::application * pcaapp, ::user::str_context * pcontext, int32_t & iPath, int32_t & iPathCount) const
   {
