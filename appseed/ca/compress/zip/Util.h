...
namespace zip
{
   ...
   public:
      ...
      void ls(::ca::application * papp, const char * lpszFileName, bool bRecursive, stringa * pstraPath = NULL, stringa * pstraTitle = NULL, stringa * pstraRelative = NULL, base_array < bool, bool > * pbaIsDir = NULL, base_array < __int64, __int64 > * piaSize = NULL, e_extract eextract = extract_first);
      ...
      bool extract_all(const char * pszDir, ::ex1::file * pfile);
