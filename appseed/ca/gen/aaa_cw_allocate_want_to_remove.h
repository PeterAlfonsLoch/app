#ifndef DEBUG_SHAREDMEORY_ALLOCATOR_HEADER
#define DEBUG_SHAREDMEORY_ALLOCATOR_HEADER
...
//	::gen::trace::category *GetCategory(int iModule, unsigned nCategory) const;
	::gen::trace::category* GetCategory(int iCategory) const;
...
#endif // DEBUG_SHAREDMEORY_ALLOCATOR_HEADER
