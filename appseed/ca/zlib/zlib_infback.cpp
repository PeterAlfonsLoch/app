...
/*
   strm provides primitive::memory allocation functions in zalloc and zfree, or
   Z_NULL to use the library primitive::memory allocation functions.
...
/*
   strm provides the primitive::memory allocation functions and window buffer on input,
   ...
   error, or Z_MEM_ERROR if it could not allocate primitive::memory for the state.
