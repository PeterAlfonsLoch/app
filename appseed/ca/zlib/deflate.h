...
/* A Pos is an index in the character window. We use int16_t instead of int32_t to
...
typedef struct internal_state {
     ...
     * base_array to 64K, this link is maintained only for the last 32K strings.
     * An index in this base_array is thus a window index modulo 32K.
     */
