...
NTSYSAPI NTSTATUS  WINAPI NtAcceptConnectPort(PHANDLE,ULONG,PLPC_MESSAGE,WINBOOL,PLPC_SECTION_WRITE,PLPC_SECTION_READ);
...
NTSYSAPI NTSTATUS  WINAPI NtAccessCheckAndAuditAlarm(PUNICODE_STRING,HANDLE,PUNICODE_STRING,PUNICODE_STRING,PSECURITY_DESCRIPTOR,ACCESS_MASK,PGENERIC_MAPPING,WINBOOL,PACCESS_MASK,PBOOLEAN,PBOOLEAN);
NTSYSAPI NTSTATUS  WINAPI NtAddAtom(const WCHAR*,ULONG,RTL_ATOM*);
NTSYSAPI NTSTATUS  WINAPI NtAdjustGroupsToken(HANDLE,WINBOOL,PTOKEN_GROUPS,ULONG,PTOKEN_GROUPS,PULONG);
NTSYSAPI NTSTATUS  WINAPI NtAdjustPrivilegesToken(HANDLE,WINBOOL,PTOKEN_PRIVILEGES,DWORD,PTOKEN_PRIVILEGES,PDWORD);
...
NTSYSAPI NTSTATUS  WINAPI NtCancelTimer(HANDLE, WINBOOL*);
NTSYSAPI NTSTATUS  WINAPI NtClearEvent(HANDLE);
NTSYSAPI NTSTATUS  WINAPI NtClose(HANDLE);
NTSYSAPI NTSTATUS  WINAPI NtCloseObjectAuditAlarm(PUNICODE_STRING,HANDLE,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI NtContinue(PCONTEXT,WINBOOL);
NTSYSAPI NTSTATUS  WINAPI NtCreateDirectoryObject(PHANDLE,ACCESS_MASK,POBJECT_ATTRIBUTES);
NTSYSAPI NTSTATUS  WINAPI NtCreateEvent(PHANDLE,ACCESS_MASK,const OBJECT_ATTRIBUTES *,EVENT_TYPE,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI NtCreateMutant(HANDLE*,ACCESS_MASK,const OBJECT_ATTRIBUTES*,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI NtCreateProcess(PHANDLE,ACCESS_MASK,POBJECT_ATTRIBUTES,HANDLE,WINBOOL,HANDLE,HANDLE,HANDLE);
...
NTSYSAPI NTSTATUS  WINAPI NtCreateThread(PHANDLE,ACCESS_MASK,POBJECT_ATTRIBUTES,HANDLE,PCLIENT_ID,PCONTEXT,PINITIAL_TEB,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI NtDelayExecution(WINBOOL,const LARGE_INTEGER*);
...
NTSYSAPI NTSTATUS  WINAPI NtInitializeRegistry(WINBOOL);
NTSYSAPI NTSTATUS  WINAPI NtInitiatePowerAction(POWER_ACTION,SYSTEM_POWER_STATE,ULONG,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI NtLockFile(HANDLE,HANDLE,PIO_APC_ROUTINE,void*,PIO_STATUS_BLOCK,PLARGE_INTEGER,PLARGE_INTEGER,ULONG*,WINBOOL,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI NtNotifyChangeDirectoryFile(HANDLE,HANDLE,PIO_APC_ROUTINE,PVOID,PIO_STATUS_BLOCK,PVOID,ULONG,ULONG,WINBOOL);
NTSYSAPI NTSTATUS  WINAPI NtNotifyChangeKey(HANDLE,HANDLE,PIO_APC_ROUTINE,PVOID,PIO_STATUS_BLOCK,ULONG,WINBOOL,PVOID,ULONG,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI NtOpenObjectAuditAlarm(PUNICODE_STRING,PHANDLE,PUNICODE_STRING,PUNICODE_STRING,PSECURITY_DESCRIPTOR,HANDLE,ACCESS_MASK,ACCESS_MASK,PPRIVILEGE_SET,WINBOOL,WINBOOL,PBOOLEAN);
...
NTSYSAPI NTSTATUS  WINAPI NtOpenThreadToken(HANDLE,DWORD,WINBOOL,HANDLE *);
NTSYSAPI NTSTATUS  WINAPI NtOpenThreadTokenEx(HANDLE,DWORD,WINBOOL,DWORD,HANDLE *);
...
NTSYSAPI NTSTATUS  WINAPI NtPrivilegeObjectAuditAlarm(PUNICODE_STRING,HANDLE,HANDLE,ULONG,PPRIVILEGE_SET,WINBOOL);
NTSYSAPI NTSTATUS  WINAPI NtPrivilegedServiceAuditAlarm(PUNICODE_STRING,PUNICODE_STRING,HANDLE,PPRIVILEGE_SET,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI NtQueryDefaultLocale(WINBOOL,LCID*);
NTSYSAPI NTSTATUS  WINAPI NtQueryDefaultUILanguage(LANGID*);
NTSYSAPI NTSTATUS  WINAPI NtQueryDirectoryFile(HANDLE,HANDLE,PIO_APC_ROUTINE,PVOID,PIO_STATUS_BLOCK,PVOID,ULONG,FILE_INFORMATION_CLASS,WINBOOL,PUNICODE_STRING,WINBOOL);
NTSYSAPI NTSTATUS  WINAPI NtQueryDirectoryObject(HANDLE,PDIRECTORY_BASIC_INFORMATION,ULONG,WINBOOL,WINBOOL,PULONG,PULONG);
NTSYSAPI NTSTATUS  WINAPI NtQueryEaFile(HANDLE,PIO_STATUS_BLOCK,PVOID,ULONG,WINBOOL,PVOID,ULONG,PULONG,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI NtRaiseException(PEXCEPTION_RECORD,PCONTEXT,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI NtSetDefaultLocale(WINBOOL,LCID);
...
NTSYSAPI NTSTATUS  WINAPI NtSetInformationKey(HANDLE,const int32_t,PVOID,ULONG);
...
NTSYSAPI NTSTATUS  WINAPI NtSetTimer(HANDLE, const LARGE_INTEGER*, PTIMER_APC_ROUTINE, PVOID, WINBOOL, ULONG, WINBOOL*);
NTSYSAPI NTSTATUS  WINAPI NtSetTimerResolution(ULONG,WINBOOL,PULONG);
...
NTSYSAPI NTSTATUS  WINAPI NtSignalAndWaitForSingleObject(HANDLE,HANDLE,WINBOOL,const LARGE_INTEGER*);
...
NTSYSAPI NTSTATUS  WINAPI NtWaitForSingleObject(HANDLE,WINBOOL,const LARGE_INTEGER*);
NTSYSAPI NTSTATUS  WINAPI NtWaitForMultipleObjects(ULONG,const HANDLE*,WINBOOL,WINBOOL,const LARGE_INTEGER*);
...
NTSYSAPI NTSTATUS  WINAPI RtlAddAuditAccessAce(PACL,DWORD,DWORD,PSID,WINBOOL,WINBOOL);
NTSYSAPI NTSTATUS  WINAPI RtlAddAuditAccessAceEx(PACL,DWORD,DWORD,DWORD,PSID,WINBOOL,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI RtlAdjustPrivilege(ULONG,WINBOOL,WINBOOL,PBOOLEAN);
...
NTSYSAPI NTSTATUS  WINAPI RtlAnsiStringToUnicodeString(PUNICODE_STRING,PCANSI_STRING,WINBOOL);
...
NTSYSAPI WINBOOL   WINAPI RtlAreAllAccessesGranted(ACCESS_MASK,ACCESS_MASK);
NTSYSAPI WINBOOL   WINAPI RtlAreAnyAccessesGranted(ACCESS_MASK,ACCESS_MASK);
NTSYSAPI WINBOOL   WINAPI RtlAreBitsSet(PCRTL_BITMAP,ULONG,ULONG);
NTSYSAPI WINBOOL   WINAPI RtlAreBitsClear(PCRTL_BITMAP,ULONG,ULONG);
...
NTSYSAPI PDEBUG_BUFFER WINAPI RtlCreateQueryDebugBuffer(ULONG,WINBOOL);
NTSYSAPI ULONG     WINAPI RtlCompactHeap(HANDLE,ULONG);
NTSYSAPI LONG      WINAPI RtlCompareString(const STRING*,const STRING*,WINBOOL);
NTSYSAPI LONG      WINAPI RtlCompareUnicodeString(const UNICODE_STRING*,const UNICODE_STRING*,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI RtlConvertSidToUnicodeString(PUNICODE_STRING,PSID,WINBOOL);
NTSYSAPI void      WINAPI RtlCopyLuid(PLUID,const LUID*);
NTSYSAPI void      WINAPI RtlCopyLuidAndAttributesArray(ULONG,const LUID_AND_ATTRIBUTES*,PLUID_AND_ATTRIBUTES);
NTSYSAPI WINBOOL   WINAPI RtlCopySid(DWORD,PSID,PSID);
...
NTSYSAPI NTSTATUS  WINAPI RtlCreateEnvironment(WINBOOL, PWSTR*);
...
NTSYSAPI WINBOOL   WINAPI RtlCreateUnicodeString(PUNICODE_STRING,LPCWSTR);
NTSYSAPI WINBOOL   WINAPI RtlCreateUnicodeStringFromAsciiz(PUNICODE_STRING,LPCSTR);
NTSYSAPI NTSTATUS  WINAPI RtlCreateUserThread(HANDLE,const SECURITY_DESCRIPTOR*,WINBOOL,PVOID,SIZE_T,SIZE_T,PRTL_THREAD_START_ROUTINE,void*,HANDLE*,CLIENT_ID*);
...
NTSYSAPI WINBOOL   WINAPI RtlDllShutdownInProgress(void);
NTSYSAPI WINBOOL   WINAPI RtlDoesFileExists_U(LPCWSTR);
NTSYSAPI WINBOOL   WINAPI RtlDosPathNameToNtPathName_U(PCWSTR,PUNICODE_STRING,PWSTR*,CURDIR*);
...
NTSYSAPI NTSTATUS  WINAPI RtlDowncaseUnicodeString(UNICODE_STRING*,const UNICODE_STRING*,WINBOOL);
NTSYSAPI void      WINAPI RtlDumpResource(LPRTL_RWLOCK);
NTSYSAPI NTSTATUS  WINAPI RtlDuplicateUnicodeString(int32_t,const UNICODE_STRING*,UNICODE_STRING*);
NTSYSAPI NTSTATUS  WINAPI RtlEmptyAtomTable(RTL_ATOM_TABLE,WINBOOL);
...
NTSYSAPI WINBOOL   WINAPI RtlEqualLuid(const LUID*,const LUID*);
NTSYSAPI WINBOOL      WINAPI RtlEqualPrefixSid(PSID,PSID);
NTSYSAPI WINBOOL      WINAPI RtlEqualSid(PSID,PSID);
NTSYSAPI WINBOOL   WINAPI RtlEqualString(const STRING*,const STRING*,WINBOOL);
NTSYSAPI WINBOOL   WINAPI RtlEqualUnicodeString(const UNICODE_STRING*,const UNICODE_STRING*,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI RtlFindCharInUnicodeString(int32_t,const UNICODE_STRING*,const UNICODE_STRING*,USHORT*);
NTSYSAPI ULONG     WINAPI RtlFindClearBits(PCRTL_BITMAP,ULONG,ULONG);
NTSYSAPI ULONG     WINAPI RtlFindClearBitsAndSet(PRTL_BITMAP,ULONG,ULONG);
NTSYSAPI ULONG     WINAPI RtlFindClearRuns(PCRTL_BITMAP,PRTL_BITMAP_RUN,ULONG,WINBOOL);
...
NTSYSAPI ULONG     WINAPI RtlFindSetRuns(PCRTL_BITMAP,PRTL_BITMAP_RUN,ULONG,WINBOOL);
NTSYSAPI WINBOOL   WINAPI RtlFirstFreeAce(PACL,PACE_HEADER *);
NTSYSAPI NTSTATUS  WINAPI RtlFormatCurrentUserKeyPath(PUNICODE_STRING);
//NTSYSAPI NTSTATUS  WINAPI RtlFormatMessage(LPWSTR,UCHAR,WINBOOL,WINBOOL,WINBOOL,__ms_va_list *,LPWSTR,ULONG);
NTSYSAPI void      WINAPI RtlFreeAnsiString(PANSI_STRING);
NTSYSAPI WINBOOL   WINAPI RtlFreeHandle(RTL_HANDLE_TABLE *,RTL_HANDLE *);
NTSYSAPI WINBOOL   WINAPI RtlFreeHeap(HANDLE,ULONG,PVOID);
...
NTSYSAPI WINBOOL   WINAPI RtlGetNtProductType(LPDWORD);
...
NTSYSAPI PVOID     WINAPI RtlImageDirectoryEntryToData(HMODULE,WINBOOL,WORD,ULONG *);
...
NTSYSAPI WINBOOL      WINAPI RtlInitializeSid(PSID,PSID_IDENTIFIER_AUTHORITY,BYTE);
...
NTSYSAPI WINBOOL   WINAPI RtlIsActivationContextActive(HANDLE);
NTSYSAPI ULONG     WINAPI RtlIsDosDeviceName_U(PCWSTR);
NTSYSAPI WINBOOL   WINAPI RtlIsNameLegalDOS8Dot3(const UNICODE_STRING*,POEM_STRING,PBOOLEAN);
NTSYSAPI WINBOOL   WINAPI RtlIsTextUnicode(LPCVOID,INT,INT *);
NTSYSAPI WINBOOL   WINAPI RtlIsValidHandle(const RTL_HANDLE_TABLE *, const RTL_HANDLE *);
NTSYSAPI WINBOOL   WINAPI RtlIsValidIndexHandle(const RTL_HANDLE_TABLE *, ULONG Index, RTL_HANDLE **);
...
NTSYSAPI WINBOOL   WINAPI RtlLockHeap(HANDLE);
...
NTSYSAPI NTSTATUS  WINAPI RtlNewSecurityObject(PSECURITY_DESCRIPTOR,PSECURITY_DESCRIPTOR,PSECURITY_DESCRIPTOR*,WINBOOL,HANDLE,PGENERIC_MAPPING);
...
NTSYSAPI NTSTATUS  WINAPI RtlOemStringToUnicodeString(UNICODE_STRING*,const STRING*,WINBOOL);
...
NTSYSAPI WINBOOL   WINAPI RtlPrefixString(const STRING*,const STRING*,WINBOOL);
NTSYSAPI WINBOOL   WINAPI RtlPrefixUnicodeString(const UNICODE_STRING*,const UNICODE_STRING*,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI RtlSetDaclSecurityDescriptor(PSECURITY_DESCRIPTOR,WINBOOL,PACL,WINBOOL);
NTSYSAPI NTSTATUS  WINAPI RtlSetEnvironmentVariable(PWSTR*,PUNICODE_STRING,PUNICODE_STRING);
NTSYSAPI NTSTATUS  WINAPI RtlSetOwnerSecurityDescriptor(PSECURITY_DESCRIPTOR,PSID,WINBOOL);
NTSYSAPI NTSTATUS  WINAPI RtlSetGroupSecurityDescriptor(PSECURITY_DESCRIPTOR,PSID,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI RtlSetSaclSecurityDescriptor(PSECURITY_DESCRIPTOR,WINBOOL,PACL,WINBOOL);
...
NTSYSAPI WINBOOL   WINAPI RtlTimeFieldsToTime(PTIME_FIELDS,PLARGE_INTEGER);
NTSYSAPI void      WINAPI RtlTimeToElapsedTimeFields(const LARGE_INTEGER *,PTIME_FIELDS);
NTSYSAPI WINBOOL   WINAPI RtlTimeToSecondsSince1970(const LARGE_INTEGER *,LPDWORD);
NTSYSAPI WINBOOL   WINAPI RtlTimeToSecondsSince1980(const LARGE_INTEGER *,LPDWORD);
NTSYSAPI WINBOOL      WINAPI RtlTryEnterCriticalSection(RTL_CRITICAL_SECTION *);
...
NTSYSAPI NTSTATUS  WINAPI RtlUnicodeStringToAnsiString(PANSI_STRING,PCUNICODE_STRING,WINBOOL);
...
NTSYSAPI NTSTATUS  WINAPI RtlUnicodeStringToOemString(POEM_STRING,PCUNICODE_STRING,WINBOOL);
...
NTSYSAPI WINBOOL   WINAPI RtlUnlockHeap(HANDLE);
...
NTSYSAPI NTSTATUS  WINAPI RtlUpcaseUnicodeString(UNICODE_STRING*,const UNICODE_STRING *,WINBOOL);
NTSYSAPI NTSTATUS  WINAPI RtlUpcaseUnicodeStringToAnsiString(STRING*,const UNICODE_STRING*,WINBOOL);
NTSYSAPI NTSTATUS  WINAPI RtlUpcaseUnicodeStringToCountedOemString(STRING*,const UNICODE_STRING*,WINBOOL);
NTSYSAPI NTSTATUS  WINAPI RtlUpcaseUnicodeStringToOemString(STRING*,const UNICODE_STRING*,WINBOOL);
...
NTSYSAPI WINBOOL   WINAPI RtlValidAcl(PACL);
NTSYSAPI WINBOOL   WINAPI RtlValidSid(PSID);
NTSYSAPI WINBOOL   WINAPI RtlValidateHeap(HANDLE,ULONG,LPCVOID);
...
NTSYSAPI NTSTATUS  WINAPI RtlWow64EnableFsRedirection(WINBOOL);
