 ...
 * the Colorer library.
 *
 * It uses line_source interface as a source of input data, and
...
public:
  ...
  /**
   * Installs line_source, used as an input of text to parse
   */
  virtual void setLineSource(line_source *lh) = 0;
