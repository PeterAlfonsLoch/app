...
CLASS_DECL_BASE void * __cdecl operator new(size_t nSize, const char * lpszFileName, int32_t nLine) new_throw_spec;
CLASS_DECL_BASE void __cdecl operator delete(void * p, const char * lpszFileName, int32_t nLine) del_throw_spec;
CLASS_DECL_BASE void * __cdecl operator new[](size_t nSize, const char * lpszFileName, int32_t nLine) new_throw_spec;
CLASS_DECL_BASE void __cdecl operator delete[](void * p, const char * lpszFileName, int32_t nLine) del_throw_spec;
