...
namespace sockets
{
   ...
   void base_socket::OnException()
   {
      ...
      // errno valid here?
      int err = SoError();
      log("exception on select", err, StrError(err), ::base::log::level_fatal);
      SetCloseAndDelete();
   }
   ...
   */
   ...
   if(m_bIpv6)
   {
   log("GetRemoteIP4", 0, "get ipv4 address for ipv6 base_socket", ::base::log::level_warning);
   }
   ...
   if(!m_bIpv6)
   {
   log("GetRemoteIP6", 0, "get ipv6 address for ipv4 base_socket", ::base::log::level_warning);
   }
...
/*   #ifdef _WIN32
   ...
   {
      log("GetPort", 0, "GetPort only implemented for listen_socket", ::base::log::level_warning);
      return 0;
   }
   ...
   void base_socket::SetClientRemoteAddress(const ::net::address & address)
   {
      ...
      /*      if (!ad.IsValid())
      {
      log("SetClientRemoteAddress", 0, "remote address not valid", ::base::log::level_error);
      }*/
   ...
   ::net::address base_socket::GetClientRemoteAddress()
   {
      ...
      {
      log("GetClientRemoteAddress", 0, "remote address not yet set", ::base::log::level_error);
      }*/
   ...
   bool base_socket::SetIpOptions(const void *p, socklen_t len)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_OPTIONS)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
      log("ip option not available", 0, "IP_OPTIONS", ::base::log::level_info);
      return false;
#endif
   }
   ...
   bool base_socket::SetIpPktinfo(bool x)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_PKTINFO)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   bool base_socket::SetIpRecvTOS(bool x)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_RECVTOS)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   bool base_socket::SetIpRecvTTL(bool x)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_RECVTTL)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   bool base_socket::SetIpRecvopts(bool x)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_RECVOPTS)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   bool base_socket::SetIpRetopts(bool x)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_RETOPTS)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   bool base_socket::SetIpTOS(unsigned char tos)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_TOS)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
      log("ip option not available", 0, "IP_TOS", ::base::log::level_info);
      return false;
#endif
   }
   ...
   unsigned char base_socket::IpTOS()
   {
      ...
      {
         log("getsockopt(IPPROTO_IP, IP_TOS)", Errno, StrError(Errno), ::base::log::level_fatal);
      }
#else
      log("ip option not available", 0, "IP_TOS", ::base::log::level_info);
#endif
   ...
   bool base_socket::SetIpTTL(int ttl)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_TTL)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
      log("ip option not available", 0, "IP_TTL", ::base::log::level_info);
      return false;
#endif
   }
   ...
   int base_socket::IpTTL()
   {
      ...
      {
         log("getsockopt(IPPROTO_IP, IP_TTL)", Errno, StrError(Errno), ::base::log::level_fatal);
      }
#else
      log("ip option not available", 0, "IP_TTL", ::base::log::level_info);
#endif
   ...
   bool base_socket::SetIpHdrincl(bool x)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_HDRINCL)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
      log("ip option not available", 0, "IP_HDRINCL", ::base::log::level_info);
      return false;
#endif
   }
   ...
   bool base_socket::SetIpRecverr(bool x)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_RECVERR)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   bool base_socket::SetIpMtudiscover(bool x)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_MTU_DISCOVER)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   int base_socket::IpMtu()
   {
      ...
      {
         log("getsockopt(IPPROTO_IP, IP_MTU)", Errno, StrError(Errno), ::base::log::level_fatal);
      }
      return mtu;
   }
#endif
   ...
   bool base_socket::SetIpRouterAlert(bool x)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_ROUTER_ALERT)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   bool base_socket::SetIpMulticastTTL(int ttl)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_MULTICAST_TTL)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
      log("ip option not available", 0, "IP_MULTICAST_TTL", ::base::log::level_info);
      return false;
#endif
   }
   ...
   int base_socket::IpMulticastTTL()
   {
      ...
      {
         log("getsockopt(IPPROTO_IP, IP_MULTICAST_TTL)", Errno, StrError(Errno), ::base::log::level_fatal);
      }
#else
      log("ip option not available", 0, "IP_MULTICAST_TTL", ::base::log::level_info);
#endif
   ...
   bool base_socket::SetMulticastLoop(bool x)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_MULTICAST_LOOP)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
      log("ip option not available", 0, "IP_MULTICAST_LOOP", ::base::log::level_info);
      return false;
#endif
   }
   ...
   bool base_socket::IpAddMembership(struct ip_mreqn& ref)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_ADD_MEMBERSHIP)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
      log("ip option not available", 0, "IP_ADD_MEMBERSHIP", ::base::log::level_info);
      return false;
#endif
   }
#endif
   ...
   bool base_socket::IpDropMembership(struct ip_mreqn& ref)
   {
      ...
      {
         log("setsockopt(IPPROTO_IP, IP_DROP_MEMBERSHIP)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
      log("ip option not available", 0, "IP_DROP_MEMBERSHIP", ::base::log::level_info);
      return false;
#endif
   }
#endif
   ...
   bool base_socket::SetSoReuseaddr(bool x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_REUSEADDR)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
   ...
   bool base_socket::SetSoKeepalive(bool x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_KEEPALIVE)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
   ...
   bool base_socket::SetSoNosigpipe(bool x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_NOSIGPIPE)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   bool base_socket::SetSoBsdcompat(bool x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_BSDCOMPAT)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   bool base_socket::SetSoBindtodevice(const string & intf)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_BINDTODEVICE)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   bool base_socket::SetSoBroadcast(bool x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_BROADCAST)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
   ...
   bool base_socket::SetSoDebug(bool x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_DEBUG)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
   ...
   bool base_socket::SetSoDontroute(bool x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_DONTROUTE)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
   ...
   bool base_socket::SetSoLinger(int onoff, int linger)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_LINGER)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
   ...
   bool base_socket::SetSoOobinline(bool x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_OOBINLINE)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
   ...
   bool base_socket::SetSoPasscred(bool x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_PASSCRED)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   bool base_socket::SoPeercred(struct ::ucred & ucr)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_PEERCRED)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   bool base_socket::SetSoPriority(int x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_PRIORITY)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   bool base_socket::SetSoRcvlowat(int x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_RCVLOWAT)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
   ...
   bool base_socket::SetSoSndlowat(int x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_SNDLOWAT)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
   ...
   bool base_socket::SetSoRcvtimeo(struct timeval& tv)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_RCVTIMEO)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
   ...
   bool base_socket::SetSoSndtimeo(struct timeval& tv)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_SNDTIMEO)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
   ...
   bool base_socket::SetSoRcvbuf(int x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_RCVBUF)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
   ...
   bool base_socket::SetSoRcvbufforce(int x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_RCVBUFFORCE)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   bool base_socket::SetSoSndbuf(int x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_SNDBUF)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
#else
   ...
   bool base_socket::SetSoSndbufforce(int x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_SNDBUFFORCE)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   bool base_socket::SetSoTimestamp(bool x)
   {
      ...
      {
         log("setsockopt(SOL_SOCKET, SO_TIMESTAMP)", Errno, StrError(Errno), ::base::log::level_fatal);
         return false;
      }
      return true;
   }
   ...
   */
   ...
   void base_socket::log(const string & strUser, int32_t err, const string & strSystem, ::base::log::e_level elevel)
   {
