...
namespace user
{
   ...
   public:
      ...
      virtual bool track_popup_menu(::xml::node node,int32_t iFlags,int32_t x,int32_t y);
      ...
      virtual bool track_popup_menu(::xml::node node,int32_t iFlags,signal_details * pobj);
      ...
      virtual bool track_popup_menu(::xml::node node,int32_t iFlags);
