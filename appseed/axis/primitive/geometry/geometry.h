...
CLASS_DECL_AXIS bool set_rect(tagRECTD * prectDest, double x1, double y1, double x2, double y2);
...
CLASS_DECL_AXIS bool set_rect(__rect64 * prectDest, int64_t x1, int64_t y1, int64_t x2, int64_t y2);
