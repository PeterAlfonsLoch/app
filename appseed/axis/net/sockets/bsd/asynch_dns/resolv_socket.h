...
namespace sockets
{
   ...
   public:
      ...
      resolv_socket(axis_socket_handler&);
      resolv_socket(axis_socket_handler&, axis_socket *parent, const string & host, port_t port, bool ipv6 = false);
      resolv_socket(axis_socket_handler&, axis_socket *parent, in_addr);
      resolv_socket(axis_socket_handler&, axis_socket *parent, in6_addr&);
      ~resolv_socket();
