...
namespace fontopus
{
   ...
   string CLASS_DECL_AXIS get_cred(::aura::application * papp, const string & strRequestUrl, const RECT & rect, string & strUsername, string & strPassword, string strToken, string strTitle, bool bInteractive);
   string CLASS_DECL_AXIS get_cred(::aura::application * papp, string & strUsername, string & strPassword, string strToken);
   void CLASS_DECL_AXIS set_cred(::aura::application * papp,string strToken,const char * pszUsername,const char * pszPassword);
   void CLASS_DECL_AXIS set_cred_ok(::aura::application * papp,string strToken,bool bOk);
