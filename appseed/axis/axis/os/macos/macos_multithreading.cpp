...
//   if(iOsPolicy == SCHED_RR)
   {
      ...
      iCa2Min = ::aura::scheduling_priority_idle;
...
int32_t process_get_os_priority(int32_t nCa2Priority)
{
   ...
   if(nCa2Priority <= (int) ::aura::scheduling_priority_none)
      return 0;
   
   if(nCa2Priority <= (int) ::aura::scheduling_priority_normal)
      return max(-20, min(0, -20 * ((int) ::aura::scheduling_priority_normal - nCa2Priority) / ((int) ::aura::scheduling_priority_normal - (int) ::aura::scheduling_priority_idle)));
   
   return max(0, min(20, 20 * (nCa2Priority - (int) ::aura::scheduling_priority_normal) / ((int) ::aura::scheduling_priority_time_critical - (int) ::aura::scheduling_priority_normal)));
...
int32_t process_get_scheduling_priority(int32_t iOsPriority)
{
   ...
   if(iOsPriority < -15)
      return ::aura::scheduling_priority_idle;
   
   if(iOsPriority < -10)
      return ::aura::scheduling_priority_lowest;

   if(iOsPriority < 0)
      return ::aura::scheduling_priority_below_normal;
   
   if(iOsPriority == 0)
      return ::aura::scheduling_priority_normal;
   
   if(iOsPriority < 10)
      return ::aura::scheduling_priority_above_normal;
   
   if(iOsPriority < 15)
      return ::aura::scheduling_priority_highest;
   
   return ::aura::scheduling_priority_time_critical;
