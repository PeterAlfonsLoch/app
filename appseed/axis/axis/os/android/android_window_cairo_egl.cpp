...
void window_cairo_egl::create_window_graphics(oswindow interaction_impl,int64_t cxParam,int64_t cyParam,int iStrideParam)
{
   ...
   * the first EGLConfig that matches our criteria */
   ...
   m_cairo = eglCreateContext(display, config, NULL, NULL);

   EGLSurface surface = eglCreateWindowSurface(display, config, window->m_engine->app->window, NULL);
