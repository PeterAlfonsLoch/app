...
void dir::rls(string_array & stra, const char *psz)
{
...
void dir::rls_dir(string_array & stra, const char *psz)
{
   ::count start = stra.get_count();
   ls_dir(stra, psz);
   ::count end = stra.get_count();
...
void dir::ls(string_array & stra, const char *psz)
{
...
void dir::ls_dir(string_array & stra, const char *psz)
{
