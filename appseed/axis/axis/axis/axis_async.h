...
namespace async
{
   ...
   struct CLASS_DECL_AXIS registration_token : public token
   {

   };


   struct CLASS_DECL_AXIS cancellation_token : public token
   {
