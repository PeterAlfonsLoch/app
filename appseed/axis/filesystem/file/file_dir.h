...
public:
   ...
   static CLASS_DECL_AXIS bool is(const char * path1);
   static CLASS_DECL_AXIS bool mk(const char * lpcsz);
   static CLASS_DECL_AXIS void ls(stringa & stra, const char *psz);
   static CLASS_DECL_AXIS void ls_dir(stringa & stra, const char *psz);
   static CLASS_DECL_AXIS void rls(stringa & stra, const char *psz);
   static CLASS_DECL_AXIS void rls_dir(stringa & stra, const char *psz);
