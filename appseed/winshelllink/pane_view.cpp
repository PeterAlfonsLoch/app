...
namespace winshelllink
{
   ...
   void pane_view::on_show_view() 
   {
      ...
      winshelllink_frame * pframe = dynamic_cast < winshelllink_frame *> (
   ...
   {
      winshelllink_application * papp = dynamic_cast < winshelllink_application * > ((dynamic_cast < userbase::frame_window * > (GetParentFrame()))->get_app());
      ...
      case PaneViewWinActionArea:
         {
            ::userbase::view * pview = dynamic_cast < ::userbase::view * > (create_view(typeid(winshelllink_view), get_document(), this, 101));
            if(pview != NULL)
            {
