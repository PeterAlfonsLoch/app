...
winshelllink_frame  * g_pframe;

// IMPLEMENT_DYNCREATE(winshelllink_frame, simple_frame_window)

 // BEGIN_MESSAGE_MAP(winshelllink_frame, simple_frame_window)
	//{{AFX_MSG_MAP(winshelllink_frame)
/* xxx	ON_WM_CREATE()
	ON_WM_GETMINMAXINFO()
	ON_WM_MOVE()
	ON_WM_CLOSE()
...
/////////////////////////////////////////////////////////////////////////////
// winshelllink_frame construction/destruction

winshelllink_frame::winshelllink_frame(::ca::application * papp) :
   ca(papp),
...
//   connect_command("app_exit", &winshelllink_frame::_001OnAppExit);
//   connect_update_cmd_ui("app_exit", &winshelllink_frame::_001OnUpdateAppExit);
}

winshelllink_frame::~winshelllink_frame()
{
}

int winshelllink_frame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
/* 	if (!m_menubar.CreateEx(this))
   ...
   string str = Application.file().as_string(
      System.dir().matter("winshelllink\\toolbar.xml"));
...
/////////////////////////////////////////////////////////////////////////////
// winshelllink_frame diagnostics

#ifdef _DEBUG
void winshelllink_frame::assert_valid() const
{
	simple_frame_window::assert_valid();
}

void winshelllink_frame::dump(dump_context & dumpcontext) const
{
...
void winshelllink_frame::_001OnTimer(gen::signal_object * pobj) 
{
...
void winshelllink_frame::SetAnimatedStatusBarText(const char * lpcsz)
{
...
void winshelllink_frame::AnimateStatusBar()
{
   if(m_strAnimatedStatusBarText.is_empty())
      return;
...
void winshelllink_frame::ShowControlBars(bool bShow)
{
   UINT nShow;
   if(bShow)
   {
...
void winshelllink_frame::OnHoverAction(bool bShowWinActionArea)
{
   if(!IsWindowVisible())
   {
...
void winshelllink_frame::_001OnClose(gen::signal_object * pobj)
{
   pobj->m_bRet = true;
   ShowWindow(SW_HIDE);
}
...
void winshelllink_frame::_001InstallMessageHandling(::user::win::message::dispatch * pinterface)
{
   simple_frame_window::_001InstallMessageHandling(pinterface);
   IGUI_WIN_MSG_LINK(WM_CLOSE, pinterface, this, &winshelllink_frame::_001OnClose);
   IGUI_WIN_MSG_LINK(WM_TIMER, pinterface, this, &winshelllink_frame::_001OnTimer);
   IGUI_WIN_MSG_LINK(WM_MOVE, pinterface, this, &winshelllink_frame::_001OnMove);
   IGUI_WIN_MSG_LINK(WM_SHOWWINDOW, pinterface, this, &winshelllink_frame::_001OnShowWindow);
   IGUI_WIN_MSG_LINK(WM_DESTROY, pinterface, this, &winshelllink_frame::_001OnDestroy);
   IGUI_WIN_MSG_LINK(WM_APP + 2000  , this, this, &winshelllink_frame::_001OnApp2000);
}

void winshelllink_frame::_001OnMove(gen::signal_object * pobj)
{
...
void winshelllink_frame::_001OnShowWindow(gen::signal_object * pobj)
{
...
bool winshelllink_frame::_001OnCommand(id id)
{
   if(id == "app_exit")
   {
...
bool winshelllink_frame::_001OnUpdateCmdUi(cmd_ui * pcmdui)
{
...
void winshelllink_frame::_001OnDestroy(gen::signal_object * pobj)
{
   show_task_bar(SW_SHOW);
}


void winshelllink_frame::_001OnApp2000(gen::signal_object * pobj)
{
...
void winshelllink_frame::show_task_bar(int nCmdShow)
{
