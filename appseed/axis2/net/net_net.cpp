...
*/
CLASS_DECL_AXIS string to_vsstring(const in6_addr * addr)
{
...
CLASS_DECL_AXIS string to_vsstring(const in_addr * addrParam)
{
...
CLASS_DECL_AXIS string to_vsstring(const sockaddr *addr)
{
