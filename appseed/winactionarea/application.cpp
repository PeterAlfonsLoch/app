...
namespace winactionarea
{
   ...
   bool application::initialize_instance()
   {
      ...
      factory().creatable_small < winactionarea::pane_view >();
      factory().creatable_small < winactionarea::menu_right_view >();
      factory().creatable_small < winactionarea::menu_view >();
...
CLASS_DECL_CA2_WINACTIONAREA ::ca::application * get_new_app()
{
   return new winactionarea::application;
}
