...
CLASS_DECL_c DWORD GetFileAttributesW(const wchar_t * psz);
...
CLASS_DECL_c HANDLE FindFirstFileA(const char * pwsz, WIN32_FIND_DATAA * pdata);
CLASS_DECL_c HANDLE FindFirstFileW(const wchar_t * pwsz, WIN32_FIND_DATAW * pdata);
