...
namespace datetime
{
   ...
   class CLASS_DECL_BASE date_span
   {
   public:
      date_span();
      int32_t m_iMonth;
   ...
   class CLASS_DECL_BASE time_span
   {
   public:
   ...
   class CLASS_DECL_BASE file_time_span
   {
   public:
   ...
   class CLASS_DECL_BASE file_time :
      public FILETIME
   {
   public:
      file_time() NOTHROW;
   ...
   extern CLASS_DECL_BASE const char * const szInvalidDateTime;
   extern CLASS_DECL_BASE const char * const szInvalidDateTimeSpan;
...
CLASS_DECL_BASE dump_context & operator <<(dump_context & dumpcontext, ::datetime::time time);
CLASS_DECL_BASE dump_context & operator <<(dump_context & dumpcontext, ::datetime::time_span time);

CLASS_DECL_BASE ::file::output_stream & operator <<(::file::output_stream & os, ::datetime::time time);
CLASS_DECL_BASE ::file::input_stream & operator >>(::file::input_stream & is, ::datetime::time & time);
CLASS_DECL_BASE ::file::output_stream & operator <<(::file::output_stream & os, ::datetime::time_span span);
CLASS_DECL_BASE ::file::input_stream & operator >>(::file::input_stream & is, ::datetime::time_span & span);


inline CLASS_DECL_BASE ::datetime::time_span operator - (const duration & duration, const ::datetime::time & time)
{
...
inline CLASS_DECL_BASE ::datetime::time operator + (const duration & duration, const ::datetime::time & time)
{
