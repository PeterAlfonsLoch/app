...
namespace datetime
{
   ...
   class CLASS_DECL_c file_time_span
   {
   public:
   ...
   extern CLASS_DECL_c const char * const szInvalidDateTime;
   extern CLASS_DECL_c const char * const szInvalidDateTimeSpan;
...
inline CLASS_DECL_c ::datetime::time operator + (const duration & duration, const ::datetime::time & time)
{
