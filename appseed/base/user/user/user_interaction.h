...
//      sp(mutex)                           m_spmutex;
      ...
      virtual bool SetWindowPos(int_ptr z,const RECT & rect,UINT nFlags = 0);
      virtual bool SetWindowPos(int_ptr z,int32_t x,int32_t y,int32_t cx,int32_t cy,UINT nFlags = 0);
