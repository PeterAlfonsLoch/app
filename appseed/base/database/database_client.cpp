...
namespace database
{
   ...
   {
      return data_set(id, ::base_system::idEmpty, b, phint);
   }

   bool client::data_set(class id id, const char * lpcsz, update_hint * phint)
   {
      return data_set(id, ::base_system::idEmpty, lpcsz, phint);
   }

   bool client::data_get(class id id, bool & b)
   {
      return data_get(id, ::base_system::idEmpty, b);
   }

   bool client::data_get(class id id, string & str)
   {
      return data_get(id, ::base_system::idEmpty, str);
   }
   ...
   {
      return data_set(id, ::base_system::idEmpty, i, puh);
   }
   ...
   {
      return data_get(id, ::base_system::idEmpty, i);
   }
