...
namespace database
{
   ...
   public:
      ...
      virtual bool data_server_load       (client * pclient, class id id, ::file::output_stream & ostream, update_hint * phint = NULL);
      virtual bool data_server_load       (client * pclient, class id id, ::file::serializable & obj, update_hint * phint = NULL);
//      virtual bool data_server_load       (client * pclient, class id id, ::core::plain_text_output_stream & ostream, update_hint * phint = NULL);
//      virtual bool data_server_load       (client * pclient, class id id, ::file::serializable & obj, update_hint * phint = NULL);
      ...
      virtual bool data_server_save       (client * pclient, class id id, ::file::input_stream & istream, update_hint * phint = NULL);
      virtual bool data_server_save       (client * pclient, class id id, ::file::serializable & obj, update_hint * phint = NULL);
//      virtual bool data_server_save       (client * pclient, class id id, ::core::plain_text_input_stream & istream, update_hint * phint = NULL);
//      virtual bool data_server_save       (client * pclient, class id id, ::file::serializable & obj, update_hint * phint = NULL);
      ...
      virtual bool var_load               (client * pclient, class id id, ::file::output_stream & obj, update_hint * phint = NULL);
      virtual bool var_save               (client * pclient, class id id, ::file::input_stream & obj, update_hint * phint = NULL);
