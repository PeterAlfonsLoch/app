...
namespace file
{
   ...
   class CLASS_DECL_BASE byte_stream_memory_buffer :
   ...
   public:
      ...
      byte_stream_memory_buffer(base_application * papp);
      byte_stream_memory_buffer(::primitive::memory_base * pbase);
      byte_stream_memory_buffer(base_application * papp, const void * data, ::primitive::memory_size c);
