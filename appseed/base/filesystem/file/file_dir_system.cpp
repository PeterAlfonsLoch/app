...
#define string_STRCAT2_beg_char_end(strCat, ch, str1, str2, beg1, end1, beg2, end2) \
      ...
      void system::root_ones(stringa & straPath, stringa & straTitle, sp(::axis::application) papp)
      {
      ...
      void system::rls_pattern(sp(::axis::application) papp, const char * lpcsz, const char * pszPattern, stringa * pstraPath, stringa * pstraTitle, stringa * pstraRelative, bool_array * pbaIsDir, int64_array * piaSize, e_extract eextract)
      {
      ...
      void system::ls_pattern(sp(::axis::application) papp, const char * lpcsz, const char * pszPattern, stringa * pstraPath, stringa * pstraTitle, bool_array * pbaIsDir, int64_array * piaSize)
      {
         UNREFERENCED_PARAMETER(pszPattern);
      ...
      void system::ls(sp(::axis::application) papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle, bool_array * pbaIsDir, int64_array * piaSize)
      {
      ...
      void system::rls(sp(::axis::application) papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle, stringa * pstraRelative, e_extract eextract)
      {
         if(eextract != extract_none && ::get_thread() != NULL && get_thread()->m_bZipIsDir && (::str::ends_ci(lpcsz,".zip") || ::str::find_ci(".zip:",lpcsz) >= 0))
         {
      ...
      void system::rls_dir(sp(::axis::application) papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle, stringa * pstraRelative)
      {
         UNREFERENCED_PARAMETER(lpcsz);
         UNREFERENCED_PARAMETER(pstraPath);
         UNREFERENCED_PARAMETER(pstraTitle);
      ...
      void system::ls_dir(sp(::axis::application) papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle)
      {
         if(::get_thread() != NULL && ::get_thread()->m_bZipIsDir && (::str::ends_ci(lpcsz,".zip") || ::str::find_ci(".zip:",lpcsz) >= 0))
         {
      ...
      bool system::has_subdir(sp(::axis::application) papp, const char * lpcsz)
      {
         UNREFERENCED_PARAMETER(lpcsz);
         throw interface_only_exception(get_app(), "this is an interface");
      }

      void system::ls_file(sp(::axis::application) papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle)
      {
         UNREFERENCED_PARAMETER(lpcsz);
         UNREFERENCED_PARAMETER(pstraPath);
         UNREFERENCED_PARAMETER(pstraTitle);
      ...
      bool system::is_or_definitively_not(bool & bIs, const char * lpcszPath, sp(::axis::application) papp)
      {
      ...
      bool system::is(const char * lpcszPath, sp(::axis::application) papp)
      {
      ...
      bool system::is(const string & strPath, sp(::axis::application) papp)
      {
      ...
      bool system::is(const var & var, sp(::axis::application) papp)
      {
         return is((const string &) var, papp);
      }

      bool system::name_is(const char * lpcszPath, sp(::axis::application) papp)
      {
         return name_is((const string &) lpcszPath, papp);
      }

      bool system::name_is(const string & strPath, sp(::axis::application) papp)
      {
      ...
      bool system::name_is(const var & var, sp(::axis::application) papp)
      {
         return name_is((const string &) var, papp);
      }


      system::is_dir_map::is_dir_map(sp(::axis::application) papp) :
      ...
      bool system::mk(const char * lpcsz, sp(::axis::application) papp)
      {
         UNREFERENCED_PARAMETER(lpcsz);
         throw interface_only_exception(get_app(), "this is an interface");
      }

      bool system::rm(sp(::axis::application) papp, const char * psz, bool bRecursive)
      {
      ...
      string system::locale_schema(sp(::axis::application) papp, const string & strLocale, const string & strSchema)
      {
      ...
      stringa system::locale_schema_matter(sp(::axis::application) papp, const string & strLocale, const string & strSchema, const char * pszRoot, const char * pszApp)
      {
      ...
      void system::matter_ls(sp(::axis::application) papp, const string & str, stringa & stra)
      {
      ...
      void system::matter_ls_file(sp(::axis::application) papp, const string & str, stringa & stra)
      {
      ...
      string system::matter(sp(::axis::application) papp, const stringa & stra, bool bDir, const char * pszRoot, const char * pszApp)
      {
...

         {
            ...
            if (papp->m_pbasesession != NULL && papp->m_pbasesession != papp &&
               (sp(::axis::application)) papp->m_pbasesystem != (sp(::axis::application)) papp)
            {
            ...
            if (papp->m_pbasesystem != NULL && papp->m_pbasesystem != papp &&
               (sp(::axis::application)) papp->m_pbasesystem != (sp(::axis::application)) papp->m_pbasesession)
            {
      ...
      string system::matter(sp(::axis::application) papp, const char * psz, const char * psz2, bool bDir, const char * pszRoot, const char * pszApp)
      {
         return matter(papp, string(psz), string(psz2), bDir, pszRoot, pszApp);
      }

      string system::matter(sp(::axis::application) papp, const string & str, const char * psz, bool bDir, const char * pszRoot, const char * pszApp)
      {
         return matter(papp, str, string(psz), bDir, pszRoot, pszApp);
      }

      string system::matter(sp(::axis::application) papp, const char * psz, const string & str, bool bDir, const char * pszRoot, const char * pszApp)
      {
...
ret:
         ...
         if(papp->m_psession != NULL && papp->m_psession != papp &&
            (sp(::axis::application)) papp->m_psystem != (sp(::axis::application)) papp)
         {
         ...
         if(papp->m_psystem != NULL && papp->m_psystem != papp &&
            (sp(::axis::application)) papp->m_psystem != (sp(::axis::application)) papp->m_psession)
         {
      ...
      string system::matter(sp(::axis::application) papp, const char * psz, bool bDir, const char * pszRoot, const char * pszApp)
      {
         string str(psz);
         string str2;
      ...
      string system::matter(sp(::axis::application) papp, const string & str, bool bDir, const char * pszRoot, const char * pszApp)
      {
         string str2;
         return matter(papp, str, str2, bDir, pszRoot, pszApp);
      }

      string system::matter(sp(::axis::application) papp)
      {
         string str;
         string str2;
      ...
      */
      ...
      void system::appmatter_locators(string & strRoot, string & strDomain, sp(::axis::application) papp)
      {
      ...
      string system::appmatter_locator(sp(::axis::application) papp)
      {
      ...
      string system::usersystemappdata(sp(::axis::application) papp, const char * lpcszPrefix, const char * lpcsz, const char * lpcsz2)
      {
      ...
      string system::userappdata(sp(::axis::application) papp, const char * lpcsz, const char * lpcsz2)
      {
         UNREFERENCED_PARAMETER(papp);
         UNREFERENCED_PARAMETER(lpcsz);
         UNREFERENCED_PARAMETER(lpcsz2);
      ...
      string system::userdata(sp(::axis::application) papp, const char * lpcsz, const char * lpcsz2)
      {
         UNREFERENCED_PARAMETER(papp);
         UNREFERENCED_PARAMETER(lpcsz);
         UNREFERENCED_PARAMETER(lpcsz2);
      ...
      string system::userfolder(sp(::axis::application) papp, const char * lpcsz, const char * lpcsz2)
      {
         UNREFERENCED_PARAMETER(papp);
         UNREFERENCED_PARAMETER(lpcsz);
         UNREFERENCED_PARAMETER(lpcsz2);
      ...
      string system::default_os_user_path_prefix(sp(::axis::application) papp)
      {
         UNREFERENCED_PARAMETER(papp);
         throw interface_only_exception(get_app(), "this is an interface");
      }

      string system::default_userappdata(sp(::axis::application) papp, const char * lpcszPrefix, const char * lpcszLogin, const char * pszRelativePath)
      {
         UNREFERENCED_PARAMETER(papp);
         UNREFERENCED_PARAMETER(lpcszPrefix);
      ...
      string system::default_userdata(sp(::axis::application) papp, const char * lpcszPrefix, const char * lpcszLogin, const char * pszRelativePath)
      {
         UNREFERENCED_PARAMETER(papp);
         UNREFERENCED_PARAMETER(lpcszPrefix);
         UNREFERENCED_PARAMETER(lpcszLogin);
      ...
      string system::default_userfolder(sp(::axis::application) papp, const char * lpcszPrefix, const char * lpcszLogin, const char * pszRelativePath)
      {
         UNREFERENCED_PARAMETER(papp);
         UNREFERENCED_PARAMETER(lpcszPrefix);
         UNREFERENCED_PARAMETER(lpcszLogin);
      ...
      string system::userquicklaunch(sp(::axis::application) papp, const char * lpcszRelativePath, const char * lpcsz2)
      {
         UNREFERENCED_PARAMETER(papp);
      ...
      string system::userprograms(sp(::axis::application) papp, const char * lpcsz, const char * lpcsz2)
      {
         UNREFERENCED_PARAMETER(papp);
         UNREFERENCED_PARAMETER(lpcsz);
         UNREFERENCED_PARAMETER(lpcsz2);
      ...
      bool system::is_inside_time(const char * pszPath, sp(::axis::application) papp)
      {
         UNREFERENCED_PARAMETER(pszPath);
         throw interface_only_exception(get_app(), "this is an interface");
      }

      bool system::is_inside(const char * pszDir, const char * pszPath, sp(::axis::application) papp)
      {
      ...
      string system::pathfind(const char * pszEnv, const char * pszTopic, const char * pszMode, sp(::axis::application) papp)
      {
