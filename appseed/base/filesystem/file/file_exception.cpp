...
namespace file
{
   ...
   void exception::OnFileFound(OF_INFO_t OpenedFileInfo )
   {
      ...
      if(System.file_name(::str::international::unicode_to_utf8(OpenedFileInfo.lpFile)).CompareNoCase(System.file_name(m_strFileName)) == 0)
      {
   ...
   */
   ...
   bool exception::get_error_message(string & str, PUINT pnHelpContext)
   {
      ...
      if(m_lOsError == ERROR_ACCESS_DENIED || m_lOsError == ERROR_SHARING_VIOLATION)
      {
         ...
         wstr = ::str::international::utf8_to_unicode(System.dir_name(m_strFileName));
