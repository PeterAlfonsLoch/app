...
namespace file
{
   ...
   plain_text_stream_memory_buffer::plain_text_stream_memory_buffer(base_application * papp)
   {
   ...
   plain_text_stream_memory_buffer::plain_text_stream_memory_buffer(base_application * papp, const void * data, ::primitive::memory_size c)
   {
