...
namespace file
{
   ...
   memory_buffer::memory_buffer(sp(::base::application) papp, ::primitive::memory_size iSize) :
      element(papp),
   ...
   memory_buffer::memory_buffer(sp(::base::application) papp, void * pMemory, ::primitive::memory_size dwSize) :
      element(papp),
   ...
   memory_buffer::memory_buffer(sp(::base::application) papp, const memory_buffer & memoryfile) :
      element(papp),
