...
#define API CLASS_DECL_CORE __declspec(nothrow) HRESULT __stdcall
#define API_(x)CLASS_DECL_CORE __declspec(nothrow) x __stdcall
#define APIINL API
...
#define INLINE inline
   ...
   #ifdef _AFX
   #error core API projects cannot define _NO_EXCEPTIONS
   #endif
#else
   #ifndef _CPPUNWIND
...
can help with that, though they have not yet been applied to the whole of core, which uses a variety of patterns to achieve
this end
*/
