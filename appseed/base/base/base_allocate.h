...
CLASS_DECL_c void * MidAlloc(size_t size);
CLASS_DECL_c void * MidRealloc(void * address, size_t sizeOld, size_t sizeNew);
CLASS_DECL_c void MidFree(void *address);
CLASS_DECL_c void * BigAlloc(size_t size);
CLASS_DECL_c void BigFree(void *address);
...
CLASS_DECL_c bool __enable_memory_tracking(bool bTrack);

/////////////////////////////////////////////////////////////////////////////
// Enumerate all objects allocated in the diagnostic primitive::memory heap

struct CLASS_DECL_c ___ENUM_CONTEXT
{
   void (*m_pfn)(object*,void *);
   void * m_pContext;
};

CLASS_DECL_c __STATIC void __do_for_all_objects_proxy(void * pObject, void * pContext);
CLASS_DECL_c void __do_for_all_objects(void (c_cdecl *pfn)(object*, void *), void * pContext);

/////////////////////////////////////////////////////////////////////////////
// Automatic debug primitive::memory diagnostics

CLASS_DECL_c bool __dump_memory_leaks();
