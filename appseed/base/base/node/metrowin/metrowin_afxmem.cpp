...
// Obsolete API
/*
void CLASS_DECL_metrowin __set_alloc_stop(LONG lRequestNumber)
{
   _CrtSetBreakAlloc(lRequestNumber);
}
*/
#ifdef DEBUG
bool CLASS_DECL_metrowin __check_memory()
...
bool CLASS_DECL_metrowin __is_memory_block(const void * pData, UINT nBytes,
