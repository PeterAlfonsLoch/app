...
//CLASS_DECL_metrowin void ::ca2::LockTempMaps(::base::application * papp);
//CLASS_DECL_metrowin bool ::ca2::UnlockTempMaps(::base::application * papp, bool bDeleteTemps = TRUE);
