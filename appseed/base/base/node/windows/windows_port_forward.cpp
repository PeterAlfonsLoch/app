...
namespace windows
{
   ...
   bool port_forward::GetMappingsUsingThread( oswindow oswindow )
   {
	   ...
	   m_pPortMappingThread = ::__begin_thread(get_app(), ThreadForPortRetrieval, this, ::aura::scheduling_priority_below_normal, 0);
   ...
   bool port_forward::EditMappingUsingThread( port_forward::port_map& oldMapping, port_forward::port_map& newMapping, oswindow oswindow )
   {
	   ...
	   m_pEditMappingThread = ::__begin_thread(get_app(), ThreadToEditMapping, this, ::aura::scheduling_priority_below_normal, 0, 0);
   ...
   bool port_forward::AddMappingUsingThread( port_forward::port_map& newMapping, oswindow oswindow )
   {
	   ...
	   m_pAddMappingThread = ::__begin_thread(get_app(), ThreadToAddMapping, this, ::aura::scheduling_priority_below_normal, 0, 0);
   ...
   bool port_forward::DeleteMappingUsingThread( port_forward::port_map& oldMapping, oswindow oswindow )
   {
	   ...
	   m_pDeleteMappingThread = ::__begin_thread(get_app(), ThreadToDeleteMapping, this, ::aura::scheduling_priority_below_normal, 0, 0);
   ...
   {	
	   ...
	   m_pDeviceInfoThread = ::__begin_thread(get_app(), ThreadForDeviceInformationRetrieval, this,  ::aura::scheduling_priority_below_normal, 0, 0);
