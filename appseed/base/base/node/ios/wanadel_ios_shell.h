...
namespace ios
{
   ...
   public:
      ...
      // xxx   static_function WINBOOL WINAPI _SHGetPathFromIDList(LPCITEMIDLIST pidl, char16_t * pszPath);
      // xxx   static_function HANDLE WINAPI _FindFirstFile(const char16_t * lpcsz, WIN32_FIND_DATAW * lpdata);
      // xxx   static_function WINBOOL WINAPI _FindNextFile(HANDLE handle, WIN32_FIND_DATAW * lpdata);
      /*   static_function WINBOOL WINAPI _MoveFile(const char16_t * lpExistingFileName, const char16_t * lpNewFileName);
       static_function DWORD WINAPI _GetFullPathName(const char16_t * lpFileName, DWORD nBufferLength, char16_t * lpBuffer, char16_t ** lpFilePart);
       ...
       // xxx    static_function ATOM WINAPI _RegisterClass(
       ...
       // xxx    static_function WINBOOL SHGetPathFromIDList(LPCITEMIDLIST pidl, char16_t * pszPath);
       // xxx    static_function HANDLE FindFirstFile(const char16_t * lpcsz, WIN32_FIND_DATAW * lpdata);
       // xxx    static_function WINBOOL WINAPI FindNextFile(HANDLE handle, WIN32_FIND_DATAW * lpdata);
       static_function WINBOOL MoveFile(const char16_t * lpExistingFileName, const char16_t * lpNewFileName);
       static_function WCHAR * __cdecl _fullpath(WCHAR *UserBuf, const WCHAR *path, size_t maxlen);
       static_function DWORD GetFullPathName(const char16_t * lpFileName, DWORD nBufferLength, char16_t * lpBuffer, char16_t ** lpFilePart);
