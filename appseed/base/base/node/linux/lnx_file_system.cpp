...
namespace lnx
{
   ...
   string file_system::time_square(sp(::base::application) papp, const char * pszPrefix, const char * pszSuffix)
   {
      string str;
   ...
   string file_system::time_log(sp(::base::application) papp, const char * pszId)
   {
   ...
   string file_system::as_string(var varFile, sp(::base::application) papp)
   {
       var varQuery;
   ...
   void file_system::as_memory(var varFile, primitive::memory_base & mem, sp(::base::application) papp)
   {
   ...
   bool file_system::put_contents(var varFile, const char * lpcszContents, sp(::base::application) papp)
   {
   ...
   bool file_system::put_contents(var varFile, ::file::reader & reader, sp(::base::application) papp)
   {
   ...
   bool file_system::put_contents(var varFile, primitive::memory & mem, sp(::base::application) papp)
   {
   ...
   void file_system::copy(const char * pszNew, const char * psz, bool bFailIfExists, e_extract eextract, sp(::base::application) papp)
   {
      if(bFailIfExists)
      {
   ...
   string file_system::copy(const char * psz, sp(::base::application) papp)
   {
      string strCopy("copy");
      string strNew;
   ...
   string file_system::paste(const char * pszLocation, const char * path, sp(::base::application) papp)
   {
   ...
   void file_system::trash_that_is_not_trash(stringa & stra, sp(::base::application) papp)
   {
   ...
   void file_system::trash_that_is_not_trash(const char * psz, sp(::base::application) papp)
   {
...
//         ::MoveFile(psz, System.dir().path(strDir, name_(psz)));
   ...
   void file_system::replace(const char * pszContext, const char * pszFind, const char * pszReplace, sp(::base::application) papp)
   {
      stringa straTitle;
...
//                ::str::international::utf8_to_unicode(System.dir().path(pszContext, strOld)),
 //              ::str::international::utf8_to_unicode(System.dir().path(pszContext, strNew)));
   ...
   string file_system::sys_temp(const char * pszName, const char * pszExtension, sp(::base::application) papp)
   {
