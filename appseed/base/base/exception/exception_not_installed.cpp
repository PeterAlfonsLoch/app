...
not_installed::not_installed(sp(base_application) papp, const char * pszVersion, const char * pszBuild, const char * pszType, const char * pszId, const char * pszLocale, const char * pszSchema) :
   element(papp),
   ::call_stack(papp),
   ::exception::base(papp)
{
