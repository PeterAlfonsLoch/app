...
//CLASS_DECL_BASE void ::core::LockTempMaps(sp(base_application) papp);
//CLASS_DECL_BASE bool ::core::UnlockTempMaps(sp(base_application) papp, bool bDeleteTemps = TRUE);
