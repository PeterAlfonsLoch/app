...
CLASS_DECL_BASE void ms_download_callback(void * param, int32_t i, uint_ptr dwLen);
CLASS_DECL_BASE void ms_get_callback(void * param, int32_t i, uint_ptr dwLen);

CLASS_DECL_BASE void dlr(uint32_t dwDownload);
