...
namespace net
{
   ...
   HRESULT /* STDMETHODCALLTYPE */ port_forward_change_callbacks::OnNewNumberOfEntries( int32_t lNewNumberOfEntries )
   {
      ...
      ::simple_message_box(NULL,tempStr,"Change Detected in Number of Port Mappings",MB_OK | MB_ICONEXCLAMATION);
   ...
   HRESULT /* STDMETHODCALLTYPE */ port_forward_change_callbacks::OnNewExternalIPAddress(const char * pszNewExternalIPAddress )
   {
      ...
      ::simple_message_box(NULL,tempStr,"Change Detected in External IP Address",MB_OK | MB_ICONEXCLAMATION);
