...
#pragma once
   ...
   namespace sockets
   {
      ...
      \ingroup basic */
      class CLASS_DECL_CORE socket_handler :
      ...
      public:
         ...
         socket_handler(::ca::application * papp, logger *log = NULL);

         /** socket_handler threadsafe constructor.
         \param mutex Externally declared mutex var
         \param log Optional log class pointer */
         socket_handler(::ca::application * papp, mutex & mutex,logger *log = NULL);
         ...
         /** Register logger object for error callback.
         \param log Pointer to log class */
         void RegStdLog(logger *log);
      ...
      protected:
         logger *m_stdlog; ///< Registered log class, or NULL
