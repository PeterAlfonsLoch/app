...
string CLASS_DECL_c operator + (const char * psz, const property & prop);
string CLASS_DECL_c operator + (const string & str, const property & prop);

var CLASS_DECL_c operator - (int32_t i, const property & prop);
var CLASS_DECL_c operator - (uint32_t user, const property & prop);
...
var CLASS_DECL_c operator - (const var & var, const property & prop);
...
class CLASS_DECL_c pair_set_interface
{
public:
...
class CLASS_DECL_c str_str_interface
{
public:
...
public:
   ...
   //      friend string CLASS_DECL_c operator + (const char * psz, const property & var);
   //      friend string CLASS_DECL_c operator + (const string & str, const property & var);
   ...
   //      friend var CLASS_DECL_c operator - (int32_t i, const property & prop);
   //      friend var CLASS_DECL_c operator - (uint32_t user, const property & prop);
   //      friend var CLASS_DECL_c operator - (int64_t i, const property & prop);
   //      friend var CLASS_DECL_c operator - (uint64_t ui, const property & prop);
   //      friend var CLASS_DECL_c operator - (double d, const property & prop);
   //      friend var CLASS_DECL_c operator - (const var & var, const property & prop);
   //      friend var CLASS_DECL_c operator - (const property & prop1, const property & prop2);
...
class CLASS_DECL_c property_array :
...
class CLASS_DECL_c property_map :
   public id_to_index
{
public:
...
namespace str
{
   inline bool CLASS_DECL_c begins(const property & property, const char * lpcszPrefix) { return begins(property.get_string(), lpcszPrefix); };
}
