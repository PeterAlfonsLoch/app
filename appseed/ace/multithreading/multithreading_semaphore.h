...
class CLASS_DECL_ACE semaphore :
...
public:
   ...
   semaphore(::ace::application * papp, LONG lInitialCount = 1, LONG lMaxCount = 1, const char * pstrName=NULL, LPSECURITY_ATTRIBUTES lpsaAttributes = NULL);
   virtual ~semaphore();
