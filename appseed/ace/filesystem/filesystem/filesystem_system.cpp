...
//CLASS_DECL_ACE void NESSIEinit(struct NESSIEstruct * const structpointer);
//CLASS_DECL_ACE void NESSIEadd(const uchar * const source, uint_ptr sourceBits, struct NESSIEstruct * const structpointer);
//CLASS_DECL_ACE void NESSIEfinalize(struct NESSIEstruct * const structpointer, uchar * const result);
...
//   }
   ...
   bool system::exists(const ::file::path & pszPath, ::ace::application * papp)
   {
   ...
   //bool system::exists(const char * pszPath, var * pvarQuery, ::ace::application * papp)
   //{
   ...
   //bool system::exists(const ::file::path & strPath,::ace::application * papp)
   //{
   ...
   bool system::exists(const ::file::path & strPath,var * pvarQuery,::ace::application * papp)
   {
      ...
      //if (!papp->m_pacesystem->dir().name_is(strPath, papp))
      //   return false;
   ...
   var system::length(const ::file::path & pszPath,::ace::application * papp)
   {
   ...
   //var system::length(const ::file::path & pszPath,var * pvarQuery,::ace::application * papp)
   //{
   ...
   //var system::length(const string & strPath, ::ace::application * papp)
   //{
   ...
   var system::length(const ::file::path & strPath,var * pvarQuery,::ace::application * papp)
   {
   ...
   ::file::path system::time_square(::ace::application * papp,const string & pszPrefix,const string & pszSuffix)
   {
   ...
   ::file::path system::time_log(::ace::application * papp,const string & pszId)
   {
      return time(papp, System.dir().time_log(pszId), 9);
   }


   ::file::path system::time(::ace::application * papp,const ::file::path & psz,int32_t iMaxLevel,const string & pszPrefix,const string & pszSuffix)
   {
...
restart:
   ...
   string system::as_string(var varFile, ::ace::application * papp)
   {
      var varQuery;
      return as_string(varFile, varQuery, papp);
   }

   string system::as_string(var varFile, var & varQuery, ::ace::application * papp)
   {
      memory storage;
   ...
   void system::as_memory(var varFile, primitive::memory_base & mem, ::ace::application * papp)
   {
   ...
   void system::lines(stringa & stra, var varFile, ::ace::application * papp)
   {
   ...
   bool system::put_contents(var varFile, const void * pvoidContents, ::count count, ::ace::application * papp)
   {
   ...
   bool system::add_contents(var varFile,const void * pvoidContents,::count count,::ace::application * papp)
   {
   ...
   bool system::put_contents(var varFile, const char * lpcszContents, ::ace::application * papp)
   {
   ...
   bool system::add_contents(var varFile,const char * lpcszContents,::ace::application * papp)
   {
   ...
   bool system::put_contents(var varFile, ::file::reader & reader, ::ace::application * papp)
   {
      ::file::buffer_sp spfile;
      spfile = App(papp).file().get_file(varFile, ::file::type_binary | ::file::mode_write | ::file::mode_create | ::file::share_deny_none | ::file::defer_create_directory);
      if(spfile.is_null())
   ...
   bool system::put_contents(var varFile, memory & mem, ::ace::application * papp)
   {
      return put_contents(varFile, mem.get_data(), (count) mem.get_size(), papp);
   }

   bool system::put_contents_utf8(var varFile, const char * lpcszContents, ::ace::application * papp)
   {
      ::file::buffer_sp spfile;
      spfile = App(papp).file().get_file(varFile, ::file::type_binary | ::file::mode_write | ::file::mode_create | ::file::share_deny_none | ::file::defer_create_directory);
      if(spfile.is_null())
   ...
   system::system(::ace::application * papp) :
      object(papp)
   {
      //m_path.m_pfile = this;
   ...
   ::cres system::copy(const ::file::path & pszNew,const ::file::path & psz,bool bFailIfExists,e_extract eextract,::ace::application * papp)
   {
   ...
   bool system::get_status(const ::file::path & path,::file::file_status & status,::ace::application * papp)
   {
   ...
   cres system::set_status(const ::file::path & path,const ::file::file_status & status,::ace::application * papp)
   {
   ...
   ::cres system::move(const ::file::path & pszNew,const ::file::path & psz,::ace::application * papp)
   {
#ifdef WINDOWSEX
   ...
   ::cres system::del(const ::file::path & psz,::ace::application * papp)
   {
   ...
   ::file::path system::copy(const ::file::path & psz,::ace::application * papp)
   {
      string strCopy("copy");
      string strNew;
   ...
   ::file::path system::paste(const ::file::path & pszLocation,const ::file::path & path,::ace::application * papp)
   {
   ...
   void system::trash_that_is_not_trash(::file::patha & stra, ::ace::application * papp)
   {
   ...
   void system::trash_that_is_not_trash(const ::file::path & psz,::ace::application * papp)
   {
   ...
   ::cres system::replace(const ::file::path & pszContext,const string & pszFind,const string & pszReplace,::ace::application * papp)
   {
   ...
   ::file::path system::sys_temp(const ::file::path & pszName, const char * pszExtension, ::ace::application * papp)
   {
   ...
   ::file::buffer_sp system::time_square_file(::ace::application * papp, const string & pszPrefix, const string & pszSuffix)
   {
   ...
   ::file::buffer_sp system::get(const ::file::path & name,::ace::application * papp)
   {
   ...
   cres system::rename(const ::file::path & pszNew,const ::file::path & psz,::ace::application * papp)
   {
   ...
   void system::dtf(const ::file::path  & pszFile,const ::file::path & pszDir,::ace::application * papp)
   {
      listing ls(papp);
      ls.rls( pszDir);
      dtf(pszFile, ls, papp);
   ...
   void system::dtf(const ::file::path & pszFile,::file::patha & stra,::ace::application * papp)
   {
   ...
   void system::ftd(const ::file::path & pszDir,const ::file::path & pszFile,::ace::application * papp)
   {
   ...
   bool system::is_valid_fileset(const ::file::path & pszFile,::ace::application * papp)
   {
   ...
   ::file::buffer_sp system::get_file(var varFile,UINT nOpenFlags,cres * pfesp,::ace::application * papp)
   {
