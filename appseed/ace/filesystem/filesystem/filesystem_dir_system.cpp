...
#define string_STRCAT2_beg_char_end(strCat, ch, str1, str2, beg1, end1, beg2, end2) \
   { \
      ...
      ::file::listing & system::root_ones(::file::listing & listing,::ace::application * papp)
      {
      ...
      ::file::listing & system::ls(::ace::application * papp, listing & listing)
      {
      ...
      bool system::has_subdir(::ace::application * papp,const ::file::path & psz)
      {
      ...
      bool system::is_or_definitively_not(bool & bIs, const ::file::path & lpcszPath, ::ace::application * papp)
      {
      ...
      bool system::is(const ::file::path & lpcszPath,::ace::application * papp)
      {
      ...
      bool system::name_is(const ::file::path & lpcszPath,::ace::application * papp)
      {
      ...
      system::is_dir_map::is_dir_map(::ace::application * papp) :
      ...
      ::file::path system::userfolder(::ace::application * papp)
      {
      ...
      bool system::mk(const ::file::path & psz,::ace::application * papp)
      {
      ...
      bool system::rm(::ace::application * papp,const ::file::path & psz,bool bRecursive)
      {
      ...
      ::file::path system::locale_schema(::ace::application * papp, const string & strLocale, const string & strSchema)
      {

         return papp->m_pacesession->get_locale_schema_dir(strLocale, strSchema);

      }



      ::file::patha system::locale_schema_matter(::ace::application * papp,const string & strLocale,const string & strSchema,const ::file::path & strRoot,const ::file::path & strDomain)
      {
         ...
         if(strRoot.has_char() && strDomain.has_char())
         {
            ...
            if(Session.m_bMatterFromHttpCache)
            {
               ...
               return   {strRoot / "appmatter" / strDomain / papp->m_pacesession->get_locale_schema_dir(strLocale,strSchema)};
            }
            else
            {
               return {element() / strRoot / "appmatter" / strDomain / papp->m_pacesession->get_locale_schema_dir(strLocale,strSchema) };
         ...
         else
         {
            ...
            for (index i = 0; i < papp->m_straMatterLocator.get_count(); i++)
            {
               ...
               stra.add_unique(papp->m_straMatterLocator[i] / papp->m_pacesession->get_locale_schema_dir(strLocale, strSchema));
      ...
      void system::matter_ls(::ace::application * papp,const ::file::path & str,::file::patha & patha)
      {
      ...
      void system::matter_ls_file(::ace::application * papp,const ::file::path & str,::file::patha & stra)
      {
      ...
      ::file::path system::matter(::ace::application * papp,const ::file::patha & stra,bool bDir,const ::file::path & pszRoot,const ::file::path & pszApp)
      {
      ...
      ::file::path system::matter(::ace::application * papp,const ::file::path & path,bool bDir,const ::file::path & pszRoot,const ::file::path & pszApp)
      {
         throw interface_only_exception(get_app());
      ...
      */
      ...
      ::file::path system::matter_from_locator(::ace::str_context * pcontext, const string & strLocator,  const ::file::path & str)
      {
      ...
      void system::appmatter_locators(::file::path & strRoot,::file::path & strDomain,::ace::application * papp)
      {
      ...
      ::file::path system::appmatter_locator(::ace::application * papp)
      {
      ...
      ::file::path system::usersystemappdata(::ace::application * papp, const string & lpcszPrefix)
      {
         UNREFERENCED_PARAMETER(papp);
      ...
      ::file::path system::userappdata(::ace::application * papp)
      {
      ...
      ::file::path system::userdata(::ace::application * papp)
      {
      ...
      ::file::path system::default_os_user_path_prefix(::ace::application * papp)
      {
      ...
      ::file::path system::default_userappdata(::ace::application * papp, const string & lpcszPrefix, const string & lpcszLogin)
      {
         UNREFERENCED_PARAMETER(papp);
         UNREFERENCED_PARAMETER(lpcszPrefix);
      ...
      ::file::path system::default_userdata(::ace::application * papp, const string & lpcszPrefix, const string & lpcszLogin)
      {
         UNREFERENCED_PARAMETER(papp);
         UNREFERENCED_PARAMETER(lpcszPrefix);
         UNREFERENCED_PARAMETER(lpcszLogin);
      ...
      ::file::path system::default_userfolder(::ace::application * papp, const string & lpcszPrefix, const string & lpcszLogin)
      {
         UNREFERENCED_PARAMETER(papp);
         UNREFERENCED_PARAMETER(lpcszPrefix);
         UNREFERENCED_PARAMETER(lpcszLogin);
      ...
      ::file::path system::userquicklaunch(::ace::application * papp)
      {
         UNREFERENCED_PARAMETER(papp);
         throw interface_only_exception(get_app(), "this is an interface");
      }

      ::file::path system::userprograms(::ace::application * papp)
      {
         UNREFERENCED_PARAMETER(papp);
         throw interface_only_exception(get_app(), "this is an interface");
      }
      ...
      bool system::is_inside_time(const ::file::path & pszPath,::ace::application * papp)
      {
         UNREFERENCED_PARAMETER(pszPath);
         throw interface_only_exception(get_app(), "this is an interface");
      }

      bool system::is_inside(const ::file::path & pszDir,const ::file::path & pszPath,::ace::application * papp)
      {
      ...
      ::file::path system::pathfind(const string & pszEnv, const string & pszTopic, const string & pszMode, ::ace::application * papp)
      {
