...
namespace file
{
   ...
   struct CLASS_DECL_ACE path_meta
   {
   ...
   public:
      ...
      //   bool rename(const char * pszNew,const char * psz,::ace::application * papp); TODO should go to something like file::system
