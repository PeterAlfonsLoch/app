...
namespace file
{
   ...
   class CLASS_DECL_ACE serializable
   {
   public:
...
CLASS_DECL_ACE bool file_put(const char * path, ::file::serializable & s, ::ace::application * papp = NULL);
CLASS_DECL_ACE bool file_as(::file::serializable & s, const char * path, ::ace::application * papp = NULL);


template < class ARRAY >
bool file_put_array(const char * path, const ARRAY & a, ::ace::application * papp = NULL);


template < class ARRAY >
bool file_as_array(ARRAY & a, const char * path, ::ace::application * papp = NULL);
