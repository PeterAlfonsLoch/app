...
namespace file
{
   ...
   class CLASS_DECL_ACE simple_binary_buffer :
   ...
   public:
      ...
      simple_binary_buffer(::ace::application * papp);
   ...
   void CLASS_DECL_ACE throw_exception(::ace::application * papp, ::file::exception::e_cause cause,LONG lOsError,const char * lpszFileName = NULL);
