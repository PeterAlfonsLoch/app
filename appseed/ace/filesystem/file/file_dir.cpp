...
::file::path dir::ca2_module()
{
...

   {
      ...
      str = ::dir::pathfind(getenv("DYLD_LIBRARY_PATH"), "libace.dylib", "rfs"); // readable - normal file - non zero sized
      ...
      str = ::dir::pathfind(getenv("DYLD_FALLBACK_LIBRARY_PATH"), "libace.dylib", "rfs"); // readable - normal file - non zero sized
...
//   return true;
   ...
   HMODULE hmodule = ::GetModuleHandleA("ace.dll");
...
string ca2_module_dup()
{
   ...
   GetModuleFileNameW(::GetModuleHandleA("ace.dll"), lpszModuleFilePath, MAX_PATH + 1);
...

   {
      ...
      str = ::dir::pathfind(::file::path(str).folder(), "libace.dylib", "rfs"); // readable - normal file - non zero sized
