...
namespace file
{
   ...
   class CLASS_DECL_ACE memory_buffer :
   ...
   public:
      ...
      memory_buffer(::ace::application * papp, memory_size_t iSize = 0);
      memory_buffer(::ace::application * papp, void * pMemory, memory_size_t dwSize);
      memory_buffer(::ace::application * papp, const memory_buffer & memoryfile);
      memory_buffer(::ace::application * papp, ::primitive::memory_base * pmemory);
