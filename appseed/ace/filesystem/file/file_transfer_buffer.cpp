...
namespace file
{
   ...
   transfer_buffer::transfer_buffer(::ace::application * papp, mutex * pmutex) :
      object(papp)
   {
   ...
   //
   transfer_buffer::transfer_buffer(::ace::application * papp, ::file::memory_buffer * pmemoryfileIn) :
      object(papp)
   {
