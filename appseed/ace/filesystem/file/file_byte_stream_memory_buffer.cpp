...
namespace file
{
   ...
   byte_stream_memory_buffer::byte_stream_memory_buffer(::ace::application * papp)
   {
   ...
   byte_stream_memory_buffer::byte_stream_memory_buffer(::ace::application * papp, const void * data, memory_size_t c)
   {
