...
CLASS_DECL_ACE string defer_solve_relative_compresions(const string & strParam)
{
...
//CLASS_DECL_ACE bool read_resource_as_file_dup(const char * pszFile,HINSTANCE hinst,UINT nID,LPCTSTR lpcszType);
