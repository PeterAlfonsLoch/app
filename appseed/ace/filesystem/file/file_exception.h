...
namespace file
{
   ...
   public:
      ...
      exception(::ace::application * papp,e_cause cause = exception::none,LONG lOsError = -1,const char * lpszArchiveName = NULL);
   ...
   class CLASS_DECL_ACE exception_sp :
      public sp(exception)
   {
   public:
      ...
      exception_sp(::ace::application * papp,exception::e_cause cause = exception::none,LONG lOsError = -1,const char * lpszArchiveName = NULL)
      {
...
inline ::exception::exception * fesp(::ace::application * papp,::file::exception::e_cause cause = ::file::exception::none,LONG lOsError = -1,const char * lpszArchiveName = NULL)
{
   return canew(::file::exception(papp,cause,lOsError,lpszArchiveName));
}
inline ::file::exception_sp fesp(::file::exception * p) { return p; }

CLASS_DECL_ACE void throw_file_exception(::ace::application * papp,::file::exception::e_cause cause,LONG lOsError,const char * lpszFileName = NULL);
