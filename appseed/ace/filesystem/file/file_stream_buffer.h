...
CLASS_DECL_ACE int get_sync_io_error();
CLASS_DECL_ACE void set_sync_io_error(int iError);
CLASS_DECL_ACE int get_generate_sync_io_error();
CLASS_DECL_ACE void set_generate_sync_io_error(int iError);


class CLASS_DECL_ACE sync_io_error
{
public:
...
namespace file
{
   ...
   class CLASS_DECL_ACE stream_buffer :
