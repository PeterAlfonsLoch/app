...
namespace file
{
   ...
   plain_text_stream_memory_buffer::plain_text_stream_memory_buffer(::ace::application * papp)
   {
   ...
   plain_text_stream_memory_buffer::plain_text_stream_memory_buffer(::ace::application * papp, const void * data, memory_size_t c)
   {
