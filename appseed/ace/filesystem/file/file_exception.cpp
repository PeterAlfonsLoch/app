...
namespace file
{
   ...
   exception::exception(::ace::application * papp, exception::e_cause cause , LONG lOsError, const char * lpszArchiveName) :
      object(papp),
      ::call_stack(papp),
      ::exception::base(papp),
...
void throw_file_exception(::ace::application * papp,::file::exception::e_cause cause,LONG lOsError,const char * lpszFileName /* == NULL */)
{
