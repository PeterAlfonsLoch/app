...
namespace file
{
   ...
   memory_buffer::memory_buffer(::ace::application * papp, memory_size_t iSize) :
      object(papp),
   ...
   memory_buffer::memory_buffer(::ace::application * papp, void * pMemory, memory_size_t dwSize) :
      object(papp),
   ...
   memory_buffer::memory_buffer(::ace::application * papp, const memory_buffer & memoryfile) :
      object(papp),
   ...
   memory_buffer::memory_buffer(::ace::application * papp, ::primitive::memory_base * pmemory) :
      object(papp),
