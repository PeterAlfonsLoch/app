...
/*      static BOOL WINAPI _SHGetPathFromIDList(LPCITEMIDLIST pidl, unichar * pszPath);
      static HANDLE WINAPI _FindFirstFile(const unichar * lpcsz, WIN32_FIND_DATAW * lpdata);
      ...
      HANDLE (WINAPI * m_pfnFindFirstFile)(const unichar * lpcsz, WIN32_FIND_DATAW * lpdata);
