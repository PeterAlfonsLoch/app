...
CLASS_DECL_ACE int32_t oswindow_find_message_only_window(::user::interaction * puibaseMessageWindow);
CLASS_DECL_ACE int32_t oswindow_find(Display * pdisplay, Window window);
CLASS_DECL_ACE int32_t oswindow_find(Window window);
CLASS_DECL_ACE oswindow_data * oswindow_get_message_only_window(::user::interaction * puibaseMessageWindow);
//CLASS_DECL_ACE oswindow_data * oswindow_get(Display * pdisplay, Window window, Visual * pvisual = NULL);
CLASS_DECL_ACE oswindow_data * oswindow_get(Window window);
CLASS_DECL_ACE oswindow oswindow_defer_get(Window w);
CLASS_DECL_ACE bool oswindow_remove(Display * pdisplay, Window window);
CLASS_DECL_ACE bool oswindow_remove_message_only_window(::user::interaction * puibaseMessageOnlyWindow);
...
CLASS_DECL_ACE int IsWindow(oswindow oswindow);
