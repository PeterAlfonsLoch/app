...
br_find_bin_dir (const char *default_bin_dir)
{
	...
	if (prefix == (char *) NULL) {
		...
		if (default_bin_dir != (const char *) NULL)
			return _strdup (default_bin_dir);
		else
			return (char *) NULL;
	}
...
br_find_sbin_dir (const char *default_sbin_dir)
{
	...
	if (prefix == (char *) NULL) {
		...
		if (default_sbin_dir != (const char *) NULL)
			return _strdup (default_sbin_dir);
		else
			return (char *) NULL;
	}
...
br_find_data_dir (const char *default_data_dir)
{
	...
	if (prefix == (char *) NULL) {
		...
		if (default_data_dir != (const char *) NULL)
			return _strdup (default_data_dir);
		else
			return (char *) NULL;
	}
...
br_find_locale_dir (const char *default_locale_dir)
{
	...
	if (data_dir == (char *) NULL) {
		...
		if (default_locale_dir != (const char *) NULL)
			return _strdup (default_locale_dir);
		else
			return (char *) NULL;
	}
...
br_find_lib_dir (const char *default_lib_dir)
{
	...
	if (prefix == (char *) NULL) {
		...
		if (default_lib_dir != (const char *) NULL)
			return _strdup (default_lib_dir);
		else
			return (char *) NULL;
	}
...
br_find_libexec_dir (const char *default_libexec_dir)
{
	...
	if (prefix == (char *) NULL) {
		...
		if (default_libexec_dir != (const char *) NULL)
			return _strdup (default_libexec_dir);
		else
			return (char *) NULL;
	}
...
br_find_etc_dir (const char *default_etc_dir)
{
	...
	if (prefix == (char *) NULL) {
		...
		if (default_etc_dir != (const char *) NULL)
			return _strdup (default_etc_dir);
		else
			return (char *) NULL;
	}
