...
namespace process
{
   ...
   public:
      ...
      public:
         ...
         process_thread(::ace::application * papp,const string & strCmdLine,const ::duration & dur,bool * pbPotentialTimeout = NULL,string * pstrRead = NULL,bool bElevated = false);
      ...
      public:
         ...
         process_processor(::ace::application * papp, const string & strCmdLine, const ::duration & dur, bool * pbPotentialTimeout = NULL, string * pstrRead = NULL, bool bElevated = false);
