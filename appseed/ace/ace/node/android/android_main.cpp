...
//int32_t CLASS_DECL_ACE __android_main(::ace::system * psystem, int32_t argc, char * argv[])
//{
//
//   if(!defer_au_init())
//      return -1;
...
//
//
//int32_t CLASS_DECL_ACE ca2_main(::ace::system * psystem, HINSTANCE hInstance, HINSTANCE hPrevInstance, const char * lpCmdLine, int32_t nCmdShow)
//{
//   try
//   {
//
