...
//int32_t CLASS_DECL_AURA __android_main(::ace::system * psystem, int32_t argc, char * argv[])
//{
//
//   if(!defer_au_init())
//      return -1;
...
//
//
//int32_t CLASS_DECL_AURA ca2_main(::ace::system * psystem, HINSTANCE hInstance, HINSTANCE hPrevInstance, const char * lpCmdLine, int32_t nCmdShow)
//{
//   try
//   {
//
