...
namespace android
{
   ...
   //bool dir::rls(::ace::application * papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle, stringa * pstraRelative, e_extract eextract)
   //{
   ...
   //bool dir::rls_pattern(::ace::application * papp, const char * lpcsz, const char * pszPattern, stringa * pstraPath, stringa * pstraTitle, stringa * pstraRelative, bool_array * pbaIsDir, int64_array * piaSize, e_extract eextract)
   //{
   ...
   //bool dir::rls_dir(::ace::application * papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle, stringa * pstraRelative)
   //{
   ...
   //bool dir::ls_dir(::ace::application * papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle)
   //{
   ...
   //bool dir::ls_file(::ace::application * papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle)
   //{
   ...
   //bool dir::ls(::ace::application * papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle, bool_array * pbaIsDir, int64_array * piaSize)
   //{
   ...
   ::file::path dir::usersystemappdata(::ace::application * papp, const string & lpcszPrefix)
   {
