...
/*void CLASS_DECL_ACE ::ca2::InitLocalData(HINSTANCE hInst)
{
   if (__thread_data != NULL)
      __thread_data->AssignInstance(hInst);
}

void CLASS_DECL_ACE __term_local_data(HINSTANCE hInst, bool bAll)
{
   if (__thread_data != NULL)
...
void CLASS_DECL_ACE __tls_add_ref()
{
   ++gen_TlsRef;
}

void CLASS_DECL_ACE __tls_release()
{
