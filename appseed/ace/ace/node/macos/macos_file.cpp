...
namespace macos
{
   ...
   file::file(::ace::application * papp, int32_t hFile) :
   ::object(papp)
   {
...
CLASS_DECL_ACE bool vfxResolveShortcut(string & strTarget, const char * pszSource, ::user::primitive * puiMessageParentOptional)
{
...
void CLASS_DECL_ACE vfxThrowFileException(::ace::application * papp, ::file::exception::e_cause cause, LONG lOsError, const char * lpszFileName /* == NULL */)
{
#ifdef DEBUG
   const char * lpsz;
...
::file::exception * CLASS_DECL_ACE get_FileException(::ace::application * papp, ::file::exception::e_cause cause, LONG lOsError, const char * lpszFileName /* == NULL */)
{
#ifdef DEBUG
   const char * lpsz;
   if (cause >= 0 && cause < _countof(::macos::rgszFileExceptionCause))
