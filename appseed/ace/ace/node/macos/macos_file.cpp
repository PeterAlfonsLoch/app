...
void CLASS_DECL_AURA vfxThrowFileException(::ace::application * papp, ::file::exception::e_cause cause, LONG lOsError, const char * lpszFileName /* == NULL */)
{
#ifdef DEBUG
   const char * lpsz;
...
::file::exception * CLASS_DECL_AURA get_FileException(::ace::application * papp, ::file::exception::e_cause cause, LONG lOsError, const char * lpszFileName /* == NULL */)
{
#ifdef DEBUG
   const char * lpsz;
   if (cause >= 0 && cause < _countof(::macos::rgszFileExceptionCause))
