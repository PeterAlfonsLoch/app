//#include "framework.h"
//#include "windows.h"
//#include "ace/graphics/draw2d/draw2d.h"
...
namespace windows
{
   ...
   bool getCredentialsForService(::ace::application * papp, const string & strService,WCHAR * szUsername,WCHAR *szPassword)
   {
...
//      SID_NAME_USE    SidUse;
   ...
   string os::calc_service_name(::ace::application * papp)
   {
   ...
   bool os::create_service(::ace::application * papp)
   {
   ...
   bool os::remove_service(::ace::application * papp)
   {
   ...
   bool os::start_service(::ace::application * papp)
   {
   ...
   bool os::stop_service(::ace::application * papp)
   {
