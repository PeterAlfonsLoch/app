...
namespace windows
{
   ...
   file::file(::ace::application * papp, HANDLE hFile) :
      object(papp)
   {
...
#define EDEADLOCK       EDEADLK
   ...
   cres file_exception::last_os_error(::ace::application * papp,const char * lpszFileName /* = NULL */)
   {
      return os_error(papp,::GetLastError(),lpszFileName);
   }

   cres file_exception::os_error(::ace::application * papp,LONG lOsError,const char * lpszFileName /* = NULL */)
   {
      return fesp(papp,file_exception::OsErrorToException(lOsError),lOsError,lpszFileName);
   }


   void file_exception::ThrowOsError(::ace::application * papp, LONG lOsError, const char * lpszFileName /* = NULL */)
   {
      if (lOsError != 0)
         throw_file_exception(papp, file_exception::OsErrorToException(lOsError), lOsError, lpszFileName);
   }

   void file_exception::ThrowErrno(::ace::application * papp, int32_t nErrno, const char * lpszFileName /* = NULL */)
   {
      if (nErrno != 0)
...
/*bool CLASS_DECL_ACE ::core::ComparePath(const char * lpszPath1, const char * lpszPath2)
{
// use case insensitive compare as a starter
