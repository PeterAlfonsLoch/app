...
//            if(dynamic_cast < ::ace::application * > (pca) == m_papp)
//            {
//               m_papp = NULL;
//            }
//         }
...
////      bool bIdle = TRUE;
////      LONG lIdleCount = 0;
////      ::ace::application * pappThis1 = dynamic_cast < ::ace::application * > (this);
////      ::ace::application * pappThis2 = dynamic_cast < ::ace::application * > (m_p.m_p);
////
...
////         ::ca2::LockTempMaps(dynamic_cast < ::ace::application * > (m_p->m_papp));
////         ::ca2::UnlockTempMaps(dynamic_cast < ::ace::application * > (m_p->m_papp));
////         }*/
////      }
////
////#if defined(DEBUG) && !defined(___NO_DEBUG_CRT)
...
////
////
////   void thread::ProcessWndProcException(::exception::ace* e, signal_details * pobj)
////   {
...
////
////#ifndef ___PORTABLE
////         ::ace::application * papp = dynamic_cast < ::ace::application * > (get_app());
...
////
////      //      ::application* papp = dynamic_cast < ::ace::application * > (get_app());
...
////         //         threadWnd.Detach();
////         __end_thread(dynamic_cast < ::ace::application * > (m_paxisapp.m_p), nResult);
////      }
////      catch(...)
////      {
////      }
...
//////}
//////
//////LRESULT thread::ProcessWndProcException(::exception::ace* e, const MSG* pMsg)
//////{
//////return __internal_process_wnd_proc_exception( e, pMsg );
//////}
//////*/
