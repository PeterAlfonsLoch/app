...
namespace metrowin
{
   ...
   native_buffer::native_buffer(::ace::application * papp):
      ::object(papp)
   {
   ...
   native_buffer::native_buffer(::ace::application * papp,StorageFile ^ file):
      ::object(papp)
   {
   ...
   native_buffer::native_buffer(::ace::application * papp,const char * lpszfileName,UINT nOpenFlags):
      ::object(papp)
   {
