...
*/
   ...
   bool os::create_service(sp(::ace::application) papp)
   {
   ...
   bool os::remove_service(sp(::ace::application) papp)
   {
   ...
   bool os::start_service(sp(::ace::application) papp)
   {
   ...
   bool os::stop_service(sp(::ace::application) papp)
   {
