...
CLASS_DECL_AURA void __end_thread(::ace::application * papp, UINT nExitCode, bool bDelete = TRUE);

CLASS_DECL_AURA void __init_thread();
CLASS_DECL_AURA void __term_thread(::ace::application * papp, HINSTANCE hInstTerm = NULL);
