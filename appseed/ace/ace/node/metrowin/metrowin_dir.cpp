...
//#endif
   ...
   ::file::path dir::usersystemappdata(::ace::application *  papp, const string & strPrefix)
   {
   ...
   ::file::path dir::default_userfolder(::ace::application *  papp,const string & strPrefix,const string & strLogin)
   {
   ...
   bool dir::is_inside(const ::file::path & pszDir,const ::file::path & strPath,::ace::application *  papp)
   {
