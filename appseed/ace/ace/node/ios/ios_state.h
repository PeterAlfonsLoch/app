...
class CLASS_DECL_ACE __MODULE_THREAD_STATE
{
public:
...
class CLASS_DECL_ACE __MODULE_STATE
{
public:
   ...
   ::ace::application * m_pCurrentWinApp;
...
CLASS_DECL_ACE __MODULE_STATE* __set_module_state(__MODULE_STATE* pNewState);
CLASS_DECL_ACE __MODULE_STATE* __get_module_state();
CLASS_DECL_ACE bool __is_module_dll();
CLASS_DECL_ACE bool __init_current_state_app();
CLASS_DECL_ACE __MODULE_STATE* __get_static_module_state();
CLASS_DECL_ACE HINSTANCE __get_instance_handle_helper();

CLASS_DECL_ACE __MODULE_THREAD_STATE* __get_module_thread_state();
...
struct CLASS_DECL_ACE __MAINTAIN_STATE
{
...
struct CLASS_DECL_ACE __MAINTAIN_STATE2
{
...
class CLASS_DECL_ACE ___THREAD_STATE :
public ::thread_state
{
public:
   ___THREAD_STATE();
...
CLASS_DECL_ACE ___THREAD_STATE * __get_thread_state();


namespace ios
{
   
   CLASS_DECL_ACE ::thread_state * __get_thread_state();
