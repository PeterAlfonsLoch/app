...
//
//
//   dir::dir(sp(::ace::application)  papp) :
//      ::object(papp),
//      ::file::dir::system(papp),
//   m_path(papp)
//   {
...
//   }
//
//   path::path(sp(::ace::application)  papp) :
//   ::object(papp)
//   {
//   }
//
...
//   }
//
//   void dir::root_ones(stringa & stra, sp(::ace::application)  papp)
//   {
//      stra.add("/");
...
//   }
//
//   void dir::ls_pattern(sp(::ace::application)  papp, const char * lpcsz, const char * pszPattern, stringa * pstraPath, stringa * pstraTitle, bool_array * pbaIsDir, int64_array * piaSize)
//   {
//
//      if(::file::dir::system::is(lpcsz, papp)) // if ace class "already" "says" it is a dir, let it handle it: may be not a operational system dir, e.g., zip or compressed directory...
//      {
//
//         return ::file::dir::system::ls_pattern(papp, lpcsz, pszPattern, pstraPath, pstraTitle, pbaIsDir, piaSize);
//
...
//   }
//
//   void dir::rls(sp(::ace::application)  papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle, stringa * pstraRelative, e_extract eextract)
//   {
//      rls_pattern(papp, lpcsz, "*.*", pstraPath, pstraTitle, pstraRelative, NULL, NULL, eextract);
//   }
//
//   void dir::rls_pattern(sp(::ace::application)  papp, const char * lpcsz, const char * pszPattern, stringa * pstraPath, stringa * pstraTitle, stringa * pstraRelative, bool_array * pbaIsDir, int64_array * piaSize, e_extract eextract)
//   {
//
//      stringa straDir;
//
...
//   }
//
//   void dir::rls_dir(sp(::ace::application)  papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle, stringa * pstraRelative)
//   {
//
//      stringa stra;
//
...
//
//
//   void dir::ls_dir(sp(::ace::application)  papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle)
//   {
//
//      stringa stra;
//
...
//   }
//
//   void dir::ls_file(sp(::ace::application)  papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle)
//   {
//
//      stringa stra;
//
...
//   }
//
//   void dir::ls(sp(::ace::application)  papp, const char * lpcsz, stringa * pstraPath, stringa * pstraTitle, bool_array * pbaIsDir, int64_array * piaSize)
//   {
//
//      stringa stra;
//
...
//   }
//
//   bool dir::is(const char * lpcszPath, sp(::ace::application)  papp)
//   {
//
//      bool bIsDir;
//
...
//   }
//
//   bool dir::is(const string & strPath, sp(::ace::application)  papp)
//   {
//
//      if(::file::dir::system::is(strPath, papp))
//         return true;
...
//   }
//
//   bool dir::name_is(const string & str, sp(::ace::application)  papp)
//   {
//      //OutputDebugString(str);
//      strsize iLast = str.get_length() - 1;
//      while(iLast >= 0)
...
//   }
//
//   bool dir::mk(const char * lpcsz, sp(::ace::application)  papp)
//   {
//
//      if(is(lpcsz, papp))
//         return true;
...
//   }
//
//   bool dir::rm(sp(::ace::application)  papp, const char * psz, bool bRecursive)
//   {
//      if(bRecursive)
//      {
//         stringa straPath;
...
//   }
//
//   string dir::usersystemappdata(sp(::ace::application)  papp, const char * lpcszPrefix, const char * lpcsz, const char * lpcsz2)
//   {
//      UNREFERENCED_PARAMETER(papp);
//      return path(appdata(lpcszPrefix), lpcsz, lpcsz2);
//   }
//
//   string dir::userappdata(sp(::ace::application)  papp, const char * lpcsz, const char * lpcsz2)
//   {
//      return path(userfolder(papp, "appdata"), lpcsz, lpcsz2);
//   }
//
//   string dir::userdata(sp(::ace::application)  papp, const char * lpcsz, const char * lpcsz2)
//   {
//      return path(userfolder(papp, "data"), lpcsz, lpcsz2);
//   }
//
//   string dir::userfolder(sp(::ace::application)  papp, const char * lpcsz, const char * lpcsz2)
//   {
//
//      string str;
//      /*SHGetSpecialFolderPath(
...
//   }
//
//   string dir::default_os_user_path_prefix(sp(::ace::application)  papp)
//   {
//      /*UNREFERENCED_PARAMETER(papp);
//       unichar buf[MAX_PATH];
//       ULONG ulSize = sizeof(buf) / sizeof(unichar);
...
//   }
//
//   string dir::default_userappdata(sp(::ace::application)  papp, const char * lpcszPrefix, const char * lpcszLogin, const char * pszRelativePath)
//   {
//      return path(default_userfolder(papp, lpcszPrefix, lpcszLogin, "appdata"), pszRelativePath);
//   }
//
//   string dir::default_userdata(sp(::ace::application)  papp, const char * lpcszPrefix, const char * lpcszLogin, const char * pszRelativePath)
//   {
//      return path(default_userfolder(papp, lpcszPrefix, lpcszLogin, "data"), pszRelativePath);
//   }
//
//   string dir::default_userfolder(sp(::ace::application)  papp, const char * lpcszPrefix, const char * lpcszLogin, const char * pszRelativePath)
//   {
//
//      return userfolder(papp, pszRelativePath);
//
...
//   }
//
//   string dir::userquicklaunch(sp(::ace::application)  papp, const char * lpcszRelativePath, const char * lpcsz2)
//   {
//      UNREFERENCED_PARAMETER(papp);
//      string str;
//      /*SHGetSpecialFolderPath(
...
//   }
//
//   string dir::userprograms(sp(::ace::application)  papp, const char * lpcszRelativePath, const char * lpcsz2)
//   {
//      UNREFERENCED_PARAMETER(papp);
//      string str;
//      /*      SHGetSpecialFolderPath(
...
//   }
//
//   bool dir::is_inside_time(const char * pszPath, sp(::ace::application)  papp)
//   {
//      return is_inside(time(), pszPath, papp);
//   }
//
//   bool dir::is_inside(const char * pszDir, const char * pszPath, sp(::ace::application)  papp)
//   {
//      return ::str::begins_ci(pszDir, pszPath);
//   }
//
//   bool dir::has_subdir(sp(::ace::application)  papp, const char * pszDir)
//   {
//      stringa stra;
