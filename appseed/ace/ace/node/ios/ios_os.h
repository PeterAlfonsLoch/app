...
namespace ios
{
   ...
   public:
      ...
      virtual bool create_service(sp(::ace::application) papp);
      virtual bool remove_service(sp(::ace::application) papp);
      
      virtual bool start_service(sp(::ace::application) papp);
      virtual bool stop_service(sp(::ace::application) papp);
