...
namespace ios
{
   ...
   file_system::file_system(::ace::application *  papp) :
   ::object(papp),
   ::file::system(papp)
   {
   ...
   var file_system::length(const string & pszPath, ::ace::application * papp)
   {
   ...
   //   string file_system::time_square(::ace::application *  papp, const char * pszPrefix, const char * pszSuffix)
   //   {
   //      string str;
   ...
   //   string file_system::time_log(::ace::application *  papp, const char * pszId)
   //   {
   //      return time(papp, System.dir().time_log(pszId), 9);
   //   }
   //
   //   string file_system::time(::ace::application *  papp, const char * psz, int32_t iMaxLevel, const char * pszPrefix, const char * pszSuffix)
   //   {
   ...
   //   string file_system::as_string(var varFile, ::ace::application *  papp)
   //   {
   //      var varQuery;
   //      return as_string(varFile, varQuery, papp);
   //   }
   //
   //   string file_system::as_string(var varFile, var & varQuery, ::ace::application *  papp)
   //   {
   //      memory storage;
   ...
   //   }
   //
   //   void file_system::as_memory(var varFile, primitive::memory_base & mem, ::ace::application *  papp)
   //   {
   //
   //      mem.allocate(0);
   //
   ...
   //   }
   //
   //   void file_system::lines(stringa & stra, var varFile, ::ace::application *  papp)
   //   {
   //
   ...
   //   bool file_system::put_contents(var varFile, const void * pvoidContents, count count, ::ace::application *  papp)
   //   {
   //
   //      ::file::buffer_sp spfile;
   //
   ...
   //   }
   //
   //   bool file_system::put_contents(var varFile, const char * lpcszContents, ::ace::application *  papp)
   //   {
   ...
   //   }
   //
   //   bool file_system::put_contents(var varFile, ::file::reader & reader, ::ace::application *  papp)
   //   {
   //      ::file::buffer_sp spfile;
   //      spfile = App(papp).file().get_file(varFile, ::file::type_binary | ::file::mode_write | ::file::mode_create | ::file::share_deny_none | ::file::defer_create_directory);
   //      if(spfile.is_null())
   ...
   //   }
   //
   //   bool file_system::put_contents(var varFile, memory & mem, ::ace::application *  papp)
   //   {
   //      return put_contents(varFile, mem.get_data(), (count) mem.get_size(), papp);
   //   }
   //
   //   bool file_system::put_contents_utf8(var varFile, const char * lpcszContents, ::ace::application *  papp)
   //   {
   //      ::file::buffer_sp spfile;
   //      spfile = App(papp).file().get_file(varFile, ::file::type_binary | ::file::mode_write | ::file::mode_create | ::file::share_deny_none | ::file::defer_create_directory);
   //      if(spfile.is_null())
   ...
   //   void file_system::copy(const char * pszNew, const char * psz, bool bFailIfExists, e_extract eextract, ::ace::application *  papp)
   //   {
   //      if(bFailIfExists)
   //      {
   ...
   //
   //
   //   string file_system::copy(const char * psz, ::ace::application *  papp)
   //   {
   //      string strCopy("copy");
   //      string strNew;
   ...
   //
   //
   //   bool file_system::exists(const char * pszPath, ::ace::application *  papp)
   //   {
   //
   ...
   //   bool file_system::exists(const string & strPath, ::ace::application *  papp)
   //   {
   //
   ...
   //   }
   //
   //   string file_system::paste(const char * pszLocation, const char * path, ::ace::application *  papp)
   //   {
   ...
   //   void file_system::trash_that_is_not_trash(stringa & stra, ::ace::application *  papp)
   //   {
   //
   //      if(stra.get_size() <= 0)
   //         return;
   ...
   //   }
   //
   //   void file_system::trash_that_is_not_trash(const char * psz, ::ace::application *  papp)
   //   {
   //
   ...
   //   }
   //
   //   void file_system::replace(const char * pszContext, const char * pszFind, const char * pszReplace, ::ace::application *  papp)
   //   {
   //      stringa straTitle;
   ...
   //   }
   //
   //   string file_system::sys_temp(const char * pszName, const char * pszExtension, ::ace::application *  papp)
   //   {
   //
   ...
   //   }
   //
   //   ::file::buffer_sp file_system::time_square_file(::ace::application *  papp, const char * pszPrefix, const char * pszSuffix)
   //   {
   //
   ...
   //   }
   //
   //   ::file::buffer_sp file_system::get(const char * name, ::ace::application *  papp)
   //   {
   //
   ...
   ::file::buffer_sp file_system::get_file(var varFile,UINT nOpenFlags,cres * pfesp,::ace::application * papp)
   {
