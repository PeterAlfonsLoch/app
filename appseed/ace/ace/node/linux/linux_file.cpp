...
namespace linux
{
   ...
   file::file(::ace::application * papp, int iFile) :
      ::object(papp)
   {
   ...
   file::file(::ace::application * papp, const ::file::path & lpszFileName, UINT nOpenFlags) :
      ::object(papp)
   {
...
/*      if (!::UnlockFile((HANDLE)m_iFile,  LODWORD(dwPos), HIDWORD(dwPos), LODWORD(dwCount), HIDWORD(dwCount)))
   ...
   */
   ...
   void PASCAL file_exception::ThrowOsError(sp(::ace::application) papp, LONG lOsError, const char * lpszFileName /* = NULL */)
   {
      if (lOsError != 0)
         vfxThrowFileException(papp, file_exception::OsErrorToException(lOsError), lOsError, lpszFileName);
   }

   void PASCAL file_exception::ThrowErrno(sp(::ace::application) papp, int32_t nErrno, const char * lpszFileName /* = NULL */)
   {
      if (nErrno != 0)
