...
namespace linux
{
   ...
   public:
      ...
      file(::ace::application * papp, const ::file::path & lpszFileName, UINT nOpenFlags);
      virtual ~file();
   ...
   namespace file_exception
   {
      ...
      void PASCAL ThrowOsError(sp(::ace::application) papp, LONG lOsError, const char * lpszFileName = NULL);
      void PASCAL ThrowErrno(sp(::ace::application) papp, int32_t nErrno, const char * lpszFileName = NULL);
