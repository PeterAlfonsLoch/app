...
invalid_handle_exception::invalid_handle_exception(::ace::application * papp) :
   object(papp),
   ::call_stack(papp),
   ::exception::base(papp),
...
invalid_handle_exception::invalid_handle_exception(::ace::application * papp, const char * pszMessage) :
   object(papp),
   ::call_stack(papp),
   ::exception::base(papp),
   ::simple_exception(papp),
