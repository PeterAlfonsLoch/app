...
#define DECLARE_SE_EXCEPTION_CLASS(name) class CLASS_DECL_AURA name : virtual public standard_exception \
   ...
   protected: \
   name (::ace::application * papp, EXCEPTION_POINTERS * ppointers) : \
      object(papp), \
      ::call_stack(papp), \
      ::exception::base(papp), \
...
public:
...
#ifdef WINDOWS
   standard_exception(::ace::application * papp, EXCEPTION_POINTERS * ppointers) :
      object(papp),
      ::call_stack(papp),
      ::exception::base(papp),
   ...
   standard_exception(::ace::application * papp, int32_t iSignal, void * psiginfo, void * pc) :
      object(papp),
      ::call_stack(papp),
      ::exception::base(papp),
      m_iSignal(iSignal),
...
namespace exception
{
   ...
   public:
      ...
      standard_access_violation (::ace::application * papp, int32_t signal, void * psiginfo, void * pc) :
         object(papp),
         ::call_stack(papp),
         ::exception::base(papp),
...
/*       sig_ucontext_t * uc = (sig_ucontext_t *)ucontext;
      ...
      standard_access_violation (::ace::application * papp, EXCEPTION_POINTERS * ppointers) :
         object(papp),
         ::call_stack(papp),
         ::exception::base(papp),
         ::standard_exception(papp, ppointers)
   ...
   public:
      ...
      standard_sigfpe(::ace::application * papp,int32_t iSignal,void * psiginfo,void * pc):
         object(papp),
      ::call_stack(papp),
         ::exception::base(papp),
   ...
   {
   public:
      standard_sigfpe (::ace::application * papp, int32_t iSignal, siginfo_t * psiginfo, void * pc) :
         object(papp),
#ifdef LINUX
#ifdef _LP64
      ::call_stack(papp, 3, (void *) ((sig_ucontext_t *) pc)->uc_mcontext.rip),
   ...
   public:
      ...
      standard_no_memory (::ace::application * papp, EXCEPTION_POINTERS * ppointers) :
         object(papp),
         ::call_stack(papp),
         ::exception::base(papp),
         ::standard_exception(papp, ppointers)
...
/*class standard_sigsegv : public standard_exception
{
   friend class translator;
protected:
   standard_sigsegv (::ace::application * papp, siginfo_t * psiginfo, void * pc) : object(papp), standard_exception(papp, psiginfo, pc) {}
public:
   //bool is_read_op() const { return !info()->ExceptionRecord->ExceptionInformation [0]; }
   //uint_ptr inaccessible_address() const { return info()->ExceptionRecord->ExceptionInformation [1]; }
};*/
...
/*class standard_sigfpe : public standard_exception
{
   friend class translator;
protected:
   standard_sigfpe (::ace::application * papp, siginfo_t * psiginfo, void * pc) : object(papp), standard_exception(papp, psiginfo, pc) {}
public:
//   bool is_read_op() const { return !info()->ExceptionRecord->ExceptionInformation [0]; }
  // uint_ptr inaccessible_address() const { return info()->ExceptionRecord->ExceptionInformation [1]; }
};
