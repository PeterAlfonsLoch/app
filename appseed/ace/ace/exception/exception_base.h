...
namespace exception
{
   ...
   public:
      ...
      base(::ace::application * papp,uint32_t uiSkip = CALL_STACK_DEFAULT_SKIP_TRIGGER);   // sets m_bAutoDelete = TRUE
      explicit base(::ace::application * papp,bool bAutoDelete,uint32_t uiSkip = CALL_STACK_DEFAULT_SKIP_TRIGGER /* -1 for disable call stack*/);   // sets m_bAutoDelete = bAutoDelete
