...
not_installed::not_installed(::ace::application * papp, const char * pszVersion, const char * pszBuild, const char * pszType, const char * pszId, const char * pszLocale, const char * pszSchema) :
   object(papp),
   ::call_stack(papp),
   ::exception::base(papp)
{
