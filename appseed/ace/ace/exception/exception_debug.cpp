...
assert_exception::assert_exception(::ace::application * papp, const char * pszFile, long lLine) :
   object(papp),
   ::call_stack(papp),
   ::exception::base(papp),
...
misc_exception::misc_exception(::ace::application * papp, const char * pszMessage) :
   object(papp),
   ::call_stack(papp),
   ::exception::base(papp),
   simple_exception(papp)
