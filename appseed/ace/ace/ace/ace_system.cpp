...
//#include "ace/user/colorertake5/colorertake5.h"
...
namespace ace
{
   ...
   system::system(::ace::application * papp, void * pdata) :
      m_process(this)
   {
...
//      m_spmutexFactory = canew(mutex(get_app()));
   ...
   system::~system()
   {
      ...
      try
      {
         ...
         ::ace::del(m_pmachineeventcentral);
...
//   {
//
////      ::output_debug_string("::ace::system::install_uninstall_verb " + demangle(typeid(*this).name()) + "\n");
//
...
//   }
   ...
   void system::construct(const char * pszAppId)
   {
      ...
      ::ace::application::construct(pszAppId);
   ...
   bool system::process_initialize()
   {
      ...
      //#ifdef WINDOWSEX
      //
      //      dappy(string(typeid(*this).name()) + " : Going to ::ace::system::m_spwindow->create_window_ex : " + ::str::from(m_iReturnCode));
      //
      //      if(!m_spwindow->create_window_ex(0,NULL,NULL,0,null_rect(),NULL,"::ace::system::interaction_impl::no_twf"))
      //      {
      //
      //         dappy(string(typeid(*this).name()) + " : ::ace::system::m_spwindow->create_window_ex failure : " + ::str::from(m_iReturnCode));
      //
      //         return false;
      //
      //      }
   ...
   bool system::initialize_instance()
   {
      ...
      dappy(string(typeid(*this).name()) + " : ::ace::session OK " + ::str::from(m_iReturnCode));
...
//      m_basesessionptra.remove_all();
      ...
      try
      {
         ...
         iRet = ::ace::application::exit_instance();
...
//      m_pmutexDc.release();
   ...
   int32_t system::_debug_logging_report(int32_t iReportType, const char * pszFileName, int32_t iLineNumber, const char * pszModuleName, const char * pszFormat,va_list list)
   {
      ...
      if(m_plog == NULL || !m_plog->m_bExtendedLog)
      {
         ...
         return ::ace::SimpleDebugReport(iReportType,pszFileName,iLineNumber,pszModuleName,pszFormat,list);
...
//         if(list != NULL)
   ...
   object * system::on_alloc(::ace::application * papp, ::type * ptype)
   {
   ...
   object * system::alloc(::ace::application * papp, ::type * ptype)
   {
   ...
   object * system::alloc(::ace::application * papp,const std_type_info & info)
   {
   ...
   void system::on_allocation_error(::ace::application * papp, ::type * ptype)
   {
   ...
   object * system::alloc(::ace::application * papp,const class id & idType)
   {
   ...
   ::ace::session * system::query_session(index iEdge)
   {
   ...
   //spa(::ace::session) & system::basesessionptra()
   //{
...
//      for(int32_t i = 0; i < appptra().get_size(); i++)
      //    {
      //     ::ace::application * papp = appptra()(i);
   ...
   bool system::assert_running_global(const char * pszAppName,const char * pszId)
   {
      if(string(pszId).has_char())
      {
         ...
         if(pmutex == NULL)
         {
            ...
            ::ace::shell_launcher launcher(NULL,NULL,dir().module()/strApp,strParameters,NULL,SW_SHOW);
      ...
      else
      {
         ...
         if(pmutex == NULL)
         {
            ...
            ::ace::shell_launcher launcher(NULL,NULL,dir().module()/strApp,NULL,NULL,SW_SHOW);
   ...
   bool system::assert_running_local(const char * pszAppName,const char * pszId)
   {
      ...
      if(strId.has_char())
      {
         ...
         if(pmutex == NULL)
         {
            ...
            ::ace::shell_launcher launcher(NULL,NULL,dir().ca2module() / strApp,strParameters,NULL,SW_SHOW);
...
//   }
   ...
   ::file::path system::dir_appmatter_locator(::ace::application * papp)
   {
   ...
   uint32_t _thread_proc_start_system(void * p)
   {
      ...
      ::ace::system * psystem = (::ace::system *)p;
   ...
   ::ace::session * system::on_create_session()
   {

      return new ::ace::session(this);
   ...
   void system::on_map_application_library(::ace::library & library)
   {
   ...
   void system::on_request(sp(::create) pcreate)
   {
      ...
      ::ace::session * psession = get_session(pcreate->m_spCommandLine->m_iEdge,pcreate->m_spCommandLine->m_pbiasCreate);

      if(psession == NULL)
      {

         ::output_debug_string("::ace::system::on_request session NULL An error that prevents the application from starting has occurred.\
\n\r\nPlease run app-removal.exe and restart the application, or contact the administrator. Startup Error !!");
      ...
      ::output_debug_string("::ace::system::on_request session = " + demangle(typeid(*psession).name()) + "("+::str::from((int_ptr) psession)+")\n\n");
   ...
   bool system::find_applications_to_cache(bool bSave)
   {
      ...
      ::output_debug_string("\n\n::ace::system::find_applications_to_cache\n\n");
   ...
   bool system::map_application_library(const char * pszLibrary)
   {
      ...
      ::ace::library library(this,0,NULL);
   ...
   bool system::set_main_init_data(::ace::main_init_data * pdata)
   {

      if(pdata != NULL)
      {
         if(!::ace::application::set_main_init_data(pdata))
            return false;
      }
   ...
   void system::on_command(::primitive::command * pcommand)
   {
      ...
      else
      {
         ...
         ::ace::application::on_command(pcommand);
