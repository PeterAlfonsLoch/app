...
//extern "C" CLASS_DECL_ACE HRESULT __stdcall gen_CreateRegistrar(IRegistrar** ppReg);
...
#define ASSERT_KINDOF(class_name, object) ASSERT(ace < class_name > ::bases(object))
