...
namespace ace
{
   ...
   public:
      ...
      ::ace::os_sp                                m_spos;
      //array < ::ace::session * >                  m_basesessionptra;
...
//      ::html::html *                               m_phtml; // only defined  in core;
      ...
      system(::ace::application * papp, void * pdata);
      virtual ~system();
      ...
      //spa(::ace::session)                         &  basesessionptra();
      ...
      virtual void on_allocation_error(::ace::application * papp, ::type * ptype);
      //   sp(object) alloc(::ace::application * papp, sp(type) info);
      object * alloc(::ace::application * papp,const std_type_info & info);
      //   virtual sp(object) on_alloc(::ace::application * papp, sp(type) info);



      using ::ace::application::alloc;
      virtual object * alloc(::ace::application * papp,::type * ptype);
      virtual object * alloc(::ace::application * papp,const class id & idType);

      virtual object * on_alloc(::ace::application * papp,::type * ptype);
...
//      virtual mutex * wait_twf();
      ...
      virtual ::ace::session * query_session(index iEdge);
      ...
      virtual ::file::path dir_appmatter_locator(::ace::application * papp);
      ...
      virtual ::ace::session * on_create_session();


      virtual ::ace::session *             get_session(index iEdge,application_bias * pbiasCreation = NULL);
      ...
      virtual void on_map_application_library(::ace::library & library);
