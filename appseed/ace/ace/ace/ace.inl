...
//
//   template < class T >
//   bool system::output(::ace::application * papp,const char * pszOutput,T * p,bool (T::*lpfnOuput)(::file::ostream &,const char *),const char * lpszSource)
//   {
//
...
//
//   template < class T >
//   bool system::output(::ace::application * papp,const char * pszOutput,T * p,bool (T::*lpfnOuput)(::file::ostream &,::file::istream &),const char * lpszInput)
//   {
//
//      System.dir().mk(System.dir().name(pszOutput),papp);
//
...
//
//   template < class T >
//   bool system::output(::ace::application * papp,const char * pszOutput,T * p,bool (T::*lpfnOuput)(::file::ostream &,::file::istream &),::file::istream & istream)
//   {
//
...
namespace ace
{
   ...
   // impl
   template < class APP >
   sp(::ace::application) single_application_library < APP > ::get_new_app(const char * pszAppId)
   {

      if(!contains_app(pszAppId))
         return NULL;

      ::ace::application * papp = new APP();
