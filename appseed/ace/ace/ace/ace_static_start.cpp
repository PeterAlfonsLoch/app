...
extern ::map < void *, void *,::ace::application *, ::ace::application * > * g_pmapAura;

extern string_map < sp(::ace::library) > * g_pmapLibCall;
...
//#include "ace/os/macos/macos_window_impl.h"

extern oswindow_dataptra * g_poswindowdataptra;

#elif defined(APPLE_IOS)

//#include "ace/os/ios/ios_window_impl.h"
...
namespace ace
{
   ...
   namespace static_start
   {
      ...
      CLASS_DECL_ACE void init()
      {
         ...
         xxdebug_box("ace.dll base_static_start (0)", "box", MB_OK);
         ...
         */
         ...
         g_pmapAura =new ::map < void *,void *,::ace::application *,::ace::application * >;
...
//#endif // defined(APPLEOS)
         ...
         //g_pmutexTrace = NULL;
         ::ace::del(s_pmutexMessageDispatch);

         ::ace::del(g_pmutexUiDestroyed);

         ::ace::del(g_pmapAura);

         ::ace::del(g_pmutgen);

         ::ace::del(g_pmutexSystemHeap);
...
//         destroy_id_space();
         ...
         ::ace::del(g_pmutexOutputDebugStringA);
         ...
         ::ace::del(g_pstrCalcModuleFolderDup);

         ::ace::del(::id_space::s_pidspace);

         ::ace::del(s_pstringmanager);


         //::ace::del(g_pplexheapallocarray);
