...
command_target::command_target(::ace::application * papp)
   : object(papp)
{
   CommonConstruct();
}
...
bool command_target::handle(::ace::cmd_msg * pcmdmsg)
{
...
/*
bool command_target::_001OnCmdMsg(::ace::cmd_msg * pcmdmsg)
...
{
//      TRACE(::ace::trace::category_AppMsg, 0, "Warning: using system arrow bitmap instead of dot.\n");
