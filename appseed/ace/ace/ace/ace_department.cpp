...
namespace ace
{
   ...
   void department::construct(::ace::application * papp)
   {
   ...
   void department::on_signal(signal_details * pobj)
   {
      ...
      try
      {
         if(papplicationsignal->m_esignal == ::ace::application_signal_process_initialize)
         {
            papplicationsignal->m_bOk = process_initialize();
         }
         else if(papplicationsignal->m_esignal == ::ace::application_signal_initialize)
         {
            papplicationsignal->m_bOk = initialize();
         }
         else if(papplicationsignal->m_esignal == ::ace::application_signal_initialize1)
         {
            papplicationsignal->m_bOk = initialize1();
         }
         else if(papplicationsignal->m_esignal == ::ace::application_signal_initialize2)
         {
            papplicationsignal->m_bOk = initialize2();
         }
         else if(papplicationsignal->m_esignal == ::ace::application_signal_initialize3)
         {
            papplicationsignal->m_bOk = initialize3();
         }
         //         else if(papplicationsignal->m_esignal == ::ace::application_signal_initialize_instance)
         //       {
         //        papplicationsignal->m_bOk = initialize();
         //   }
         else if(papplicationsignal->m_esignal == ::ace::application_signal_finalize)
         {
