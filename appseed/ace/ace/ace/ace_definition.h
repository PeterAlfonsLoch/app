...
// rather only used as a ace class.  Additionally, the constructor and
...
#define API CLASS_DECL_ACE __declspec(nothrow) HRESULT __stdcall
#define API_(x)CLASS_DECL_ACE __declspec(nothrow) x __stdcall
#define APIINL API
#define APIINL_(x) API_(x)
#define INLINE inline


#define offsetofclass(ace, derived) ((uint_ptr)(static_cast<ace*>((derived*)_PACKING))-_PACKING)
