...
open_url::open_url(::ace::application * papp,const string & strLink,const string & pszTarget) :
   object(papp)
{
...
bool open_url::start(::ace::application * papp,const string & strLink,const string & strTarget)
{
