...
namespace ace
{
      ...
      m_mutexTrace(papp)
   {
      ...
      m_ptrace          = new ::ace::trace::trace(papp);
      m_bLog            = true;
      ...
      set_trace_category(::ace::trace::category_General, "category_General", 3000);
      set_trace_category(::ace::trace::category_COM, "category_COM", 0);
      set_trace_category(::ace::trace::category_QI, "category_QI", 0);
      set_trace_category(::ace::trace::category_Registrar, "category_Registrar", 0);
      set_trace_category(::ace::trace::category_Refcount, "category_Refcount", 0);
      set_trace_category(::ace::trace::category_Windowing, "category_Windowing", 0);
      set_trace_category(::ace::trace::category_Controls, "category_Controls", 0);
      set_trace_category(::ace::trace::category_Hosting, "category_Hosting", 0);
      set_trace_category(::ace::trace::category_DBClient, "category_DBClient", 0);
      set_trace_category(::ace::trace::category_DBProvider, "category_DBProvider", 0);
      set_trace_category(::ace::trace::category_Snapin, "category_Snapin", 0);
      set_trace_category(::ace::trace::category_NotImpl, "category_NotImpl", 0);
      set_trace_category(::ace::trace::category_Allocation, "category_Allocation", 0);
      set_trace_category(::ace::trace::category_Exception, "category_Exception", 0);
      set_trace_category(::ace::trace::category_Time, "category_Time", 0);
      set_trace_category(::ace::trace::category_Cache, "category_Cache", 0);
      set_trace_category(::ace::trace::category_Stencil, "category_Stencil", 0);
      set_trace_category(::ace::trace::category_String, "category_String", 0);
      set_trace_category(::ace::trace::category_Map, "category_Map", 0);
      set_trace_category(::ace::trace::category_Util, "category_Util", 0);
      set_trace_category(::ace::trace::category_Security, "category_Security", 0);
      set_trace_category(::ace::trace::category_Sync, "category_Sync", 0);
      set_trace_category(::ace::trace::category_ISAPI, "category_ISAPI", 0);

      set_trace_category(::ace::trace::category_User, "category_User", 0);
      set_trace_category(::ace::trace::category_User2, "category_User2", 0);
      set_trace_category(::ace::trace::category_User3, "category_User3", 0);
      set_trace_category(::ace::trace::category_User4, "category_User4", 0);


      set_trace_category(::ace::trace::category_AppMsg, "AppMsg", 0);        // main message pump trace (includes DDE)
      set_trace_category(::ace::trace::category_WinMsg , "category_WinMsg", 0);        // Windows message tracing
      set_trace_category(::ace::trace::category_CmdRouting , "category_CmdRouting", 0);    // Windows command routing trace
      set_trace_category(::ace::trace::category_Ole , "category_Ole", 0);          // special OLE callback trace
      set_trace_category(::ace::trace::category_Database , "category_Database", 0);     // special database trace
      set_trace_category(::ace::trace::category_Internet , "category_Internet", 0);     // special Internet client trace
      set_trace_category(::ace::trace::category_dumpContext , "category_dumpContext", 0);   // traces from dump_context
      set_trace_category(::ace::trace::category_Memory , "category_Memory", 0);      // generic non-kernel memory traces
      set_trace_category(::ace::trace::category_Html , "category_Html", 0);         // Html traces
      set_trace_category(::ace::trace::category_Socket , "category_Socket", 0);      // socket traces
...
//   extern sp(::ace::application) g_papp;

   CLASS_DECL_ACE int32_t SimpleDebugReport(int32_t iReportType, const char * pszFileName,int32_t iLine,const char *,const char * pszFormat, va_list list)
   {
      #ifdef WIN32
   ...
   void log::trace_str(const char *pszFileName, int32_t nLine, uint32_t dwCategory, uint32_t nLevel, const char * psz) const
   {
      ...
      //sl.lock();
      log * plog = (log *) this;
      ::ace::trace::category & category = plog->m_ptrace->m_map[dwCategory];
      if(category.m_estatus == ::ace::trace::status_disabled || category.m_uiLevel > category.m_uiLevel)
         return;
      //sl.unlock();
      stringa stra;
...
/*   void log::set_trace_category(uint32_t dwCategory, const char * pszName, uint32_t uiLevel)
   ...
   void log::print(const char * pszFormat, ...)
   {
      va_list ptr;
      va_start(ptr, pszFormat);
      trace_v(NULL, -1, ::ace::trace::category_General, 0, pszFormat, ptr);
      va_end(ptr);
   }
...
/*   void log::trace_v(const char *pszFileName, int32_t nLine, uint32_t dwCategory, uint32_t nLevel, const char * pszFormat, va_list args) const
   {
      ...
      //m_trace.TraceV(pszFileName, nLine, dwCategory, nLevel, pszFmt, args);
      log * plog = (log *) this;
      ::ace::trace::category & category = plog->m_trace.m_map[dwCategory];
      if(category.m_estatus == ::ace::trace::status_disabled || category.m_uiLevel > category.m_uiLevel)
         return;
      string str;
      str.FormatV(pszFormat, args);
  ...
  /*    string strPre;
   ...
   void log::set_trace_category(uint32_t dwCategory, const char * pszName, uint32_t uiLevel)
   {
      ::ace::trace::category & category = m_ptrace->operator[](dwCategory);
      category.m_strCategory = pszName;
      category.m_dwCategory = dwCategory;
      category.m_uiLevel = uiLevel;
      category.m_estatus = uiLevel >= 1 ? ::ace::trace::status_enabled : ::ace::trace::status_disabled;
   }
