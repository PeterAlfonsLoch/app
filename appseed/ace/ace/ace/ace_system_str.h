...
inline static string log_level_name(::ace::log::e_level elevel)
{
   switch (elevel)
   {
   case ::ace::log::level_warning:
      return "warning";
   case ::ace::log::level_error:
      return "error";
   case ::ace::log::level_fatal:
      return "fatal";
   case ::ace::log::level_info:
      return "info";
   default:
