...
namespace ace
{
   ...
   public:
      ...
      string                                          m_strAppName;
      ::ace::allocatorsp                             m_allocer;
      sp(class signal)                                m_psignal;

      ::ace::main_init_data *                        m_pinitmaindata;
...
virtual      void load_string_table(const string & pszApp,const string & pszId);
      ...
      virtual int32_t hotplugin_host_starter_start_sync(const char * pszCommandLine,::ace::application * papp,hotplugin::host * phost,hotplugin::plugin * pplugin = NULL);
...
//#endif
      ...
      virtual bool init_main_data(::ace::main_init_data * pdata);
...
//#endif
      ...
      virtual ::ace::application * instantiate_application(const char * pszType,const char * pszId,application_bias * pbias);
      virtual ::ace::application * create_application(const char * pszType,const char * pszId,bool bSynch,application_bias * pbias);
      virtual ::ace::application * create_platform(::ace::session * psession);
