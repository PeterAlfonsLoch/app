...
namespace message
{
   ...
   base::base(::ace::application * papp,class ::signal * psignal):
   ...
   base::base(::ace::application * papp,::user::primitive * pwnd,UINT uiMessage,WPARAM wparam,::lparam lparam,LRESULT & lresult):
      signal_details(papp)
   {
