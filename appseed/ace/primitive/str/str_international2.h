...
/*      inline void unicode_to_utf8(stringa & stra, stringa & stra)
      ...
      inline bool multibyte_to_utf8(UINT uiCodePageSrc, memory & str, const char * lpcsz)
      {
         return MultiByteToMultiByte(CP_UTF8, str, uiCodePageSrc, lpcsz);
      }

      inline bool multibyte_to_utf8(UINT uiCodePageSrc, memory & str, const char * lpcsz, strsize nCount)
      {
         return MultiByteToMultiByte(CP_UTF8, str, uiCodePageSrc, lpcsz, nCount);
      }

      //inline bool OemToUtf8(memory & str, const char * lpcsz)
      //{
      //   return MultiByteToMultiByte(CP_UTF8, str, CP_OEMCP, lpcsz);
      //}

      //inline bool OemToUtf8(memory & str, const char * lpcsz, strsize nCount)
      //{
      //   return MultiByteToMultiByte(CP_UTF8, str, CP_OEMCP, lpcsz, nCount);
      //}

      inline bool utf8_to_multibyte(UINT uiCodePage, memory & str, const char * lpcsz)
      {
         return MultiByteToMultiByte(CodePageUtf8, str, uiCodePage, lpcsz);
      }

      inline bool utf8_to_multibyte(UINT uiCodePage, memory & str, const char * lpcsz, strsize nCount)
      {
