...
namespace str
{
   ...
   inline CLASS_DECL_ACE  string  from(char ca)
   {
      string str;
      from(str, ca);
      return str;
   ...
   inline CLASS_DECL_ACE  string  from(uchar uch)
   {
      string str;
      from(str, uch);
      return str;
   ...
   inline CLASS_DECL_ACE  string  from(int16_t i)
   {
      string str;
      from(str, i);
      return str;
   ...
   inline CLASS_DECL_ACE  string  from(uint16_t ui)
   {
      string str;
      from(str, ui);
      return str;
   ...
   inline CLASS_DECL_ACE  string  from(long int i)
   {
      string str;
      from(str, i);
      return str;
   ...
   inline CLASS_DECL_ACE bool     trimmed_is_empty(const char * psz)
   {
...
CLASS_DECL_ACE int32_t uni_to_utf8(char * psz, int32_t w);;
CLASS_DECL_ACE ::count utf16_len(const char * psz);
CLASS_DECL_ACE ::count utf16_len_len(const char * psz, strsize srclen);
CLASS_DECL_ACE void utf8_to_utf16(unichar * pwsz, const char * psz);
CLASS_DECL_ACE void utf8_to_utf16_len(unichar * pwsz,const char * psz,strsize srclen);
CLASS_DECL_ACE int32_t utf8_len(const unichar * pwsz);
CLASS_DECL_ACE int32_t utf8_len_len(const unichar * pwsz, strsize srclen);
CLASS_DECL_ACE void utf16_to_utf8(char * psz, const unichar * pwsz);
CLASS_DECL_ACE void utf16_to_utf8_len(char * psz,const unichar * pwsz,strsize srclen);

#ifdef __cplusplus

CLASS_DECL_ACE string utf16_to_utf8(const unichar * pwsz, strsize srcLine = -1);
