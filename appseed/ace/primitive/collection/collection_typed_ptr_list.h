...
/////////////////////////////////////////////////////////////////////////////
// CTypedPtrList<AXIS_CLASS, TYPE>

template < class TYPE, class AXIS_CLASS = pointer_list>
...
template < class TYPE, class AXIS_CLASS = pointer_list >
class typed_ptr_list : public _typed_ptr_list < TYPE, AXIS_CLASS >
{
public:
// Construction
	typed_ptr_list(int_ptr nBlockSize = 10)
		: _typed_ptr_list<AXIS_CLASS, TYPE>(nBlockSize) { }
	...
	void add_head(typed_ptr_list<AXIS_CLASS, TYPE>* pNewList)
		{ AXIS_CLASS::add_head(pNewList); }
	void add_tail(typed_ptr_list<AXIS_CLASS, TYPE>* pNewList)
		{ AXIS_CLASS::add_tail(pNewList); }
};

// need specialized version for object_list because of add_head/Tail ambiguity
template<> class CLASS_DECL_ACE typed_ptr_list < object_list * , object_list>
...
// Construction
	...
	POSITION add_head(object_list* newElement)
		{ return _typed_ptr_list < object_list *,  object_list >::add_head((object*)newElement); }
	POSITION add_tail(object_list* newElement)
		{ return _typed_ptr_list < object_list *,  object_list >::add_tail((object*)newElement); }
...
template<> class CLASS_DECL_ACE typed_ptr_list < pointer_list *, pointer_list >
