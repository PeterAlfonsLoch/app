// MainFrm.h : interface of the CCDFrame class
//
/////////////////////////////////////////////////////////////////////////////

#if !defined(AFX_CDFRAME_H__582F7EA6_EB01_423D_8723_74301B16C6EA__INCLUDED_)
#define AFX_CDFRAME_H__582F7EA6_EB01_423D_8723_74301B16C6EA__INCLUDED_
...
//class CCDFrameInPlaceWnd;

//CMenu* FindPopupMenuFromID(CMenuV003* pMenu, UINT nID, UINT nData);
/*class CFullScreenItem
{
public:
    CMDIChildWnd * m_pChildWindow;
    CView * m_pView;
    WINDOWPLACEMENT m_wpPrevChildWindow;
    DWORD m_dwChildStyle;
    DWORD m_dwViewStyle;
    DWORD m_dwViewStyleEx;
};*/
...
public:
	...
	bool IsCompactMode();
	bool ViewCompactMode(bool bCompact);
...
//inline CAlbumDialog * CCDFrame::GetAlbumDialog()
//{
...
#endif // !defined(AFX_CDFRAME_H__582F7EA6_EB01_423D_8723_74301B16C6EA__INCLUDED_)
