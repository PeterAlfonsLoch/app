      ...
      && log_entry->changed_paths2)
    {
      ...
      for (hi = apr_hash_first(pool, log_entry->changed_paths2);
           ...
           hi = apr_hash_next(hi))
        {
          ...
          const char *merge_source_rel_target = NULL;
          const char *merge_source_fspath = NULL;
          svn_boolean_t ancestor_is_self;
                          ...
                          apr_pool_t *scratch_pool)
{
  ...
  svn_client__pathrev_t *pathrev = NULL;
  ...
  svn_mergeinfo_t target_history = NULL;
  ...
  for (hi_catalog = apr_hash_first(scratch_pool, target_mergeinfo_cat);
       ...
       hi_catalog = apr_hash_next(hi_catalog))
    {
      ...
      svn_mergeinfo_t subtree_history = NULL;
