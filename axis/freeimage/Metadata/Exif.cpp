...
static short
ReadInt16(int_bool msb_order, const void *buffer) {
	short value;
...
static LONG
ReadInt32(int_bool msb_order, const void *buffer) {
	LONG value;
...
ReadUint16(int_bool msb_order, const void *buffer) {
...
static DWORD
ReadUint32(int_bool msb_order, const void *buffer) {
...
*/
static void
processIFDOffset(FITAG *tag, char *pval, int_bool msb_order, DWORD *subdirOffset, TagLib::MDMODEL *md_model) {
	// get the IFD offset
...
*/
static void
processMakerNote(FIBITMAP *dib, char *pval, int_bool msb_order, DWORD *subdirOffset, TagLib::MDMODEL *md_model) {
	FITAG *tagMake = NULL;
...
*/
static void
processExifTag(FIBITMAP *dib, FITAG *tag, char *pval, int_bool msb_order, TagLib::MDMODEL md_model) {
	char defaultKey[16];
	int n;
	DWORD i;
...
*/
static int_bool
jpeg_read_exif_dir(FIBITMAP *dib, const BYTE *tiffp, unsigned long offset, unsigned int length, int_bool msb_order) {
	WORD de, nde;
