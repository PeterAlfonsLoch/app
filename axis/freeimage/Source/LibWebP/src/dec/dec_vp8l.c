...
static void ClearMetadata(VP8LMetadata* const hdr) {
  ...
  memory_free(hdr->huffman_image_);
...
VP8LDecoder* VP8LNew(void) {
  VP8LDecoder* const dec = (VP8LDecoder*)memory_calloc(1, sizeof(*dec));
...
void VP8LClear(VP8LDecoder* const dec) {
  ...
  memory_free(dec->rescaler_memory);
