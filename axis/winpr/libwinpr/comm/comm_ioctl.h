...
typedef struct _SERIAL_DRIVER
{
	SERIAL_DRIVER_ID id;
	TCHAR *name;
	WINBOOL (*set_baud_rate)(WINPR_COMM *pComm, const SERIAL_BAUD_RATE *pBaudRate);
	WINBOOL (*get_baud_rate)(WINPR_COMM *pComm, SERIAL_BAUD_RATE *pBaudRate);
	WINBOOL (*get_properties)(WINPR_COMM *pComm, COMMPROP *pProperties);
	WINBOOL (*set_serial_chars)(WINPR_COMM *pComm, const SERIAL_CHARS *pSerialChars);
	WINBOOL (*get_serial_chars)(WINPR_COMM *pComm, SERIAL_CHARS *pSerialChars);
	WINBOOL (*set_line_control)(WINPR_COMM *pComm, const SERIAL_LINE_CONTROL *pLineControl);
	WINBOOL (*get_line_control)(WINPR_COMM *pComm, SERIAL_LINE_CONTROL *pLineControl);
	WINBOOL (*set_handflow)(WINPR_COMM *pComm, const SERIAL_HANDFLOW *pHandflow);
	WINBOOL (*get_handflow)(WINPR_COMM *pComm, SERIAL_HANDFLOW *pHandflow);
	WINBOOL (*set_timeouts)(WINPR_COMM *pComm, const SERIAL_TIMEOUTS *pTimeouts);
	WINBOOL (*get_timeouts)(WINPR_COMM *pComm, SERIAL_TIMEOUTS *pTimeouts);
	WINBOOL (*set_dtr)(WINPR_COMM *pComm);
	WINBOOL (*clear_dtr)(WINPR_COMM *pComm);
	WINBOOL (*set_rts)(WINPR_COMM *pComm);
	WINBOOL (*clear_rts)(WINPR_COMM *pComm);
	WINBOOL (*get_modemstatus)(WINPR_COMM *pComm, ULONG *pRegister);
	WINBOOL (*set_wait_mask)(WINPR_COMM *pComm, const ULONG *pWaitMask);
	WINBOOL (*get_wait_mask)(WINPR_COMM *pComm, ULONG *pWaitMask);
	WINBOOL (*wait_on_mask)(WINPR_COMM *pComm, ULONG *pOutputMask);
	WINBOOL (*set_queue_size)(WINPR_COMM *pComm, const SERIAL_QUEUE_SIZE *pQueueSize);
	WINBOOL (*purge)(WINPR_COMM *pComm, const ULONG *pPurgeMask);
	WINBOOL (*get_commstatus)(WINPR_COMM *pComm, SERIAL_STATUS *pCommstatus);
	WINBOOL (*set_break_on)(WINPR_COMM *pComm);
	WINBOOL (*set_break_off)(WINPR_COMM *pComm);
	WINBOOL (*set_xoff)(WINPR_COMM *pComm);
	WINBOOL (*set_xon)(WINPR_COMM *pComm);
	WINBOOL (*get_dtrrts)(WINPR_COMM *pComm, ULONG *pMask);
	WINBOOL (*config_size)(WINPR_COMM *pComm, ULONG *pSize);
	WINBOOL (*immediate_char)(WINPR_COMM *pComm, const UCHAR *pChar);
	WINBOOL (*reset_device)(WINPR_COMM *pComm);
