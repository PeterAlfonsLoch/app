...
//	   DWORD dw = GetLastError();
   ...
   /*	if(!::DrawDibDraw ( pbuffer->m_drawdib.m_hdrawdib, 
      ...
      if(::GetWindowLong(hwndParam, GWL_EXSTYLE) & WS_EX_LAYERED)
      {
         ...
         sz.cx = min(rectWindow.right - pt.x, Application.m_monitorinfoa[0].rcMonitor.right - pt.x);
         sz.cy = min(rectWindow.bottom - pt.y, Application.m_monitorinfoa[0].rcMonitor.bottom - pt.y);
