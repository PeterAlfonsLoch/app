...
namespace win
{
   ...
   BOOL graphics::CreateIC(const char * lpszDriverName,
      const char * lpszDeviceName, const char * lpszOutput, const void * lpInitData)
   ...
   { ASSERT(get_handle1() != NULL); return ::ExcludeUpdateRgn(get_handle1(), WIN_WINDOW(pWnd)->GetSafeHwnd()); }
   int graphics::GetDeviceCaps(int nIndex) const
   { ASSERT(get_handle2() != NULL); return ::GetDeviceCaps(get_handle2(), nIndex); }
   ...
   int graphics::EnumObjects(int nObjectType,
      int (CALLBACK* lpfn)(LPVOID, LPARAM), LPARAM lpData)
   { ASSERT(get_handle2() != NULL); return ::EnumObjects(get_handle2(), nObjectType, (GOBJENUMPROC)lpfn, lpData); }
   ...
   { ASSERT(get_handle2() != NULL); return ::GetNearestColor(get_handle2(), crColor); }
   ...
   { ASSERT(get_handle1() != NULL); return SetViewportOrg(point.x, point.y); }
   size graphics::SetViewportExt(SIZE size)
   { ASSERT(get_handle1() != NULL); return SetViewportExt(size.cx, size.cy); }
   point graphics::SetWindowOrg(POINT point)
   { ASSERT(get_handle1() != NULL); return SetWindowOrg(point.x, point.y); }
   size graphics::SetWindowExt(SIZE size)
   { ASSERT(get_handle1() != NULL); return SetWindowExt(size.cx, size.cy); }

   void graphics::DPtoLP(LPPOINT lpPoints, int nCount) const
   { ASSERT(get_handle2() != NULL); VERIFY(::DPtoLP(get_handle2(), lpPoints, nCount)); }
   void graphics::DPtoLP(LPRECT lpRect) const
   { ASSERT(get_handle2() != NULL); VERIFY(::DPtoLP(get_handle2(), (LPPOINT)lpRect, 2)); }
   void graphics::LPtoDP(LPPOINT lpPoints, int nCount) const
   { ASSERT(get_handle2() != NULL); VERIFY(::LPtoDP(get_handle2(), lpPoints, nCount)); }
   void graphics::LPtoDP(LPRECT lpRect) const
   { ASSERT(get_handle2() != NULL); VERIFY(::LPtoDP(get_handle2(), (LPPOINT)lpRect, 2)); }

   BOOL graphics::FillRgn(::ca::rgn* pRgn, ::ca::brush* pBrush)
   { ASSERT(get_handle1() != NULL); return ::FillRgn(get_handle1(), (HRGN)pRgn->get_os_data(), (HBRUSH)pBrush->get_os_data()); }
   BOOL graphics::FrameRgn(::ca::rgn* pRgn, ::ca::brush* pBrush, int nWidth, int nHeight)
   { ASSERT(get_handle1() != NULL); return ::FrameRgn(get_handle1(), (HRGN)pRgn->get_os_data(), (HBRUSH)pBrush->get_os_data(),
   nWidth, nHeight); }
   ...
   BOOL graphics::BitBlt(int x, int y, int nWidth, int nHeight, ::ca::graphics * pgraphicsSrc,
      int xSrc, int ySrc, DWORD dwRop)
   { ASSERT(get_handle1() != NULL); return ::BitBlt(get_handle1(), x, y, nWidth, nHeight,
   WIN_HDC(pgraphicsSrc), xSrc, ySrc, dwRop); }
   ...
   return ::TextOutW(get_handle1(), x, y, wstr, (int) wstr.get_length()); }
   ...
   { 
      ...
      ASSERT(get_handle1() != NULL); 
      wstring wstr;
      gen::international::utf8_to_unicode(wstr, str);
      return TextOutW(get_handle1(), x, y, (const wchar_t *)wstr, (int)wstr.get_length()); 
...
#define HIMETRIC_INCH   2540    // HIMETRIC units per inch
...
#ifdef _DEBUG
   void graphics::AssertValid() const
   {
      base_object::AssertValid();
   }

   void graphics::Dump(CDumpContext & dumpcontext) const
   {
   ...
   BOOL graphics::Attach(HDC hDC)
   {
      ...
      ASSERT(get_handle2() == NULL);    // only attach to an empty DC
   ...
   void graphics::SetOutputDC(HDC hDC)  // Set the Output DC
   {
      ...
      {
         TRACE(traceAppMsg, 0, "Cannot Set Output hDC on Attached graphics.\n");
         ASSERT(FALSE);
      }
#endif
      set_handle1(hDC);
   ...
   void graphics::ReleaseOutputDC()     // Release the Output DC
   {
      ...
      if (pMap != NULL && pMap->lookup_permanent(get_handle1()) == this)
      {
         TRACE(traceAppMsg, 0, "Cannot Release Output hDC on Attached graphics.\n");
         ASSERT(FALSE);
      }
#endif
      set_handle1(NULL);
   ...
   int graphics::SaveDC()
   {
      ...
      if (get_handle1() != get_handle2() && ::SaveDC(get_handle1()) != 0)
   ...
   BOOL graphics::RestoreDC(int nSavedDC)
   {
      ...
      ASSERT(get_handle1() != NULL);
      ASSERT(get_handle1() == get_handle2() || nSavedDC == -1);
   ...
   ::ca::palette* graphics::SelectPalette(::ca::palette* pPalette, BOOL bForceBackground)
   {
      ...
      return dynamic_cast < ::ca::palette * > (::win::graphics_object::from_handle(get_app(), ::SelectPalette(get_handle1(),
         (HPALETTE)pPalette->get_os_data(), bForceBackground)));
   }
   ...
   point graphics::SetViewportOrg(int x, int y)
   {
      ...
      if (get_handle1() != get_handle2())
         VERIFY(::SetViewportOrgEx(get_handle1(), x, y, &point));
      if (get_handle2() != NULL)
         VERIFY(::SetViewportOrgEx(get_handle2(), x, y, &point));
      return point;
   }
   ...
   point graphics::OffsetViewportOrg(int nWidth, int nHeight)
   {
      ...
      if (get_handle1() != get_handle2())
         VERIFY(::OffsetViewportOrgEx(get_handle1(), nWidth, nHeight, &point));
      if (get_handle2() != NULL)
         VERIFY(::OffsetViewportOrgEx(get_handle2(), nWidth, nHeight, &point));
      return point;
   }
   ...
   size graphics::SetViewportExt(int x, int y)
   {
      ...
      if (get_handle1() != get_handle2())
         VERIFY(::SetViewportExtEx(get_handle1(), x, y, &size));
      if (get_handle2() != NULL)
         VERIFY(::SetViewportExtEx(get_handle2(), x, y, &size));
      return size;
   }
   ...
   size graphics::ScaleViewportExt(int xNum, int xDenom, int yNum, int yDenom)
   {
      ...
      if (get_handle1() != get_handle2())
         VERIFY(::ScaleViewportExtEx(get_handle1(), xNum, xDenom, yNum, yDenom, &size));
      if (get_handle2() != NULL)
         VERIFY(::ScaleViewportExtEx(get_handle2(), xNum, xDenom, yNum, yDenom, &size));
      return size;
   }
   ...
   point graphics::SetWindowOrg(int x, int y)
   {
      ...
      if (get_handle1() != get_handle2())
         VERIFY(::SetWindowOrgEx(get_handle1(), x, y, &point));
      if (get_handle2() != NULL)
         VERIFY(::SetWindowOrgEx(get_handle2(), x, y, &point));
      return point;
   }
   ...
   point graphics::OffsetWindowOrg(int nWidth, int nHeight)
   {
      ...
      if (get_handle1() != get_handle2())
         VERIFY(::OffsetWindowOrgEx(get_handle1(), nWidth, nHeight, &point));
      if (get_handle2() != NULL)
         VERIFY(::OffsetWindowOrgEx(get_handle2(), nWidth, nHeight, &point));
      return point;
   }
   ...
   size graphics::SetWindowExt(int x, int y)
   {
      ...
      if (get_handle1() != get_handle2())
         VERIFY(::SetWindowExtEx(get_handle1(), x, y, &size));
      if (get_handle2() != NULL)
         VERIFY(::SetWindowExtEx(get_handle2(), x, y, &size));
      return size;
   }
   ...
   size graphics::ScaleWindowExt(int xNum, int xDenom, int yNum, int yDenom)
   {
      ...
      if (get_handle1() != get_handle2())
         VERIFY(::ScaleWindowExtEx(get_handle1(), xNum, xDenom, yNum, yDenom, &size));
      if (get_handle2() != NULL)
         VERIFY(::ScaleWindowExtEx(get_handle2(), xNum, xDenom, yNum, yDenom, &size));
      return size;
   }
   ...
   int graphics::IntersectClipRect(LPCRECT lpRect)
   {
      ...
      if (get_handle1() != get_handle2())
         nRetVal = ::IntersectClipRect(get_handle1(), lpRect->left, lpRect->top,
         lpRect->right, lpRect->bottom);
      if (get_handle2() != NULL)
         nRetVal = ::IntersectClipRect(get_handle2(), lpRect->left, lpRect->top,
         lpRect->right, lpRect->bottom);
      return nRetVal;
   }
   ...
   point graphics::MoveTo(int x, int y)
   {
      ...
      if (get_handle1() != get_handle2())
         VERIFY(::MoveToEx(get_handle1(), x, y, &point));
      if (get_handle2() != NULL)
         VERIFY(::MoveToEx(get_handle2(), x, y, &point));
      return point;
   }
   ...
   BOOL graphics::SelectClipPath(int nMode)
   {
      ...
      if (get_handle1() != get_handle2())
      {
         ...
         {
            TRACE(traceAppMsg, 0, "Error: unable to transfer clip region in graphics::SelectClipPath!\n");
            bResult = FALSE;
         }
         DeleteObject(hRgn);
      }
      ...
      case META_SELECTOBJECT:
         {
            ...
            if (nObjType == 0)
            {
               ...
               if (hObjOld == hStockFont)
               {
                  ...
                  (dynamic_cast<::win::graphics * >(pgraphics))->SelectObject(::win::font::from_handle(get_app(), (HFONT)hObject));
   ...
   wstring wstr;
   gen::international::utf8_to_unicode(wstr, string(lpszString, nCount));
   return ::DrawTextW(get_handle1(), wstr, wstr.get_length(), lpRect, nFormat); }
   int graphics::DrawText(const string & str, LPRECT lpRect, UINT nFormat)
   { ASSERT(get_handle1() != NULL);
   // these flags would modify the string
   ASSERT((nFormat & (DT_END_ELLIPSIS | DT_MODIFYSTRING)) != (DT_END_ELLIPSIS | DT_MODIFYSTRING));
   ...
   wstring wstr;
   gen::international::utf8_to_unicode(wstr, str);
   return ::DrawTextW(get_handle1(), (const wchar_t *)wstr, (int)wstr.get_length(), lpRect, nFormat); }

   int graphics::DrawTextEx(LPTSTR lpszString, int nCount, LPRECT lpRect,
   ...
   wstring wstr;
   gen::international::utf8_to_unicode(wstr, string(lpszString, nCount));
   return ::DrawTextExW(get_handle1(), const_cast<wchar_t *>((const wchar_t *)wstr), (int) wstr.get_length(), lpRect, nFormat, lpDTParams); }
   int graphics::DrawTextEx(const string & str, LPRECT lpRect, UINT nFormat, LPDRAWTEXTPARAMS lpDTParams)
   { ASSERT(get_handle1() != NULL);
   // these flags would modify the string
   ASSERT((nFormat & (DT_END_ELLIPSIS | DT_MODIFYSTRING)) != (DT_END_ELLIPSIS | DT_MODIFYSTRING));
   ...
   size graphics::GetTextExtent(const char * lpszString, int nCount) const
   {
      ...
      string str(lpszString, nCount);
      wstring wstr = gen::international::utf8_to_unicode(str);
      VERIFY(::GetTextExtentPoint32W(get_handle2(), wstr, (int)wstr.get_length(), &size));
      return size;
   }
...
/*
   ...
   {
      graphics::AssertValid();
      ASSERT(m_hWnd == NULL || ::IsWindow(m_hWnd));
   }

   void CClientDC::Dump(CDumpContext & dumpcontext) const
   {
   ...
   void CWindowDC::Dump(CDumpContext & dumpcontext) const
   {
      graphics::Dump(dumpcontext);
   ...
   void CPaintDC::Dump(CDumpContext & dumpcontext) const
   {
      graphics::Dump(dumpcontext);
...
*/
   ...
   // IMPLEMENT_DYNCREATE(graphics, base_object)
