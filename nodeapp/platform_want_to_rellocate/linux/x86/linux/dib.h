...
namespace win
{
   ...
   public:
      ...
      virtual ::ca::bitmap * get_bitmap();
      virtual ::ca::bitmap * detach_bitmap();
   ...
   inline int dib::cos(int i, int iAngle)
   {
      return (int) (((_int64) i * CosN[iAngle]) >> 31);
   }

   inline int dib::sin(int i, int iAngle)
   {
      return (int) (((_int64) i * SinN[iAngle]) >> 31);
   }

   inline int dib::cos10(int i, int iAngle)
   {
      return (int) (((_int64) i * Cos10N[iAngle]) >> 34);
   }

   inline int dib::sin10(int i, int iAngle)
   {
      return (int) (((_int64) i * Sin10N[iAngle]) >> 34);
   }

   inline int dib::width()
   {
      return m_size.cx;
   }

   inline int dib::height()
   {
      return m_size.cy;
   }
