...
typedef void (AFX_MSG_CALL thread::*AFX_PMSGT)(void);
...
CLASS_DECL_VMSWIN void AfxEndThread(UINT nExitCode, BOOL bDelete = TRUE);

CLASS_DECL_VMSWIN void AfxInitThread();
CLASS_DECL_VMSWIN void AfxTermThread(HINSTANCE hInstTerm = NULL);
...
//CLASS_DECL_VMSWIN HINSTANCE CLASS_DECL_VMSWIN Application.m_hInstance;
