...
public:
   ...
   application* m_pCurrentWinApp;
	...
	// AfxRegisterClass and Application.RegisterWndClass data

	string m_strUnregisterList;
...
public:
	...
	char m_szTempClassName[_AFX_TEMP_CLASS_NAME_SIZE];    // see Application.RegisterWndClass
