...
WINPR_API HANDLE OpenFileMappingA(DWORD dwDesiredAccess, WINBOOL bInheritHandle, LPCSTR lpName);
WINPR_API HANDLE OpenFileMappingW(DWORD dwDesiredAccess, WINBOOL bInheritHandle, LPCWSTR lpName);
...
WINPR_API WINBOOL FlushViewOfFile(LPCVOID lpBaseAddress, SIZE_T dwNumberOfBytesToFlush);

WINPR_API WINBOOL UnmapViewOfFile(LPCVOID lpBaseAddress);
