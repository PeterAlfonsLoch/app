...
FREERDP_API WINBOOL per_read_length(wStream* s, UINT16* length);
FREERDP_API void per_write_length(wStream* s, int length);
FREERDP_API WINBOOL per_read_choice(wStream* s, BYTE* choice);
FREERDP_API void per_write_choice(wStream* s, BYTE choice);
FREERDP_API WINBOOL per_read_selection(wStream* s, BYTE* selection);
FREERDP_API void per_write_selection(wStream* s, BYTE selection);
FREERDP_API WINBOOL per_read_number_of_sets(wStream* s, BYTE* number);
FREERDP_API void per_write_number_of_sets(wStream* s, BYTE number);
FREERDP_API WINBOOL per_read_padding(wStream* s, int length);
FREERDP_API void per_write_padding(wStream* s, int length);
FREERDP_API WINBOOL per_read_integer(wStream* s, UINT32* integer);
FREERDP_API WINBOOL per_read_integer16(wStream* s, UINT16* integer, UINT16 min);
...
FREERDP_API WINBOOL per_read_enumerated(wStream* s, BYTE* enumerated, BYTE count);
...
FREERDP_API WINBOOL per_read_object_identifier(wStream* s, BYTE oid[6]);
FREERDP_API WINBOOL per_read_octet_string(wStream* s, BYTE* oct_str, int length, int min);
FREERDP_API void per_write_octet_string(wStream* s, BYTE* oct_str, int length, int min);
FREERDP_API WINBOOL per_read_numeric_string(wStream* s, int min);
