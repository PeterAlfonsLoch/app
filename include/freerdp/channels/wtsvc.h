...
FREERDP_API WINBOOL WTSVirtualChannelManagerCheckFileDescriptor(HANDLE hServer);
FREERDP_API HANDLE WTSVirtualChannelManagerGetEventHandle(HANDLE hServer);
FREERDP_API WINBOOL WTSVirtualChannelManagerIsChannelJoined(HANDLE hServer, const char* name);
...
FREERDP_API WINBOOL WTSIsChannelJoinedByName(freerdp_peer *client, const char *channel_name);
FREERDP_API WINBOOL WTSIsChannelJoinedById(freerdp_peer *client, const UINT16 channel_id);
FREERDP_API WINBOOL WTSChannelSetHandleByName(freerdp_peer *client, const char *channel_name, void *handle);
FREERDP_API WINBOOL WTSChannelSetHandleById(freerdp_peer *client, const UINT16 channel_id, void *handle);
