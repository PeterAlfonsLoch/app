...
#define LIBMYSQL_VERSION_MAJOR 6
#define LIBMYSQL_VERSION_MINOR 1
#define LIBMYSQL_VERSION_PATCH 6
#define LIBMYSQL_VERSION_ID (LIBMYSQL_VERSION_MAJOR * 10'000 + LIBMYSQL_VERSION_MINOR * 100 + LIBMYSQL_VERSION_PATCH)
...
#define LIBMYSQL_VERSION STR(MYSQL_VERSION_MAJOR) "." STR(MYSQL_VERSION_MINOR) "." STR(LIBMYSQL_VERSION_PATCH)

#define MYSQL_DEFAULT_CHARSET_NAME "utf8"
#define MYSQL_DEFAULT_COLLATION_NAME "utf8"
...
//
#if _WIN32
#define DEFAULT_MYSQL_HOME "C:/Program Files/MySQL/MySQL Server " STR(MYSQL_VERSION_MAJOR) "." STR(MYSQL_VERSION_MINOR)
#define SHAREDIR "share"
#else
#define DEFAULT_MYSQL_HOME "/usr/local/mysql"
#define SHAREDIR DEFAULT_MYSQL_HOME "/" "share"
#endif

//
//#define DEFAULT_CHARSET_HOME DEFAULT_MYSQL_HOME
//#define PLUGINDIR DEFAULT_MYSQL_HOME "/" "plugins"
//
//
//
//
