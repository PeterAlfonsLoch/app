...
/* The dll exports. */
#define LIBMPG123_EXPORT __declspec(dllexport)
#else
#if defined(LINK_MPG123_DLL) || defined (_WIN32)
/* The exe imports. */
#define LIBMPG123_EXPORT __declspec(dllimport)
#else
/* Nothing on normal/UNIX builds */
#define LIBMPG123_EXPORT
#endif
#endif
 ...
 */
LIBMPG123_EXPORT int  mpg123_init(void);

/** Function to close down the mpg123 library. 
 *	This function is not thread-safe. Call it exactly once per process, before any other (possibly threaded) work with the library. */
LIBMPG123_EXPORT void mpg123_exit(void);
 ...
 */
LIBMPG123_EXPORT mpg123_handle *mpg123_new(const char* decoder, int *error);

/** Delete handle, mh is either a valid mpg123 handle or NULL. */
LIBMPG123_EXPORT void mpg123_delete(mpg123_handle *mh);
...
LIBMPG123_EXPORT int mpg123_param(mpg123_handle *mh, enum mpg123_parms type, long value, double fvalue);

/** Get a specific parameter, for a specific mpg123_handle. 
 *  See the mpg123_parms enumeration for a list of available parameters. */
LIBMPG123_EXPORT int mpg123_getparam(mpg123_handle *mh, enum mpg123_parms type, long *val, double *fval);
...
LIBMPG123_EXPORT int mpg123_feature(const enum mpg123_feature_set key);
...
LIBMPG123_EXPORT const char* mpg123_plain_strerror(int errcode);
...
LIBMPG123_EXPORT const char* mpg123_strerror(mpg123_handle *mh);

/** Return the plain errcode intead of a string. */
LIBMPG123_EXPORT int mpg123_errcode(mpg123_handle *mh);
...
LIBMPG123_EXPORT const char **mpg123_decoders(void);

/** Return a NULL-terminated array of the decoders supported by the CPU (plain 8bit ASCII). */
LIBMPG123_EXPORT const char **mpg123_supported_decoders(void);

/** Set the chosen decoder to 'decoder_name' */
LIBMPG123_EXPORT int mpg123_decoder(mpg123_handle *mh, const char* decoder_name);
...
LIBMPG123_EXPORT const char* mpg123_current_decoder(mpg123_handle *mh);
...
LIBMPG123_EXPORT void mpg123_rates(const long **list, size_t *number);
...
LIBMPG123_EXPORT int mpg123_format(mpg123_handle *mh, long rate, int channels, int encodings);
...
LIBMPG123_EXPORT int mpg123_format_support(mpg123_handle *mh, long rate, int encoding);

/** Get the current output format written to the addresses givenr. */
LIBMPG123_EXPORT int mpg123_getformat(mpg123_handle *mh, long *rate, int *channels, int *encoding);
 ...
 */
LIBMPG123_EXPORT int mpg123_open(mpg123_handle *mh, const char *path);

/** Use an already opened file descriptor as the bitstream input
 *  mpg123_close() will _not_ close the file descriptor.
 */
LIBMPG123_EXPORT int mpg123_open_fd(mpg123_handle *mh, int fd);
 ...
 */
LIBMPG123_EXPORT int mpg123_open_handle(mpg123_handle *mh, void *iohandle);
 ...
 */
LIBMPG123_EXPORT int mpg123_open_feed(mpg123_handle *mh);

/** Closes the source, if libmpg123 opened it. */
LIBMPG123_EXPORT int mpg123_close(mpg123_handle *mh);
...
LIBMPG123_EXPORT int mpg123_read(mpg123_handle *mh, unsigned char *outmemory, size_t outmemsize, size_t *done);
...
LIBMPG123_EXPORT int mpg123_feed(mpg123_handle *mh, const unsigned char *in, size_t size);
 ...
 */
LIBMPG123_EXPORT int mpg123_decode(mpg123_handle *mh, const unsigned char *inmemory, size_t inmemsize, unsigned char *outmemory, size_t outmemsize, size_t *done);
 ...
 */
LIBMPG123_EXPORT int mpg123_decode_frame(mpg123_handle *mh, off_t *num, unsigned char **audio, size_t *bytes);
 ...
 *  \param bytes number of output bytes ready in the buffer
 */
LIBMPG123_EXPORT int mpg123_framebyframe_decode(mpg123_handle *mh, off_t *num, unsigned char **audio, size_t *bytes);

/** Find, read and parse the next mp3 frame
 * Warning: This is experimental API that might change in future releases!
 * Please watch mpg123 development closely when using it.
 */
LIBMPG123_EXPORT int mpg123_framebyframe_next(mpg123_handle *mh);
 ...
 */
LIBMPG123_EXPORT int mpg123_framedata(mpg123_handle *mh, unsigned long *header, unsigned char **bodydata, size_t *bodybytes);
...
LIBMPG123_EXPORT off_t mpg123_framepos(mpg123_handle *mh);
...
LIBMPG123_EXPORT off_t mpg123_tell(mpg123_handle *mh);

/** Returns the frame number that the next read will give you data from. */
LIBMPG123_EXPORT off_t mpg123_tellframe(mpg123_handle *mh);

/** Returns the current byte offset in the input stream. */
LIBMPG123_EXPORT off_t mpg123_tell_stream(mpg123_handle *mh);
...
LIBMPG123_EXPORT off_t mpg123_seek(mpg123_handle *mh, off_t sampleoff, int whence);
 ...
 *  \return The resulting offset >= 0 or error/message code */
LIBMPG123_EXPORT off_t mpg123_feedseek(mpg123_handle *mh, off_t sampleoff, int whence, off_t *input_offset);

/** Seek to a desired MPEG frame index.
 *  Set whence to SEEK_SET, SEEK_CUR or SEEK_END.
 *  \return The resulting offset >= 0 or error/message code */
LIBMPG123_EXPORT off_t mpg123_seek_frame(mpg123_handle *mh, off_t frameoff, int whence);
...
LIBMPG123_EXPORT off_t mpg123_timeframe(mpg123_handle *mh, double sec);
...
LIBMPG123_EXPORT int mpg123_index(mpg123_handle *mh, off_t **offsets, off_t *step, size_t *fill);
 ...
 *  \param step    one index byte offset advances this many MPEG frames
 *  \param fill    number of recorded index offsets; size of the array */ 
LIBMPG123_EXPORT int mpg123_set_index(mpg123_handle *mh, off_t *offsets, off_t step, size_t fill);
...
LIBMPG123_EXPORT int mpg123_position( mpg123_handle *mh, off_t frame_offset, off_t buffered_bytes, off_t *current_frame, off_t *frames_left, double *current_seconds, double *seconds_left);
...
LIBMPG123_EXPORT int mpg123_eq(mpg123_handle *mh, enum mpg123_channels channel, int band, double val);
...
LIBMPG123_EXPORT double mpg123_geteq(mpg123_handle *mh, enum mpg123_channels channel, int band);

/** Reset the 32 Band Audio Equalizer settings to flat */
LIBMPG123_EXPORT int mpg123_reset_eq(mpg123_handle *mh);

/** Set the absolute output volume including the RVA setting, 
 *  vol<0 just applies (a possibly changed) RVA setting. */
LIBMPG123_EXPORT int mpg123_volume(mpg123_handle *mh, double vol);

/** Adjust output volume including the RVA setting by chosen amount */
LIBMPG123_EXPORT int mpg123_volume_change(mpg123_handle *mh, double change);
...
LIBMPG123_EXPORT int mpg123_getvolume(mpg123_handle *mh, double *base, double *really, double *rva_db);
...
LIBMPG123_EXPORT int mpg123_info(mpg123_handle *mh, struct mpg123_frameinfo *mi);

/** Get the safe output buffer size for all cases (when you want to replace the internal buffer) */
LIBMPG123_EXPORT size_t mpg123_safe_buffer(void); 
 ...
 */
LIBMPG123_EXPORT int mpg123_scan(mpg123_handle *mh);
...
LIBMPG123_EXPORT off_t mpg123_length(mpg123_handle *mh);
...
/** Override the value for file size in bytes.
  ...
  * \return MPG123_OK or MPG123_ERR */
LIBMPG123_EXPORT int mpg123_set_filesize(mpg123_handle *mh, off_t size);

/** Returns the time (seconds) per frame; <0 is error. */
LIBMPG123_EXPORT double mpg123_tpf(mpg123_handle *mh);

/** Returns the samples per frame for the most recently parsed frame; <0 is error. */
LIBMPG123_EXPORT int mpg123_spf(mpg123_handle *mh);

/** Get and reset the clip count. */
LIBMPG123_EXPORT long mpg123_clip(mpg123_handle *mh);
 ...
 */
LIBMPG123_EXPORT int mpg123_getstate(mpg123_handle *mh, enum mpg123_state key, long *val, double *fval);
...
LIBMPG123_EXPORT void mpg123_init_string(mpg123_string* sb);

/** Free-up mempory for an existing mpg123_string */
LIBMPG123_EXPORT void mpg123_free_string(mpg123_string* sb);

/** Change the size of a mpg123_string
 *  \return 0 on error, 1 on success */
LIBMPG123_EXPORT int  mpg123_resize_string(mpg123_string* sb, size_t news);
 ...
 *  \return 0 on error, 1 on success */
LIBMPG123_EXPORT int  mpg123_grow_string(mpg123_string* sb, size_t news);

/** Copy the contents of one mpg123_string string to another.
 *  \return 0 on error, 1 on success */
LIBMPG123_EXPORT int  mpg123_copy_string(mpg123_string* from, mpg123_string* to);

/** Append a C-String to an mpg123_string
 *  \return 0 on error, 1 on success */
LIBMPG123_EXPORT int  mpg123_add_string(mpg123_string* sb, const char* stuff);
...
LIBMPG123_EXPORT int  mpg123_add_substring(mpg123_string *sb, const char *stuff, size_t from, size_t count);

/** Set the conents of a mpg123_string to a C-string
 *  \return 0 on error, 1 on success */
LIBMPG123_EXPORT int  mpg123_set_string(mpg123_string* sb, const char* stuff);

/** Set the contents of a mpg123_string to a C-substring
 *  \return 0 on error, 1 on success
 *  \param from offset to copy from
 *  \param count number of characters to copy (a null-byte is always appended) */
LIBMPG123_EXPORT int  mpg123_set_substring(mpg123_string *sb, const char *stuff, size_t from, size_t count);
...
*/
LIBMPG123_EXPORT size_t mpg123_strlen(mpg123_string *sb, int utf8);

/** Remove trailing \r and \n, if present.
 *  \return 0 on error, 1 on success
 *  \param sb the string
 */
LIBMPG123_EXPORT int mpg123_chomp_string(mpg123_string *sb);
...
LIBMPG123_EXPORT enum mpg123_text_encoding mpg123_enc_from_id3(unsigned char id3_enc_byte);
 ...
 */
LIBMPG123_EXPORT int mpg123_store_utf8(mpg123_string *sb, enum mpg123_text_encoding enc, const unsigned char *source, size_t source_size);
...
LIBMPG123_EXPORT int mpg123_meta_check(mpg123_handle *mh); /* On error (no valid handle) just 0 is returned. */

/** Clean up meta data storage (ID3v2 and ICY), freeing memory. */
LIBMPG123_EXPORT void mpg123_meta_free(mpg123_handle *mh);
...
LIBMPG123_EXPORT int mpg123_id3(mpg123_handle *mh, mpg123_id3v1 **v1, mpg123_id3v2 **v2);

/** Point icy_meta to existing data structure wich may change on any next read/decode function call.
 *  \return Return value is MPG123_OK or MPG123_ERR,  */
LIBMPG123_EXPORT int mpg123_icy(mpg123_handle *mh, char **icy_meta); /* same for ICY meta string */
...
LIBMPG123_EXPORT char* mpg123_icy2utf8(const char* icy_text);
...
LIBMPG123_EXPORT mpg123_handle *mpg123_parnew(mpg123_pars *mp, const char* decoder, int *error);

/** Allocate memory for and return a pointer to a new mpg123_pars */
LIBMPG123_EXPORT mpg123_pars *mpg123_new_pars(int *error);

/** Delete and free up memory used by a mpg123_pars data structure */
LIBMPG123_EXPORT void         mpg123_delete_pars(mpg123_pars* mp);

/** Configure mpg123 parameters to accept no output format at all, 
 * use before specifying supported formats with mpg123_format */
LIBMPG123_EXPORT int mpg123_fmt_none(mpg123_pars *mp);

/** Configure mpg123 parameters to accept all formats 
 *  (also any custom rate you may set) -- this is default. */
LIBMPG123_EXPORT int mpg123_fmt_all(mpg123_pars *mp);
...
*/
LIBMPG123_EXPORT int mpg123_fmt(mpg123_pars *mh, long rate, int channels, int encodings); /* 0 is good, -1 is error */

/** Check to see if a specific format at a specific rate is supported 
 *  by mpg123_pars.
 *  \return 0 for no support (that includes invalid parameters), MPG123_STEREO, 
 *          MPG123_MONO or MPG123_STEREO|MPG123_MONO. */
LIBMPG123_EXPORT int mpg123_fmt_support(mpg123_pars *mh,   long rate, int encoding);

/** Set a specific parameter, for a specific mpg123_pars, using a parameter 
 *  type key chosen from the mpg123_parms enumeration, to the specified value. */
LIBMPG123_EXPORT int mpg123_par(mpg123_pars *mp, enum mpg123_parms type, long value, double fvalue);

/** Get a specific parameter, for a specific mpg123_pars. 
 *  See the mpg123_parms enumeration for a list of available parameters. */
LIBMPG123_EXPORT int mpg123_getpar(mpg123_pars *mp, enum mpg123_parms type, long *val, double *fval);
...
LIBMPG123_EXPORT int mpg123_replace_buffer(mpg123_handle *mh, unsigned char *data, size_t size);
...
LIBMPG123_EXPORT size_t mpg123_outblock(mpg123_handle *mh);
...
LIBMPG123_EXPORT int mpg123_replace_reader(mpg123_handle *mh, ssize_t (*r_read) (int, void *, size_t), off_t (*r_lseek)(int, off_t, int));
...
LIBMPG123_EXPORT int mpg123_replace_reader_handle(mpg123_handle *mh, ssize_t (*r_read) (void *, void *, size_t), off_t (*r_lseek)(void *, off_t, int), void (*cleanup)(void*));
